...
FaviconData = _reflection.GeneratedProtocolMessageType('FaviconData', (_message.Message,), {
  ...
  '__module__' : 'components.sync.protocol.favicon_image_specifics_pb2'
