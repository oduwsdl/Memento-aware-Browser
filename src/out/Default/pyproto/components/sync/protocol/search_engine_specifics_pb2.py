...
SearchEngineSpecifics = _reflection.GeneratedProtocolMessageType('SearchEngineSpecifics', (_message.Message,), {
  ...
  '__module__' : 'components.sync.protocol.search_engine_specifics_pb2'
