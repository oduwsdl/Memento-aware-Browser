...
ReadingListSpecifics = _reflection.GeneratedProtocolMessageType('ReadingListSpecifics', (_message.Message,), {
  ...
  '__module__' : 'components.sync.protocol.reading_list_specifics_pb2'
