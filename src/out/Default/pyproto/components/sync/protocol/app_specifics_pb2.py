...
_APPSPECIFICS.fields_by_name['extension'].message_type = components_dot_sync_dot_protocol_dot_extension__specifics__pb2._EXTENSIONSPECIFICS
...
AppNotificationSettings = _reflection.GeneratedProtocolMessageType('AppNotificationSettings', (_message.Message,), {
  ...
  '__module__' : 'components.sync.protocol.app_specifics_pb2'
