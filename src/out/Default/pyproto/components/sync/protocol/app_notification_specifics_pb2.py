...
AppNotification = _reflection.GeneratedProtocolMessageType('AppNotification', (_message.Message,), {
  ...
  '__module__' : 'components.sync.protocol.app_notification_specifics_pb2'
