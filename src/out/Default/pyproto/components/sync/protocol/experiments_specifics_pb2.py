...
KeystoreEncryptionFlags = _reflection.GeneratedProtocolMessageType('KeystoreEncryptionFlags', (_message.Message,), {
  ...
  '__module__' : 'components.sync.protocol.experiments_specifics_pb2'
