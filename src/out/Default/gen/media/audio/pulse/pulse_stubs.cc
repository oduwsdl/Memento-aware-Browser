...
static pa_context_state_t (*pa_context_get_state_ptr)(const_pa_context_ptr c) = NULL;
...
static pa_operation_state_t (*pa_operation_get_state_ptr)(const_pa_operation_ptr o) = NULL;
static void (*pa_context_unref_ptr)(pa_context* c) = NULL;
static void (*pa_operation_cancel_ptr)(pa_operation* o) = NULL;
...
static uint32_t (*pa_stream_get_device_index_ptr)(const_pa_stream_ptr s) = NULL;
static int (*pa_stream_get_latency_ptr)(pa_stream* s, pa_usec_t* r_usec, int* negative) = NULL;
static pa_stream_state_t (*pa_stream_get_state_ptr)(const_pa_stream_ptr p) = NULL;
...
static int (*pa_proplist_contains_ptr)(const_pa_proplist_ptr p, const char* key) = NULL;
static void (*pa_proplist_free_ptr)(pa_proplist* p) = NULL;
static const char* (*pa_proplist_gets_ptr)(const_pa_proplist_ptr p, const char* key) = NULL;
static int (*pa_proplist_sets_ptr)(pa_proplist* p, const char* key, const char* value) = NULL;
static size_t (*pa_stream_readable_size_ptr)(const_pa_stream_ptr p) = NULL;
...
static int (*pa_context_errno_ptr)(const_pa_context_ptr c) = NULL;
...
void InitializePulse(void* module) {
  ...
  pa_operation_cancel_ptr =
    reinterpret_cast<void (*)(pa_operation* o)>(
      dlsym(module, "pa_operation_cancel"));
  if (!pa_operation_cancel_ptr) {
    VLOG(1) << "Couldn't load pa_operation_cancel, dlerror() says:\n"
      << dlerror();
  }
  pa_operation_unref_ptr =
    reinterpret_cast<void (*)(pa_operation* o)>(
