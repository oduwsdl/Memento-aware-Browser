// media/mojo/mojom/mirror_service_remoting.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('media.mojom.MirrorServiceRemoterReceiver');
goog.provide('media.mojom.MirrorServiceRemoterCallbackRouter');
goog.provide('media.mojom.MirrorServiceRemoterInterface');
goog.provide('media.mojom.MirrorServiceRemoterRemote');
goog.provide('media.mojom.MirrorServiceRemoterPendingReceiver');
...
/** @interface */
media.mojom.MirrorServiceRemoterInterface = class {
...
goog.provide('media.mojom.MirrorServiceRemotingSourceReceiver');
goog.provide('media.mojom.MirrorServiceRemotingSourceCallbackRouter');
goog.provide('media.mojom.MirrorServiceRemotingSourceInterface');
goog.provide('media.mojom.MirrorServiceRemotingSourceRemote');
goog.provide('media.mojom.MirrorServiceRemotingSourcePendingReceiver');
...
/** @interface */
media.mojom.MirrorServiceRemotingSourceInterface = class {
...
goog.provide('media.mojom.MirrorServiceRemoter_Start_ParamsSpec');
/**
...
goog.provide('media.mojom.MirrorServiceRemoter_StartDataStreams_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.MirrorServiceRemoter_StartDataStreams_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.MirrorServiceRemoter_Stop_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.MirrorServiceRemoter_SendMessageToSink_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.MirrorServiceRemoter_EstimateTransmissionCapacity_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.MirrorServiceRemoter_EstimateTransmissionCapacity_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.MirrorServiceRemotingSource_OnSinkAvailable_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.MirrorServiceRemotingSource_OnMessageFromSink_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.MirrorServiceRemotingSource_OnStopped_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.MirrorServiceRemotingSource_OnError_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
