...
void LearningTaskControllerProxy::BeginObservation(
    const ::base::UnguessableToken& in_id, const WTF::Vector<::media::learning::FeatureValue>& in_features, const base::Optional<::media::learning::TargetValue>& in_default_target) {
