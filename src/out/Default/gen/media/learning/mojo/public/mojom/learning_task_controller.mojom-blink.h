...
class BLINK_PLATFORM_EXPORT LearningTaskController
 ...
 public:
  ...
  virtual void BeginObservation(const ::base::UnguessableToken& id, const WTF::Vector<::media::learning::FeatureValue>& features, const base::Optional<::media::learning::TargetValue>& default_target) = 0;
...
class BLINK_PLATFORM_EXPORT LearningTaskControllerProxy
 ...
 public:
  ...
  void BeginObservation(const ::base::UnguessableToken& id, const WTF::Vector<::media::learning::FeatureValue>& features, const base::Optional<::media::learning::TargetValue>& default_target) final;
