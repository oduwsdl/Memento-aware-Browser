...
namespace gpu {
const int kFeatureListForSoftwareEntry3[14] = {
...
const int kFeatureListForSoftwareEntry5[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const uint32_t kCrBugsForSoftwareEntry5[7] = {
71381,
76428,
73910,
101225,
...
".*AMD.*",  // driver_vendor
{GpuControlList::kGE, GpuControlList::kVersionStyleLexical, GpuControlList::kVersionSchemaCommon, "8.98", nullptr},  // driver_version
};
...
"Mesa",  // driver_vendor
{GpuControlList::kGE, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "10.0.4", nullptr},  // driver_version
};
...
const GpuControlList::DriverInfo kDriverInfoForSoftwareEntry5Exception3 = {
".*Brahma.*",  // driver_vendor
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // driver_version
};

const GpuControlList::More kMoreForEntry5_1043157500Exception3 = {
GpuControlList::kGLTypeNone,  // gl_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // gl_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // pixel_shader_version
false,  // in_process_gpu
...
const int kFeatureListForSoftwareEntry8[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const int kFeatureListForSoftwareEntry17[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
"Mesa",  // driver_vendor
{GpuControlList::kLT, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "10.1", nullptr},  // driver_version
};
...
const GpuControlList::Device kDevicesForSoftwareEntry17Exception0[12] = {
{0x0102, 0x0},
{0x0106, 0x0},
{0x0112, 0x0},
{0x0116, 0x0},
...
{GpuControlList::kGE, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "8.0", nullptr},  // driver_version
};
...
const GpuControlList::Device kDevicesForSoftwareEntry17Exception1[16] = {
{0xa001, 0x0},
{0xa002, 0x0},
{0xa011, 0x0},
{0xa012, 0x0},
...
nullptr,  // driver_vendor
{GpuControlList::kGT, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "8.0.2", nullptr},  // driver_version
};
...
const GpuControlList::Device kDevicesForSoftwareEntry17Exception2[2] = {
{0x0042, 0x0},
{0x0046, 0x0},
};
...
nullptr,  // driver_vendor
{GpuControlList::kGT, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "8.0.4", nullptr},  // driver_version
};
...
const GpuControlList::Device kDevicesForSoftwareEntry17Exception3[1] = {
{0x2a02, 0x0},
};
...
const GpuControlList::Device kDevicesForSoftwareEntry17Exception4[2] = {
{0x0a16, 0x0},
{0x0a26, 0x0},
};
...
nullptr,  // driver_vendor
{GpuControlList::kGE, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "10.0.1", nullptr},  // driver_version
};
...
const int kFeatureListForSoftwareEntry18[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const GpuControlList::Device kDevicesForSoftwareEntry18[1] = {
{0x029e, 0x0},
};
...
const int kFeatureListForSoftwareEntry27[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const int kFeatureListForSoftwareEntry28[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const int kFeatureListForSoftwareEntry29[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const int kFeatureListForSoftwareEntry30[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const int kFeatureListForSoftwareEntry37[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const int kFeatureListForSoftwareEntry47[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
{GpuControlList::kLT, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "295", nullptr},  // driver_version
};
...
const uint32_t kCrBugsForSoftwareEntry48[2] = {
137247,
1032907,
};
...
const char* const kMachineModelNameForEntry48Exception0[1] = {
"Chromecast",
};

const GpuControlList::MachineModelInfo kMachineModelInfoForEntry48Exception0 = {
base::size(kMachineModelNameForEntry48Exception0),  // machine model name size
kMachineModelNameForEntry48Exception0,  // machine model names
...
const GpuControlList::More kMoreForEntry48_1043157500Exception0 = {
GpuControlList::kGLTypeNone,  // gl_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // gl_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // pixel_shader_version
false,  // in_process_gpu
...
const int kFeatureListForSoftwareEntry50[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
"Mesa",  // driver_vendor
{GpuControlList::kGE, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "9.2.1", nullptr},  // driver_version
};
...
const GpuControlList::Device kDevicesForSoftwareEntry53[2] = {
{0x8108, 0x0},
{0x8109, 0x0},
};
...
"NVIDIA",  // driver_vendor
{GpuControlList::kLT, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "331.38", nullptr},  // driver_version
};
...
const int kFeatureListForSoftwareEntry93[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
false,  // in_process_gpu
0,  // gl_reset_notification_strategy
{GpuControlList::kLT, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "2", nullptr},  // direct_rendering_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // gpu_count
GpuControlList::kDontCare,  // hardware_overlay
0,  // test_group
GpuControlList::kDontCare,  // subpixel_font_rendering
...
const int kFeatureListForSoftwareEntry95[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
".*AMD.*",  // driver_vendor
{GpuControlList::kEQ, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "13.101", nullptr},  // driver_version
};
...
const int kFeatureListForSoftwareEntry107[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const IntelGpuSeriesType kIntelGpuSeriesForEntry107[1] = {
IntelGpuSeriesType::kHaswell,
};
...
const int kFeatureListForSoftwareEntry125[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const GpuControlList::Device kDevicesForSoftwareEntry125[1] = {
{0xbeef, 0x0},
};
...
const int kFeatureListForSoftwareEntry129[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const int kFeatureListForSoftwareEntry131[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const GpuControlList::Device kDevicesForSoftwareEntry131[1] = {
{0x2a02, 0x0},
};

const GpuControlList::DriverInfo kDriverInfoForSoftwareEntry131 = {
"Mesa",  // driver_vendor
{GpuControlList::kLT, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "10.4.3", nullptr},  // driver_version
};
...
const int kFeatureListForSoftwareEntry134[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
"Mesa",  // driver_vendor
{GpuControlList::kLE, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "10.1.3", nullptr},  // driver_version
};
...
const int kFeatureListForSoftwareEntry152[12] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
GPU_FEATURE_TYPE_FLASH3D,
...
const uint32_t kCrBugsForSoftwareEntry154[1] = {
1093625,
};
...
const GpuControlList::Device kDevicesForSoftwareEntry154Exception1[2] = {
{0x15d8, 0xe1},
{0x15d8, 0xe2},
};

const GpuControlList::DriverInfo kDriverInfoForSoftwareEntry154Exception1 = {
nullptr,  // driver_vendor
...
const GpuControlList::More kMoreForEntry154_1043157500Exception1 = {
GpuControlList::kGLTypeNone,  // gl_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // gl_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // pixel_shader_version
false,  // in_process_gpu
...
const GpuControlList::Device kDevicesForSoftwareEntry154Exception2[2] = {
{0x15d8, 0x93},
{0x15dd, 0x86},
};

const GpuControlList::DriverInfo kDriverInfoForSoftwareEntry154Exception2 = {
nullptr,  // driver_vendor
...
const GpuControlList::More kMoreForEntry154_1043157500Exception2 = {
GpuControlList::kGLTypeNone,  // gl_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // gl_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // pixel_shader_version
false,  // in_process_gpu
...
const GpuControlList::Device kDevicesForSoftwareEntry154Exception3[2] = {
{0x15d8, 0x0},
{0x15dd, 0x0},
};

const GpuControlList::DriverInfo kDriverInfoForSoftwareEntry154Exception3 = {
nullptr,  // driver_vendor
{GpuControlList::kGE, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "27.20.1002.34", nullptr},  // driver_version
};

const GpuControlList::More kMoreForEntry154_1043157500Exception3 = {
GpuControlList::kGLTypeNone,  // gl_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // gl_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // pixel_shader_version
false,  // in_process_gpu
...
const int kFeatureListForSoftwareEntry161[14] = {
GPU_FEATURE_TYPE_FLASH_STAGE3D,
GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL,
GPU_FEATURE_TYPE_ACCELERATED_GL,
GPU_FEATURE_TYPE_GPU_RASTERIZATION,
...
const GpuControlList::Device kDevicesForSoftwareEntry161[1] = {
{0x2a42, 0x0},
};

const GpuControlList::DriverInfo kDriverInfoForSoftwareEntry161 = {
nullptr,  // driver_vendor
{GpuControlList::kEQ, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "18.1.7", nullptr},  // driver_version
};
