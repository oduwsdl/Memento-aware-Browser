...
struct HashTraits<::gpu::mojom::VkPhysicalDeviceType>
  ...
  static bool IsEmptyValue(const ::gpu::mojom::VkPhysicalDeviceType& value) {
    return value == static_cast<::gpu::mojom::VkPhysicalDeviceType>(-1000000);
  }
...
class  VkPhysicalDeviceProperties {
 ...
 private:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
  DISALLOW_COPY_AND_ASSIGN(VkPhysicalDeviceProperties);
};
...
class  VkQueueFamilyProperties {
 ...
 private:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
  DISALLOW_COPY_AND_ASSIGN(VkQueueFamilyProperties);
};
