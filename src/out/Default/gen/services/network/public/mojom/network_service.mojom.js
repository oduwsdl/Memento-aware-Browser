...
(function() {
  ...
  NetworkServiceClient_OnRawResponse_Params.decode = function(decoder) {
    ...
    val.devtoolRequestId =
        decoder.decodeStruct(codec.String);
    val.cookiesWithStatus =
        decoder.decodeArrayPointer(new codec.PointerTo(cookie_manager$.CookieAndLineWithStatus));
    val.headers =
        decoder.decodeArrayPointer(new codec.PointerTo(http_raw_headers$.HttpRawHeaderPair));
  ...
  var kNetworkServiceClient_OnLoadingStateUpdate_Name = 1655691993;
  var kNetworkServiceClient_OnDataUseUpdate_Name = 624879644;
  var kNetworkServiceClient_OnRawRequest_Name = 1306306601;
  var kNetworkServiceClient_OnRawResponse_Name = 491133966;
  var kNetworkServiceClient_OnCorsPreflightRequest_Name = 78879049;
  var kNetworkServiceClient_OnCorsPreflightResponse_Name = 132165240;
  var kNetworkServiceClient_OnCorsPreflightRequestCompleted_Name = 777302439;
  var kNetworkServiceClient_LogCrossOriginFetchFromContentScript3_Name = 1515696436;
  ...
  var kNetworkService_SetClient_Name = 180618952;
  var kNetworkService_StartNetLog_Name = 1076248173;
  var kNetworkService_AttachNetLogProxy_Name = 372313036;
  var kNetworkService_SetSSLKeyLogFile_Name = 1384462806;
  var kNetworkService_CreateNetworkContext_Name = 115917922;
  var kNetworkService_ConfigureStubHostResolver_Name = 1096762510;
  var kNetworkService_DisableQuic_Name = 853708874;
  var kNetworkService_SetUpHttpAuth_Name = 1416419775;
  var kNetworkService_ConfigureHttpAuthPrefs_Name = 312522709;
  var kNetworkService_SetRawHeadersAccess_Name = 880717690;
  var kNetworkService_SetMaxConnectionsPerProxy_Name = 1915164735;
  var kNetworkService_GetNetworkChangeManager_Name = 1403544086;
  var kNetworkService_GetNetworkQualityEstimatorManager_Name = 712209892;
  var kNetworkService_GetDnsConfigChangeManager_Name = 129061846;
  var kNetworkService_GetTotalNetworkUsages_Name = 1874847602;
  var kNetworkService_GetNetworkList_Name = 1478112396;
  var kNetworkService_UpdateCRLSet_Name = 2018510195;
  var kNetworkService_UpdateLegacyTLSConfig_Name = 48736312;
  var kNetworkService_OnCertDBChanged_Name = 591262983;
  var kNetworkService_SetCryptConfig_Name = 252373804;
  var kNetworkService_AddCorbExceptionForPlugin_Name = 480289737;
  var kNetworkService_AddAllowedRequestInitiatorForPlugin_Name = 1909046268;
  var kNetworkService_RemoveSecurityExceptionsForPlugin_Name = 558348981;
  var kNetworkService_OnMemoryPressure_Name = 1246142044;
  var kNetworkService_OnPeerToPeerConnectionsCountChange_Name = 1963174069;
  var kNetworkService_SetEnvironment_Name = 439634479;
  var kNetworkService_SetTrustTokenKeyCommitments_Name = 323047656;
  var kNetworkService_BindTestInterface_Name = 1290014738;
