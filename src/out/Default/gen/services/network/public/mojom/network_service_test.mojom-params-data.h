 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(NetworkServiceTest_SetRequireCT_Params_Data));
      new (data()) NetworkServiceTest_SetRequireCT_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    NetworkServiceTest_SetRequireCT_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<NetworkServiceTest_SetRequireCT_Params_Data>(index_);
    }
    NetworkServiceTest_SetRequireCT_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(NetworkServiceTest_SetRequireCT_ResponseParams_Data));
      new (data()) NetworkServiceTest_SetRequireCT_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    NetworkServiceTest_SetRequireCT_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<NetworkServiceTest_SetRequireCT_ResponseParams_Data>(index_);
    }
    NetworkServiceTest_SetRequireCT_ResponseParams_Data* operator->() { return data(); }
...
class NetworkServiceTest_SetRequireCT_ParamsDataView {
 public:
  ...
  NetworkServiceTest_RequireCT required() const {
    return static_cast<NetworkServiceTest_RequireCT>(data_->required);
  }
 private:
