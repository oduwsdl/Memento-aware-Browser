...
class  DnsConfigOverrides_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<mojo::internal::String_Data>>> disabled_upgrade_providers;

 private:
  DnsConfigOverrides_Data();
  ~DnsConfigOverrides_Data() = delete;
};
static_assert(sizeof(DnsConfigOverrides_Data) == 88,
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(ResolveErrorInfo_Data));
      new (data()) ResolveErrorInfo_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ResolveErrorInfo_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ResolveErrorInfo_Data>(index_);
    }
    ResolveErrorInfo_Data* operator->() { return data(); }
...
struct ResolveErrorInfo_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
                 mojo::internal::Buffer* buffer) override {
    ResolveErrorInfo_Data::BufferWriter writer;
    mojo::internal::Serialize<DataView>(user_data_, buffer, &writer, context);
  }
...
class  ResolveHostParameters_Data {
 public:
  ...
  uint8_t pad7_[3];
  int32_t secure_dns_mode_override;
  uint8_t padfinal_[4];
