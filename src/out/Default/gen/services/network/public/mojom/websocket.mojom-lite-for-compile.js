...
goog.provide('network.mojom.AuthenticationHandlerReceiver');
goog.provide('network.mojom.AuthenticationHandlerCallbackRouter');
goog.provide('network.mojom.AuthenticationHandlerInterface');
goog.provide('network.mojom.AuthenticationHandlerRemote');
goog.provide('network.mojom.AuthenticationHandlerPendingReceiver');
...
/** @interface */
network.mojom.AuthenticationHandlerInterface = class {
...
goog.provide('network.mojom.AuthenticationHandler_OnAuthRequired_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('network.mojom.AuthenticationHandler_OnAuthRequired_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
network.mojom.WebSocketHandshakeClient_OnConnectionEstablished_Params = class {
  constructor() {
    /** @type { !network.mojom.WebSocketRemote } */
    this.socket;
    /** @type { !network.mojom.WebSocketClientPendingReceiver } */
    this.clientReceiver;
    /** @type { !MojoHandle } */
    this.readable;
