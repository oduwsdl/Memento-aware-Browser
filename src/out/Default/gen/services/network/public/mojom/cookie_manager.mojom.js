...
(function() {
  ...
  CookieEffectiveSameSite.MAX_VALUE = 3,
  ...
  CookieChangeInfo.validate = function(messageValidator, offset) {
    ...
    // validate CookieChangeInfo.accessSemantics
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 8, CookieAccessSemantics);
    if (err !== validator.validationError.NONE)
        return err;


    // validate CookieChangeInfo.cause
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 12, CookieChangeCause);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieChangeInfo.encodedSize = codec.kStructHeaderSize + 16;
  ...
  var kCookieChangeListener_OnCookieChange_Name = 1880661451;
  ...
  var kCookieManager_GetAllCookies_Name = 495595911;
  var kCookieManager_GetAllCookiesWithAccessSemantics_Name = 1064925818;
  var kCookieManager_GetCookieList_Name = 1680364377;
  var kCookieManager_SetCanonicalCookie_Name = 98484807;
  var kCookieManager_DeleteCanonicalCookie_Name = 771248937;
  var kCookieManager_DeleteCookies_Name = 1167411217;
  var kCookieManager_AddCookieChangeListener_Name = 1682795805;
  var kCookieManager_AddGlobalChangeListener_Name = 663112014;
  var kCookieManager_CloneInterface_Name = 1125226352;
  var kCookieManager_FlushCookieStore_Name = 1461474224;
  var kCookieManager_AllowFileSchemeCookies_Name = 2070517087;
  var kCookieManager_SetContentSettings_Name = 1581495916;
  var kCookieManager_SetForceKeepSessionState_Name = 167321987;
  var kCookieManager_BlockThirdPartyCookies_Name = 701871568;
  var kCookieManager_SetContentSettingsForLegacyCookieAccess_Name = 1292517150;
  var kCookieManager_SetStorageAccessGrantSettings_Name = 716717854;
