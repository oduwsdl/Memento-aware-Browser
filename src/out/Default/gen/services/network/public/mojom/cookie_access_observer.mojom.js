...
(function() {
  ...
  CookieAccessDetails.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 24, 8, new codec.PointerTo(cookie_manager$.CookieWithStatus), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieAccessDetails.decode = function(decoder) {
    ...
    val.cookieList =
        decoder.decodeArrayPointer(new codec.PointerTo(cookie_manager$.CookieWithStatus));
  ...
  var kCookieAccessObserver_OnCookiesAccessed_Name = 682158765;
  var kCookieAccessObserver_Clone_Name = 1124314019;
