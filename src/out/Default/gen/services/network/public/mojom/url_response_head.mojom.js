...
(function() {
  ...
  URLResponseHead.validate = function(messageValidator, offset) {
    ...
    // validate URLResponseHead.mementoDatetime
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 128, ip_endpoint$.IPEndPoint, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 136, proxy_resolver$.ProxyServer, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 152, fetch_api$.FetchResponseType);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLResponseHead.decode = function(decoder) {
    ...
    val.mementoInfo = (packed >> 4) & 1 ? true : false;
    val.wasFetchedViaCache = (packed >> 5) & 1 ? true : false;
    val.wasFetchedViaServiceWorker = (packed >> 6) & 1 ? true : false;
    val.wasFallbackRequiredByServiceWorker = (packed >> 7) & 1 ? true : false;
    packed = decoder.readUint8();
  ...
  URLResponseHead.encode = function(encoder, val) {
    ...
    packed |= (val.mementoInfo & 1) << 4
    packed |= (val.wasFetchedViaCache & 1) << 5
    packed |= (val.wasFetchedViaServiceWorker & 1) << 6
    packed |= (val.wasFallbackRequiredByServiceWorker & 1) << 7
    ...
    encoder.encodeStruct(codec.String, val.mementoDatetime);
