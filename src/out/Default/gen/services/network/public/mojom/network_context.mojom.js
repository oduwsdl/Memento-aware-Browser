...
(function() {
  ...
  NetworkContextParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 140, NetworkContextParams.CorsMode);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextParams.decode = function(decoder) {
    ...
    val.hstsPolicyBypassList =
        decoder.decodeArrayPointer(codec.String);
    val.corsExtraSafelistedRequestHeaderNames =
        decoder.decodeArrayPointer(codec.String);
  ...
  ClientSecurityState.encodedSize = codec.kStructHeaderSize + 16;
  ...
  NetworkContext_CreateWebSocket_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateInterface(offset + codec.kStructHeaderSize + 60, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_CreateWebSocket_Params.encodedSize = codec.kStructHeaderSize + 88;
  ...
  var kCustomProxyConfigClient_OnCustomProxyConfigUpdated_Name = 1050478131;
  var kCustomProxyConfigClient_MarkProxiesAsBad_Name = 2042762015;
  var kCustomProxyConfigClient_ClearBadProxiesCache_Name = 1164496472;
  ...
  var kTrustedHeaderClient_OnBeforeSendHeaders_Name = 1061911933;
  var kTrustedHeaderClient_OnHeadersReceived_Name = 1716893608;
  ...
  var kTrustedURLLoaderHeaderClient_OnLoaderCreated_Name = 248602258;
  var kTrustedURLLoaderHeaderClient_OnLoaderForCorsPreflightCreated_Name = 1233005640;
  ...
  var kAuthChallengeResponder_OnAuthCredentials_Name = 1908983425;
  ...
  var kClientCertificateResponder_ContinueWithCertificate_Name = 736559861;
  var kClientCertificateResponder_ContinueWithoutCertificate_Name = 1226599287;
  var kClientCertificateResponder_CancelRequest_Name = 474512564;
  ...
  var kSSLPrivateKey_Sign_Name = 1607215135;
  ...
  var kNetworkContextClient_OnAuthRequired_Name = 479654362;
  var kNetworkContextClient_OnCertificateRequested_Name = 1700869215;
  var kNetworkContextClient_OnSSLCertificateError_Name = 365788770;
  var kNetworkContextClient_OnFileUploadRequested_Name = 984053514;
  var kNetworkContextClient_OnCanSendReportingReports_Name = 289760283;
  var kNetworkContextClient_OnCanSendDomainReliabilityUpload_Name = 1648084953;
  var kNetworkContextClient_OnClearSiteData_Name = 614399500;
  ...
  var kNetworkContext_SetClient_Name = 216922779;
  var kNetworkContext_CreateURLLoaderFactory_Name = 880048848;
  var kNetworkContext_ResetURLLoaderFactories_Name = 647033224;
  var kNetworkContext_GetCookieManager_Name = 1823877985;
  var kNetworkContext_GetRestrictedCookieManager_Name = 1352545329;
  var kNetworkContext_GetHasTrustTokensAnswerer_Name = 1372283282;
  var kNetworkContext_ClearTrustTokenData_Name = 1975211222;
  var kNetworkContext_ClearNetworkingHistorySince_Name = 891190236;
  var kNetworkContext_ClearHttpCache_Name = 51272481;
  var kNetworkContext_ComputeHttpCacheSize_Name = 135095796;
  var kNetworkContext_NotifyExternalCacheHit_Name = 190214603;
  var kNetworkContext_ClearHostCache_Name = 1743857347;
  var kNetworkContext_ClearHttpAuthCache_Name = 1563746879;
  var kNetworkContext_ClearReportingCacheReports_Name = 617143980;
  var kNetworkContext_ClearReportingCacheClients_Name = 1434283458;
  var kNetworkContext_ClearNetworkErrorLogging_Name = 1066602619;
  var kNetworkContext_ClearDomainReliability_Name = 463902774;
  var kNetworkContext_GetDomainReliabilityJSON_Name = 1064661002;
  var kNetworkContext_QueueReport_Name = 435932712;
  var kNetworkContext_QueueSignedExchangeReport_Name = 314016158;
  var kNetworkContext_CloseAllConnections_Name = 1411136539;
  var kNetworkContext_CloseIdleConnections_Name = 1754964273;
  var kNetworkContext_SetNetworkConditions_Name = 148365804;
  var kNetworkContext_SetAcceptLanguage_Name = 1806036477;
  var kNetworkContext_SetEnableReferrers_Name = 51129693;
  var kNetworkContext_SetCTPolicy_Name = 939530602;
  var kNetworkContext_AddExpectCT_Name = 739810070;
  var kNetworkContext_SetExpectCTTestReport_Name = 1482668219;
  var kNetworkContext_GetExpectCTState_Name = 1794890382;
  var kNetworkContext_CreateUDPSocket_Name = 988668856;
  var kNetworkContext_CreateTCPServerSocket_Name = 1121920220;
  var kNetworkContext_CreateTCPConnectedSocket_Name = 342316660;
  var kNetworkContext_CreateTCPBoundSocket_Name = 1492598671;
  var kNetworkContext_CreateProxyResolvingSocketFactory_Name = 1107722363;
  var kNetworkContext_LookUpProxyForURL_Name = 1679088351;
  var kNetworkContext_ForceReloadProxyConfig_Name = 1298253961;
  var kNetworkContext_ClearBadProxiesCache_Name = 1672065233;
  var kNetworkContext_CreateWebSocket_Name = 587582804;
  var kNetworkContext_CreateQuicTransport_Name = 59130933;
  var kNetworkContext_CreateNetLogExporter_Name = 1133762250;
  var kNetworkContext_PreconnectSockets_Name = 1050353814;
  var kNetworkContext_CreateP2PSocketManager_Name = 1569525828;
  var kNetworkContext_CreateMdnsResponder_Name = 2035934868;
  var kNetworkContext_ResolveHost_Name = 29462906;
  var kNetworkContext_CreateHostResolver_Name = 687559073;
  var kNetworkContext_VerifyCertForSignedExchange_Name = 486203830;
  var kNetworkContext_ParseHeaders_Name = 1574770170;
  var kNetworkContext_AddHSTS_Name = 511403860;
  var kNetworkContext_IsHSTSActiveForHost_Name = 65127984;
  var kNetworkContext_GetHSTSState_Name = 319220939;
  var kNetworkContext_SetCorsOriginAccessListsForOrigin_Name = 2015503833;
  var kNetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Name = 784875438;
  var kNetworkContext_DeleteDynamicDataForHost_Name = 580687138;
  var kNetworkContext_SetSplitAuthCacheByNetworkIsolationKey_Name = 401443471;
  var kNetworkContext_SaveHttpAuthCacheProxyEntries_Name = 1026779730;
  var kNetworkContext_LoadHttpAuthCacheProxyEntries_Name = 902513749;
  var kNetworkContext_AddAuthCacheEntry_Name = 1995256504;
  var kNetworkContext_LookupServerBasicAuthCredentials_Name = 1695470539;
  var kNetworkContext_EnableStaticKeyPinningForTesting_Name = 966862504;
  var kNetworkContext_VerifyCertificateForTesting_Name = 1035685688;
  var kNetworkContext_AddDomainReliabilityContextForTesting_Name = 1553896885;
  var kNetworkContext_ForceDomainReliabilityUploadsForTesting_Name = 1740651170;
  var kNetworkContext_GetOriginPolicyManager_Name = 286796416;
  ...
  NetworkContextProxy.prototype.createWebSocket = function(url, requestedProtocols, siteForCookies, isolationInfo, additionalHeaders, processId, renderFrameId, origin, options, handshakeClient, authHandler, headerClient) {
  ...
  NetworkContextStub.prototype.createWebSocket = function(url, requestedProtocols, siteForCookies, isolationInfo, additionalHeaders, processId, renderFrameId, origin, options, handshakeClient, authHandler, headerClient) {
    return this.delegate_ && this.delegate_.createWebSocket && this.delegate_.createWebSocket(url, requestedProtocols, siteForCookies, isolationInfo, additionalHeaders, processId, renderFrameId, origin, options, handshakeClient, authHandler, headerClient);
  }
  ...
  NetworkContextStub.prototype.accept = function(message) {
    ...
    case kNetworkContext_CreateWebSocket_Name:
      ...
      this.createWebSocket(params.url, params.requestedProtocols, params.siteForCookies, params.isolationInfo, params.additionalHeaders, params.processId, params.renderFrameId, params.origin, params.options, params.handshakeClient, params.authHandler, params.headerClient);
      return true;
