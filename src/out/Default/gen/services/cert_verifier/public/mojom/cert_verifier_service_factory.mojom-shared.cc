...
bool CertVerifierServiceFactory_GetNewCertVerifier_Params_Data::Validate(
  ...
  const CertVerifierServiceFactory_GetNewCertVerifier_Params_Data* object = static_cast<const CertVerifierServiceFactory_GetNewCertVerifier_Params_Data*>(data);
