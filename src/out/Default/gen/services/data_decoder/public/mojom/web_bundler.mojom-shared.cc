...
std::ostream& operator<<(std::ostream& os, WebBundlerError value) {
  switch(value) {
    case WebBundlerError::kOK:
      return os << "WebBundlerError::kOK";
    case WebBundlerError::kNotImplemented:
      return os << "WebBundlerError::kNotImplemented";
    case WebBundlerError::kFileOpenFailed:
      return os << "WebBundlerError::kFileOpenFailed";
    case WebBundlerError::kWebBundlerConnectionError:
      return os << "WebBundlerError::kWebBundlerConnectionError";
    default:
      return os << "Unknown WebBundlerError value: " << static_cast<int32_t>(value);
  }
}
