...
serviceManager.mojom.Connector_BindInterface_ResponseParams = class {
  constructor() {
    ...
    this.result;
    /** @type { (serviceManager.mojom.Identity|undefined) } */
    this.identity;
  }
};
...
serviceManager.mojom.Connector_QueryService_ResponseParams = class {
  constructor() {
    /** @type { (serviceManager.mojom.ServiceInfo|undefined) } */
    this.info;
  }
};
...
serviceManager.mojom.Connector_RegisterServiceInstance_Params = class {
  constructor() {
    ...
    /** @type { !MojoHandle } */
    this.service;
    /** @type { (serviceManager.mojom.ProcessMetadataPendingReceiver|undefined) } */
...
serviceManager.mojom.Connector_Clone_Params = class {
  constructor() {
    /** @type { !serviceManager.mojom.ConnectorPendingReceiver } */
    this.receiver;
  }
};
