...
bool SerialPortInfo_Data::Validate(
  ...
  const mojo::internal::ContainerValidateParams persistent_id_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->persistent_id, validation_context,
                                         &persistent_id_validate_params)) {
    return false;
  }
...
bool SerialPortManager_SetClient_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SerialPortManager_SetClient_Params_Data* object = static_cast<const SerialPortManager_SetClient_Params_Data*>(data);
...
bool SerialPortManager_GetPort_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->port_receiver, 3, validation_context)) {
    return false;
  }
...
bool SerialPortManagerClient_OnPortAdded_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SerialPortManagerClient_OnPortAdded_Params_Data* object = static_cast<const SerialPortManagerClient_OnPortAdded_Params_Data*>(data);
...
bool SerialPortManagerClient_OnPortRemoved_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SerialPortManagerClient_OnPortRemoved_Params_Data* object = static_cast<const SerialPortManagerClient_OnPortRemoved_Params_Data*>(data);
