...
class SerialPortInfoDataView {
 public:
  ...
  inline void GetPersistentIdDataView(
      mojo::StringDataView* output);

  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadPersistentId(UserType* output) {
    auto* pointer = data_->persistent_id.Get();
...
struct Serializer<::device::mojom::SerialPortInfoDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(Traits::persistent_id(input)) in_persistent_id = Traits::persistent_id(input);
    typename decltype((*output)->persistent_id)::BaseType::BufferWriter
        persistent_id_writer;
    mojo::internal::Serialize<mojo::StringDataView>(
        in_persistent_id, buffer, &persistent_id_writer, context);
    (*output)->persistent_id.Set(
        persistent_id_writer.is_null() ? nullptr : persistent_id_writer.data());
...
inline void SerialPortInfoDataView::GetPersistentIdDataView(
    mojo::StringDataView* output) {
  auto pointer = data_->persistent_id.Get();
