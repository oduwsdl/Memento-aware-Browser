...
class HidDeviceInfoDataView {
 public:
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadPhysicalDeviceId(UserType* output) {
...
struct Serializer<::device::mojom::HidDeviceInfoDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    typename decltype((*output)->physical_device_id)::BaseType::BufferWriter
        physical_device_id_writer;
    mojo::internal::Serialize<mojo::StringDataView>(
        in_physical_device_id, buffer, &physical_device_id_writer, context);
    (*output)->physical_device_id.Set(
        physical_device_id_writer.is_null() ? nullptr : physical_device_id_writer.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        (*output)->physical_device_id.is_null(),
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
