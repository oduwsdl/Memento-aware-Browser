 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(NFCProvider_SuspendNFCOperations_Params_Data));
      new (data()) NFCProvider_SuspendNFCOperations_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    NFCProvider_SuspendNFCOperations_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<NFCProvider_SuspendNFCOperations_Params_Data>(index_);
    }
    NFCProvider_SuspendNFCOperations_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(NFCProvider_ResumeNFCOperations_Params_Data));
      new (data()) NFCProvider_ResumeNFCOperations_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    NFCProvider_ResumeNFCOperations_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<NFCProvider_ResumeNFCOperations_Params_Data>(index_);
    }
    NFCProvider_ResumeNFCOperations_Params_Data* operator->() { return data(); }
