...
std::ostream& operator<<(std::ostream& os, MediaAudioVideoState value) {
  switch(value) {
    case MediaAudioVideoState::kUnknown:
      return os << "MediaAudioVideoState::kUnknown";
    case MediaAudioVideoState::kAudioOnly:
      return os << "MediaAudioVideoState::kAudioOnly";
    case MediaAudioVideoState::kAudioVideo:
      return os << "MediaAudioVideoState::kAudioVideo";
    default:
      return os << "Unknown MediaAudioVideoState value: " << static_cast<int32_t>(value);
  }
}
...
bool MediaSessionInfo_Data::Validate(
  ...
  static constexpr struct {
    uint32_t version;
    uint32_t num_bytes;
  } kVersionSizes[] = {{ 0, 16 }, { 1, 24 }, { 2, 24 }, { 4, 24 }, { 6, 24 }, { 7, 24 }, { 8, 32 }};
  ...
  if (!::media_session::mojom::internal::MediaAudioVideoState_Data
        ::Validate(object->audio_video_state, validation_context))
    return false;
