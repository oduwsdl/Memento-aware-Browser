...
blink.mojom.DomStorageProvider_BindDomStorage_Params = class {
  constructor() {
    /** @type { !blink.mojom.DomStoragePendingReceiver } */
    this.receiver;
    /** @type { !blink.mojom.DomStorageClientRemote } */
    this.client;
  }
};
...
blink.mojom.DomStorage_OpenLocalStorage_Params = class {
  constructor() {
    ...
    this.origin;
    /** @type { !blink.mojom.StorageAreaPendingReceiver } */
    this.area;
  }
};
...
blink.mojom.DomStorage_BindSessionStorageNamespace_Params = class {
  constructor() {
    /** @type { !string } */
    this.namespaceId;
    /** @type { !blink.mojom.SessionStorageNamespacePendingReceiver } */
    this.receiver;
  }
};
