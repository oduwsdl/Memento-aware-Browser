 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(WebBluetoothAdvertisingEvent_Data));
      new (data()) WebBluetoothAdvertisingEvent_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    WebBluetoothAdvertisingEvent_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<WebBluetoothAdvertisingEvent_Data>(index_);
    }
    WebBluetoothAdvertisingEvent_Data* operator->() { return data(); }
...
struct WebBluetoothAdvertisingEvent_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
                 mojo::internal::Buffer* buffer) override {
    WebBluetoothAdvertisingEvent_Data::BufferWriter writer;
    mojo::internal::Serialize<DataView>(user_data_, buffer, &writer, context);
  }
