 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(PaymentRequestDetailsUpdate_Data));
      new (data()) PaymentRequestDetailsUpdate_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    PaymentRequestDetailsUpdate_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<PaymentRequestDetailsUpdate_Data>(index_);
    }
    PaymentRequestDetailsUpdate_Data* operator->() { return data(); }
...
struct PaymentRequestDetailsUpdate_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
                 mojo::internal::Buffer* buffer) override {
    PaymentRequestDetailsUpdate_Data::BufferWriter writer;
    mojo::internal::Serialize<DataView>(user_data_, buffer, &writer, context);
  }
