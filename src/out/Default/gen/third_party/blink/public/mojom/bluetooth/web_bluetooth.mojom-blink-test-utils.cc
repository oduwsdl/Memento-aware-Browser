...
void WebBluetoothServiceInterceptorForTesting::WatchAdvertisementsForDevice(const ::WTF::String& device_id, ::mojo::PendingAssociatedRemote<WebBluetoothAdvertisementClient> client, WatchAdvertisementsForDeviceCallback callback) {
