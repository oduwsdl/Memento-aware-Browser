 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(WebBluetoothService_GetDevices_Params_Data));
      new (data()) WebBluetoothService_GetDevices_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    WebBluetoothService_GetDevices_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<WebBluetoothService_GetDevices_Params_Data>(index_);
    }
    WebBluetoothService_GetDevices_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(WebBluetoothService_GetDevices_ResponseParams_Data));
      new (data()) WebBluetoothService_GetDevices_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    WebBluetoothService_GetDevices_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<WebBluetoothService_GetDevices_ResponseParams_Data>(index_);
    }
    WebBluetoothService_GetDevices_ResponseParams_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(WebBluetoothService_WatchAdvertisementsForDevice_Params_Data));
      new (data()) WebBluetoothService_WatchAdvertisementsForDevice_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    WebBluetoothService_WatchAdvertisementsForDevice_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<WebBluetoothService_WatchAdvertisementsForDevice_Params_Data>(index_);
    }
    WebBluetoothService_WatchAdvertisementsForDevice_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(WebBluetoothService_WatchAdvertisementsForDevice_ResponseParams_Data));
      new (data()) WebBluetoothService_WatchAdvertisementsForDevice_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    WebBluetoothService_WatchAdvertisementsForDevice_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<WebBluetoothService_WatchAdvertisementsForDevice_ResponseParams_Data>(index_);
    }
    WebBluetoothService_WatchAdvertisementsForDevice_ResponseParams_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(WebBluetoothAdvertisementClient_AdvertisingEvent_Params_Data));
      new (data()) WebBluetoothAdvertisementClient_AdvertisingEvent_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    WebBluetoothAdvertisementClient_AdvertisingEvent_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<WebBluetoothAdvertisementClient_AdvertisingEvent_Params_Data>(index_);
    }
    WebBluetoothAdvertisementClient_AdvertisingEvent_Params_Data* operator->() { return data(); }
...
class WebBluetoothService_RemoteCharacteristicWriteValue_ParamsDataView {
 public:
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadWriteType(UserType* output) const {
  ...
  WebBluetoothWriteType write_type() const {
    return static_cast<WebBluetoothWriteType>(data_->write_type);
  }
 private:
...
inline void WebBluetoothService_GetDevices_ResponseParamsDataView::GetDevicesDataView(
    mojo::ArrayDataView<WebBluetoothDeviceDataView>* output) {
  auto pointer = data_->devices.Get();
  *output = mojo::ArrayDataView<WebBluetoothDeviceDataView>(pointer, context_);
}
...
inline void WebBluetoothAdvertisementClient_AdvertisingEvent_ParamsDataView::GetResultDataView(
    WebBluetoothAdvertisingEventDataView* output) {
  auto pointer = data_->result.Get();
  *output = WebBluetoothAdvertisingEventDataView(pointer, context_);
}
