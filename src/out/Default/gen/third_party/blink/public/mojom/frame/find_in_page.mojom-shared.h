...
class FindOptionsDataView {
 public:
  ...
  bool find_next_if_selection_matches() const {
    return data_->find_next_if_selection_matches;
  }
...
struct Serializer<::blink::mojom::FindOptionsDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->new_session = Traits::new_session(input);
    (*output)->force = Traits::force(input);
    (*output)->find_next_if_selection_matches = Traits::find_next_if_selection_matches(input);
