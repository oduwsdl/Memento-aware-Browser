...
(function() {
  ...
  GetAssertionAuthenticatorResponse.encodedSize = codec.kStructHeaderSize + 32;
  ...
  PublicKeyCredentialCreationOptions.decode = function(decoder) {
    ...
    val.enforceProtectionPolicy = (packed >> 1) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  PublicKeyCredentialCreationOptions.encode = function(encoder, val) {
    ...
    packed |= (val.enforceProtectionPolicy & 1) << 1
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
