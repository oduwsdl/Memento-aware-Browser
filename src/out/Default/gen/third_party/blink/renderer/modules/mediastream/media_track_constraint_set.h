...
class MODULES_EXPORT MediaTrackConstraintSet : public IDLDictionaryBase {
 public:
  ...
  bool hasMandatory() const { return !(mandatory_.IsEmpty() || mandatory_.IsNull() || mandatory_.IsUndefined()); }
  ScriptValue mandatory() const {
    return mandatory_;
  }
  void setMandatory(ScriptValue);
  ...
  void setOptional(const HeapVector<ScriptValue>&);

  bool hasPan() const { return !pan_.IsNull(); }
  const BooleanOrDoubleOrConstrainDoubleRange& pan() const {
    return pan_;
  }
  void setPan(const BooleanOrDoubleOrConstrainDoubleRange&);
  ...
  const BooleanOrDoubleOrConstrainDoubleRange& tilt() const {
    return tilt_;
  }
  void setTilt(const BooleanOrDoubleOrConstrainDoubleRange&);
  ...
  const BooleanOrDoubleOrConstrainDoubleRange& zoom() const {
    return zoom_;
  }
  void setZoom(const BooleanOrDoubleOrConstrainDoubleRange&);
 ...
 private:
  ...
  ScriptValue mandatory_;
  BooleanOrConstrainBooleanParameters noise_suppression_;
  HeapVector<ScriptValue> optional_;
  BooleanOrDoubleOrConstrainDoubleRange pan_;
  ...
  BooleanOrDoubleOrConstrainDoubleRange tilt_;
  ...
  BooleanOrDoubleOrConstrainDoubleRange zoom_;
