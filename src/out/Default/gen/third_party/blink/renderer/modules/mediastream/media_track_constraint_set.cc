...
void MediaTrackConstraintSet::setMandatory(ScriptValue value) {
  mandatory_ = value;
}
...
void MediaTrackConstraintSet::setPan(const BooleanOrDoubleOrConstrainDoubleRange& value) {
  pan_ = value;
}
...
void MediaTrackConstraintSet::setTilt(const BooleanOrDoubleOrConstrainDoubleRange& value) {
  tilt_ = value;
}
...
void MediaTrackConstraintSet::setZoom(const BooleanOrDoubleOrConstrainDoubleRange& value) {
  zoom_ = value;
}
...
void MediaTrackConstraintSet::Trace(Visitor* visitor) const {
  ...
  visitor->Trace(mandatory_);
  visitor->Trace(noise_suppression_);
  visitor->Trace(optional_);
  visitor->Trace(pan_);
