...
class MODULES_EXPORT CanvasContextCreationAttributesModule : public IDLDictionaryBase {
 public:
  ...
  bool hasWillReadFrequently() const { return has_will_read_frequently_; }
  bool willReadFrequently() const {
    DCHECK(has_will_read_frequently_);
    return will_read_frequently_;
  }
  inline void setWillReadFrequently(bool);
 ...
 private:
  ...
  bool has_will_read_frequently_ = false;
...
void CanvasContextCreationAttributesModule::setWillReadFrequently(bool value) {
  will_read_frequently_ = value;
  has_will_read_frequently_ = true;
}
