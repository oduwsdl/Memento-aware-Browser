...
class MODULES_EXPORT RTCConfiguration : public IDLDictionaryBase {
 public:
  ...
  bool hasEncodedInsertableStreams() const { return has_encoded_insertable_streams_; }
  bool encodedInsertableStreams() const {
    DCHECK(has_encoded_insertable_streams_);
    return encoded_insertable_streams_;
  }
  inline void setEncodedInsertableStreams(bool);

  bool hasForceEncodedAudioInsertableStreams() const { return has_force_encoded_audio_insertable_streams_; }
  bool forceEncodedAudioInsertableStreams() const {
    DCHECK(has_force_encoded_audio_insertable_streams_);
    return force_encoded_audio_insertable_streams_;
  }
  inline void setForceEncodedAudioInsertableStreams(bool);

  bool hasForceEncodedVideoInsertableStreams() const { return has_force_encoded_video_insertable_streams_; }
  bool forceEncodedVideoInsertableStreams() const {
    DCHECK(has_force_encoded_video_insertable_streams_);
    return force_encoded_video_insertable_streams_;
  }
  inline void setForceEncodedVideoInsertableStreams(bool);
 ...
 private:
  ...
  bool has_encoded_insertable_streams_ = false;
  bool has_force_encoded_audio_insertable_streams_ = false;
  bool has_force_encoded_video_insertable_streams_ = false;
...
void RTCConfiguration::setEncodedInsertableStreams(bool value) {
  encoded_insertable_streams_ = value;
  has_encoded_insertable_streams_ = true;
}

void RTCConfiguration::setForceEncodedAudioInsertableStreams(bool value) {
  force_encoded_audio_insertable_streams_ = value;
  has_force_encoded_audio_insertable_streams_ = true;
}

void RTCConfiguration::setForceEncodedVideoInsertableStreams(bool value) {
  force_encoded_video_insertable_streams_ = value;
  has_force_encoded_video_insertable_streams_ = true;
}
