...
class MODULES_EXPORT GPUTextureDescriptor : public GPUObjectDescriptorBase {
 public:
  ...
  const UnsignedLongEnforceRangeSequenceOrGPUExtent3DDict& size() const {
    return size_;
  }
  void setSize(const UnsignedLongEnforceRangeSequenceOrGPUExtent3DDict&);
 ...
 private:
  ...
  UnsignedLongEnforceRangeSequenceOrGPUExtent3DDict size_;
  uint32_t usage_;
