...
class MODULES_EXPORT GPUTextureCopyView : public IDLDictionaryBase {
 public:
  ...
  static GPUTextureCopyView* Create(v8::Isolate* isolate) {
    return MakeGarbageCollected<GPUTextureCopyView>();
  }
  ...
  const UnsignedLongEnforceRangeSequenceOrGPUOrigin3DDict& origin() const {
    return origin_;
  }
  void setOrigin(const UnsignedLongEnforceRangeSequenceOrGPUOrigin3DDict&);
 ...
 private:
  ...
  uint32_t mip_level_;
  UnsignedLongEnforceRangeSequenceOrGPUOrigin3DDict origin_;
