...
class MODULES_EXPORT RTCIceCandidateInit : public IDLDictionaryBase {
 public:
  ...
  bool hasSdpMLineIndexNonNull() const { return has_sdp_m_line_index_; }
  // Returns the value if this member has a non-null value.  Call
  // |hasSdpMLineIndexNonNull| in advance to check the condition.
  ...
  // Returns true iff this member has a non-null value.  Returns false if the
  // value is missing or a null value.
  bool hasSdpMidNonNull() const { return !sdp_mid_.IsNull(); }
  // Returns the value if this member has a non-null value.  Call
  // |hasSdpMidNonNull| in advance to check the condition.
  const String& sdpMidNonNull() const {
    DCHECK(hasSdpMidNonNull());
    return sdp_mid_;
  }
  ...
  inline void setUsernameFragmentToNull();
  // Migration adapters
  // Returns true iff this member has a non-null value.  Returns false if the
  // value is missing or a null value.
  bool hasUsernameFragmentNonNull() const { return !username_fragment_.IsNull(); }
  // Returns the value if this member has a non-null value.  Call
  // |hasUsernameFragmentNonNull| in advance to check the condition.
  const String& usernameFragmentNonNull() const {
    DCHECK(hasUsernameFragmentNonNull());
    return username_fragment_;
  }
...
void RTCIceCandidateInit::setUsernameFragmentToNull() {
  username_fragment_ = String();
}
