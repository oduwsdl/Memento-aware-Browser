...
class MODULES_EXPORT DetectedBarcode : public IDLDictionaryBase {
 public:
 ...
 private:
  ...
  friend class V8DetectedBarcode;
};

void DetectedBarcode::setBoundingBox(DOMRectReadOnly* value) {
  bounding_box_ = value;
}
