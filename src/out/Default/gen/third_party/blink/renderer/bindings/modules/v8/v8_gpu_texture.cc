...
static void CreateViewMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  descriptor = NativeValueTraits<GPUTextureViewDescriptor>::NativeValue(info.GetIsolate(), info[0], exception_state);
  if (exception_state.HadException())
    return;

  V8SetReturnValue(info, impl->createView(descriptor));
}
...
static constexpr V8DOMConfiguration::MethodConfiguration kV8GPUTextureMethods[] = {
    {"createView", V8GPUTexture::CreateViewMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
