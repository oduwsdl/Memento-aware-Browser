...
v8::Maybe<void> V8CustomElementFormStateRestoreCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const FileOrUSVStringOrFormData& value, const String& mode) {
...
void V8CustomElementFormStateRestoreCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const FileOrUSVStringOrFormData& value, const String& mode) {
