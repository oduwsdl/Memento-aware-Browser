...
static void QueryMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  permission = NativeValueTraits<IDLObject>::NativeValue(info.GetIsolate(), info[0], exception_state);
...
static void RequestMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  permissions = NativeValueTraits<IDLObject>::NativeValue(info.GetIsolate(), info[0], exception_state);
  if (exception_state.HadException())
    return;
...
static void RequestAllMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  permissions = NativeValueTraits<IDLSequence<IDLObject>>::NativeValue(info.GetIsolate(), info[0], exception_state);
  if (exception_state.HadException())
    return;
