...
static void InstallV8AudioScheduledSourceNodeTemplate(
  ...
  kAccessorConfigurations[] = {
      { "onended", V8AudioScheduledSourceNode::OnendedAttributeGetterCallback, V8AudioScheduledSourceNode::OnendedAttributeSetterCallback, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
  };
