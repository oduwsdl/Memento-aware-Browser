...
static void CancelMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (UNLIKELY(num_args_passed <= 0)) {
    ScriptPromise result = impl->cancelWrapper(script_state);
    V8SetReturnValue(info, result.V8Value());
    return;
  }
...
static void InstallV8UnderlyingSourceBaseTemplate(
  ...
  kAccessorConfigurations[] = {
      { "type", V8UnderlyingSourceBase::TypeAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
  };
