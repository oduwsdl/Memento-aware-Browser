...
eternalV8GPUBindGroupEntryKeys(v8::Isolate* isolate) {
...
void V8GPUBindGroupEntry::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUBindGroupEntry* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8GPUBindGroupEntryKeys(isolate).data();
...
v8::Local<v8::Value> GPUBindGroupEntry::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8GPUBindGroupEntry(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8GPUBindGroupEntry(const GPUBindGroupEntry* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const auto* keys = eternalV8GPUBindGroupEntryKeys(isolate).data();
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
...
GPUBindGroupEntry* NativeValueTraits<GPUBindGroupEntry>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  GPUBindGroupEntry* impl = MakeGarbageCollected<GPUBindGroupEntry>();
  V8GPUBindGroupEntry::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
