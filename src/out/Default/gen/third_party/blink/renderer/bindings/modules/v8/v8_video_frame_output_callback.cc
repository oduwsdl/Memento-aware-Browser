...
v8::Maybe<void> V8VideoFrameOutputCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, VideoFrame* output) {
  ...
  v8::Local<v8::Value> v8_output = ToV8(output, argument_creation_context, GetIsolate());
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_output };
...
void V8VideoFrameOutputCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, VideoFrame* output) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, output);
