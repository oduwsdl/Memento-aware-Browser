...
v8::Maybe<void> V8PositionErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, GeolocationPositionError* positionError) {
...
void V8PositionErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, GeolocationPositionError* positionError) {
