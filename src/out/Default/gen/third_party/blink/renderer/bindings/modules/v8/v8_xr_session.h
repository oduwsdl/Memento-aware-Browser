...
class V8XRSession {
 ...
 public:
  ...
  MODULES_EXPORT static void InteractionModeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void OnsqueezeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void OnsqueezeAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void OnsqueezestartAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void OnsqueezestartAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void OnsqueezeendAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void OnsqueezeendAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void RequestLightProbeMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
