...
static void SetScissorRectMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  width = NativeValueTraits<IDLUnsignedLongEnforceRange>::NativeValue(info.GetIsolate(), info[2], exception_state);
  if (exception_state.HadException())
    return;

  height = NativeValueTraits<IDLUnsignedLongEnforceRange>::NativeValue(info.GetIsolate(), info[3], exception_state);
  if (exception_state.HadException())
    return;
...
static void SetStencilReferenceMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  uint32_t reference;
  reference = NativeValueTraits<IDLUnsignedLongEnforceRange>::NativeValue(info.GetIsolate(), info[0], exception_state);
  if (exception_state.HadException())
    return;
...
static void PushDebugGroupMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "GPURenderPassEncoder", "pushDebugGroup");
...
static void InsertDebugMarkerMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "GPURenderPassEncoder", "insertDebugMarker");
  ...
  if (RuntimeEnabledFeatures::WebGPUEnabled()) {
    {
      ...
      constexpr V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
          {"draw", V8GPURenderPassEncoder::DrawMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
      };
      for (const auto& config : kConfigurations) {
        V8DOMConfiguration::InstallMethod(
            isolate, world, instance_template, prototype_template,
  ...
  if (RuntimeEnabledFeatures::WebGPUEnabled()) {
    {
      ...
      constexpr V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
          {"drawIndexed", V8GPURenderPassEncoder::DrawIndexedMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
      };
      for (const auto& config : kConfigurations) {
        V8DOMConfiguration::InstallMethod(
            isolate, world, instance_template, prototype_template,
