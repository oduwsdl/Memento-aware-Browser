...
class V8Animation {
 ...
 public:
  ...
  CORE_EXPORT static void ReplaceStateAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void OnremoveAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void OnremoveAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void CommitStylesMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void UpdatePlaybackRateMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void PersistMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
