...
static void MultiDrawArraysInstancedWEBGLMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "WebGLMultiDraw", "multiDrawArraysInstancedWEBGL");
...
static void MultiDrawElementsInstancedWEBGLMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "WebGLMultiDraw", "multiDrawElementsInstancedWEBGL");
...
void V8WebGLMultiDraw::MultiDrawArraysInstancedWEBGLMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  webgl_multi_draw_v8_internal::MultiDrawArraysInstancedWEBGLMethod(info);
}

void V8WebGLMultiDraw::MultiDrawElementsInstancedWEBGLMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  webgl_multi_draw_v8_internal::MultiDrawElementsInstancedWEBGLMethod(info);
}
...
static constexpr V8DOMConfiguration::MethodConfiguration kV8WebGLMultiDrawMethods[] = {
    ...
    {"multiDrawArraysInstancedWEBGL", V8WebGLMultiDraw::MultiDrawArraysInstancedWEBGLMethodCallback, 8, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
    {"multiDrawElementsInstancedWEBGL", V8WebGLMultiDraw::MultiDrawElementsInstancedWEBGLMethodCallback, 9, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
};
