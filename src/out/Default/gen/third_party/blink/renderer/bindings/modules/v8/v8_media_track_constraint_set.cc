...
eternalV8MediaTrackConstraintSetKeys(v8::Isolate* isolate) {
...
void V8MediaTrackConstraintSet::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, MediaTrackConstraintSet* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8MediaTrackConstraintSetKeys(isolate).data();
  ...
  if (mandatory_value.IsEmpty() || mandatory_value->IsUndefined()) {
    ...
    ScriptValue mandatory_cpp_value = NativeValueTraits<IDLObject>::NativeValue(isolate, mandatory_value, exception_state);
    if (exception_state.HadException())
      return;
  ...
  if (optional_value.IsEmpty() || optional_value->IsUndefined()) {
    ...
    HeapVector<ScriptValue> optional_cpp_value = NativeValueTraits<IDLSequence<IDLObject>>::NativeValue(isolate, optional_value, exception_state);
    if (exception_state.HadException())
      return;
  ...
  if (zoom_value.IsEmpty() || zoom_value->IsUndefined()) {
    ...
    BooleanOrDoubleOrConstrainDoubleRange zoom_cpp_value;
    V8BooleanOrDoubleOrConstrainDoubleRange::ToImpl(isolate, zoom_value, zoom_cpp_value, UnionTypeConversionMode::kNotNullable, exception_state);
    if (exception_state.HadException())
      return;
  ...
  if (RuntimeEnabledFeatures::MediaCapturePanTiltEnabled()) {
    ...
    if (pan_value.IsEmpty() || pan_value->IsUndefined()) {
      ...
      BooleanOrDoubleOrConstrainDoubleRange pan_cpp_value;
      V8BooleanOrDoubleOrConstrainDoubleRange::ToImpl(isolate, pan_value, pan_cpp_value, UnionTypeConversionMode::kNotNullable, exception_state);
      if (exception_state.HadException())
        return;
    ...
    if (tilt_value.IsEmpty() || tilt_value->IsUndefined()) {
      ...
      BooleanOrDoubleOrConstrainDoubleRange tilt_cpp_value;
      V8BooleanOrDoubleOrConstrainDoubleRange::ToImpl(isolate, tilt_value, tilt_cpp_value, UnionTypeConversionMode::kNotNullable, exception_state);
      if (exception_state.HadException())
        return;
