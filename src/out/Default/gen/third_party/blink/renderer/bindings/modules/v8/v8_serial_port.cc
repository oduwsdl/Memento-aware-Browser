...
static_assert(
    ...
    "SerialPort does not inherit from ActiveScriptWrappable<>, but specifying "
    "[ActiveScriptWrappable] extended attribute in the IDL file.  "
    "Be consistent.");
static_assert(
    !std::is_same<decltype(&SerialPort::HasPendingActivity),
                  decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "SerialPort is not overriding hasPendingActivity(), but is specifying "
    "[ActiveScriptWrappable] extended attribute in the IDL file.  "
    "Be consistent.");
...
static void ReadableAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kGetterContext, "SerialPort", "readable");

  ReadableStream* cpp_value(impl->readable(script_state, exception_state));
...
static void WritableAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kGetterContext, "SerialPort", "writable");

  WritableStream* cpp_value(impl->writable(script_state, exception_state));
...
static void OpenMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->open(script_state, options, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
static void GetSignalsMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "SerialPort", "getSignals");
  ExceptionToRejectPromiseScope reject_promise_scope(info, exception_state);
  ...
  ScriptPromise result = impl->getSignals(script_state, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void SetSignalsMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "SerialPort", "setSignals");
  ExceptionToRejectPromiseScope reject_promise_scope(info, exception_state);
  ...
  signals = NativeValueTraits<SerialOutputSignals>::NativeValue(info.GetIsolate(), info[0], exception_state);
  if (exception_state.HadException())
    return;

  ScriptPromise result = impl->setSignals(script_state, signals, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
void V8SerialPort::ReadableAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SerialPort_readable_Getter");

  serial_port_v8_internal::ReadableAttributeGetter(info);
}

void V8SerialPort::WritableAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SerialPort_writable_Getter");

  serial_port_v8_internal::WritableAttributeGetter(info);
}
...
void V8SerialPort::GetSignalsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  serial_port_v8_internal::GetSignalsMethod(info);
}

void V8SerialPort::SetSignalsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  serial_port_v8_internal::SetSignalsMethod(info);
}
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    if (is_secure_context) {
      ...
      kAccessorConfigurations[] = {
          { "readable", V8SerialPort::ReadableAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
          { "writable", V8SerialPort::WritableAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
      };
    ...
    if (is_secure_context) {
      {
        // Install getSignals configuration
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
            {"getSignals", V8SerialPort::GetSignalsMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
        };
        for (const auto& config : kConfigurations) {
          V8DOMConfiguration::InstallMethod(
              isolate, world, instance_object, prototype_object,
    ...
    if (is_secure_context) {
      {
        // Install setSignals configuration
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
            {"setSignals", V8SerialPort::SetSignalsMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
        };
        for (const auto& config : kConfigurations) {
          V8DOMConfiguration::InstallMethod(
              isolate, world, instance_object, prototype_object,
