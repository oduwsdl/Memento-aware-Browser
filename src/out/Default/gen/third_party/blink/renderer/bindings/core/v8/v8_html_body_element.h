...
class V8HTMLBodyElement {
 ...
 public:
  ...
  static void InstallPortals(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::Object> instance, v8::Local<v8::Object> prototype, v8::Local<v8::Function> interface);
  static void InstallPortals(ScriptState*, v8::Local<v8::Object> instance);
  static void InstallPortals(ScriptState*);
  ...
  CORE_EXPORT static void OntimezonechangeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void OntimezonechangeAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
