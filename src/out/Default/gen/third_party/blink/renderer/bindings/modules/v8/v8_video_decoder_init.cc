...
eternalV8VideoDecoderInitKeys(v8::Isolate* isolate) {
...
void V8VideoDecoderInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, VideoDecoderInit* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8VideoDecoderInitKeys(isolate).data();
  ...
  if (output_value.IsEmpty() || output_value->IsUndefined()) {
    ...
    V8VideoFrameOutputCallback* output_cpp_value = V8VideoFrameOutputCallback::Create(output_value.As<v8::Function>());
    impl->setOutput(output_cpp_value);
  }
}

v8::Local<v8::Value> VideoDecoderInit::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8VideoDecoderInit(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8VideoDecoderInit(const VideoDecoderInit* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const auto* keys = eternalV8VideoDecoderInitKeys(isolate).data();
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
...
VideoDecoderInit* NativeValueTraits<VideoDecoderInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  VideoDecoderInit* impl = MakeGarbageCollected<VideoDecoderInit>();
  V8VideoDecoderInit::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
