...
CORE_EXPORT extern const WrapperTypeInfo v8_event_counts_wrapper_type_info;

class V8EventCounts {
  STATIC_ONLY(V8EventCounts);
 public:
  CORE_EXPORT static bool HasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> FindInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  CORE_EXPORT static v8::Local<v8::FunctionTemplate> DomTemplate(v8::Isolate*, const DOMWrapperWorld&);
  static EventCounts* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<EventCounts>();
  }
  CORE_EXPORT static EventCounts* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);

  CORE_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_event_counts_wrapper_type_info;
  }
...
template <>
struct V8TypeOf<EventCounts> {
  typedef V8EventCounts Type;
};
