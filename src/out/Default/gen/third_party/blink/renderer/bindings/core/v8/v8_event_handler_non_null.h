...
class CORE_EXPORT V8EventHandlerNonNull final : public CallbackFunctionBase {
 public:
  ...
  v8::Maybe<ScriptValue> Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<ScriptValue>& args) WARN_UNUSED_RESULT;

  // Performs "construct".
  // https://heycam.github.io/webidl/#construct-a-callback-function
  v8::Maybe<ScriptValue> Construct(const HeapVector<ScriptValue>& args) WARN_UNUSED_RESULT;
  ...
  v8::Maybe<ScriptValue> InvokeWithoutRunnabilityCheck(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<ScriptValue>& args) WARN_UNUSED_RESULT;
};
