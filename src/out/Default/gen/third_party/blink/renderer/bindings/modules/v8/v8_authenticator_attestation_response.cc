...
static void AttestationObjectAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValueFast(info, WTF::GetPtr(impl->attestationObject()), impl);
}
...
static void GetAuthenticatorDataMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  AuthenticatorAttestationResponse* impl = V8AuthenticatorAttestationResponse::ToImpl(info.Holder());

  V8SetReturnValue(info, impl->getAuthenticatorData());
}

static void GetPublicKeyMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  AuthenticatorAttestationResponse* impl = V8AuthenticatorAttestationResponse::ToImpl(info.Holder());

  V8SetReturnValue(info, impl->getPublicKey());
}

static void GetPublicKeyAlgorithmMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  AuthenticatorAttestationResponse* impl = V8AuthenticatorAttestationResponse::ToImpl(info.Holder());

  V8SetReturnValueInt(info, impl->getPublicKeyAlgorithm());
}
...
void V8AuthenticatorAttestationResponse::GetAuthenticatorDataMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  authenticator_attestation_response_v8_internal::GetAuthenticatorDataMethod(info);
}

void V8AuthenticatorAttestationResponse::GetPublicKeyMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  authenticator_attestation_response_v8_internal::GetPublicKeyMethod(info);
}

void V8AuthenticatorAttestationResponse::GetPublicKeyAlgorithmMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  authenticator_attestation_response_v8_internal::GetPublicKeyAlgorithmMethod(info);
}
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    if (is_secure_context) {
      ...
      kAccessorConfigurations[] = {
          { "attestationObject", V8AuthenticatorAttestationResponse::AttestationObjectAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
      };
    ...
    if (is_secure_context) {
      {
        // Install getAuthenticatorData configuration
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
            {"getAuthenticatorData", V8AuthenticatorAttestationResponse::GetAuthenticatorDataMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
        };
        for (const auto& config : kConfigurations) {
          V8DOMConfiguration::InstallMethod(
              isolate, world, instance_object, prototype_object,
    ...
    if (is_secure_context) {
      {
        // Install getPublicKey configuration
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
            {"getPublicKey", V8AuthenticatorAttestationResponse::GetPublicKeyMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
        };
        for (const auto& config : kConfigurations) {
          V8DOMConfiguration::InstallMethod(
              isolate, world, instance_object, prototype_object,
    ...
    if (is_secure_context) {
      {
        // Install getPublicKeyAlgorithm configuration
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
            {"getPublicKeyAlgorithm", V8AuthenticatorAttestationResponse::GetPublicKeyAlgorithmMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
        };
        for (const auto& config : kConfigurations) {
          V8DOMConfiguration::InstallMethod(
              isolate, world, instance_object, prototype_object,
