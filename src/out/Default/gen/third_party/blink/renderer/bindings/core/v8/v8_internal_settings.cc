...
static void SetUniversalAccessFromFileURLsMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "InternalSettings", "setUniversalAccessFromFileURLs");
  ...
  impl->setUniversalAccessFromFileURLs(enabled, exception_state);
  if (exception_state.HadException()) {
    return;
  }
}
...
void V8InternalSettings::SetPictographFontFamilyMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("InternalSettings.setPictographFontFamily");
...
void V8InternalSettings::SetUniversalAccessFromFileURLsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  internal_settings_v8_internal::SetUniversalAccessFromFileURLsMethod(info);
}
...
void V8InternalSettings::SetLangAttributeAwareFormControlUIEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("InternalSettings.setLangAttributeAwareFormControlUIEnabled");
...
void V8InternalSettings::SetExperimentalContentSecurityPolicyFeaturesEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("InternalSettings.setExperimentalContentSecurityPolicyFeaturesEnabled");
...
void V8InternalSettings::SetScrollTopLeftInteropEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("InternalSettings.setScrollTopLeftInteropEnabled");
...
static constexpr V8DOMConfiguration::MethodConfiguration kV8InternalSettingsMethods[] = {
    ...
    {"setUniversalAccessFromFileURLs", V8InternalSettings::SetUniversalAccessFromFileURLsMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
