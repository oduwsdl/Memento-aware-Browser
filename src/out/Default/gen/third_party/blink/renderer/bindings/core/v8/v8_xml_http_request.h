...
class V8XMLHttpRequest {
 ...
 public:
  ...
  CORE_EXPORT static void TrustTokenOperationErrorAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void SetTrustTokenMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
