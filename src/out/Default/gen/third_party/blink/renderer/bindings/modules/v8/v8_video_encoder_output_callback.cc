...
const char* V8VideoEncoderOutputCallback::NameInHeapSnapshot() const {
  return "V8VideoEncoderOutputCallback";
}

v8::Maybe<void> V8VideoEncoderOutputCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, EncodedVideoChunk* chunk) {
  ...
  v8::Local<v8::Value> v8_chunk = ToV8(chunk, argument_creation_context, GetIsolate());
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_chunk };
...
void V8VideoEncoderOutputCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, EncodedVideoChunk* chunk) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, chunk);
