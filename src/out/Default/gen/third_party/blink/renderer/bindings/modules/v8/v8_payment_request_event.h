...
class V8PaymentRequestEvent {
 ...
 public:
  ...
  MODULES_EXPORT static void PaymentOptionsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void ShippingOptionsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void ChangeShippingAddressMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void ChangeShippingOptionMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
