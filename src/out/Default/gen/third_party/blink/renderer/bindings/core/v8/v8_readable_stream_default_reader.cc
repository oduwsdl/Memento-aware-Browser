...
const WrapperTypeInfo& ReadableStreamReader::wrapper_type_info_ = v8_readable_stream_default_reader_wrapper_type_info;

// not [ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, ReadableStreamReader>::value,
    "ReadableStreamReader inherits from ActiveScriptWrappable<>, but is not specifying "
    "[ActiveScriptWrappable] extended attribute in the IDL file.  "
    "Be consistent.");
static_assert(
    std::is_same<decltype(&ReadableStreamReader::HasPendingActivity),
                 decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "ReadableStreamReader is overriding hasPendingActivity(), but is not specifying "
    "[ActiveScriptWrappable] extended attribute in the IDL file.  "
    "Be consistent.");
...
static void ClosedAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ReadableStreamReader* impl = V8ReadableStreamDefaultReader::ToImpl(holder);
...
static void CancelMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ReadableStreamReader* impl = V8ReadableStreamDefaultReader::ToImpl(info.Holder());
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ReadableStreamReader_ConstructorCallback");
  ...
  ReadableStreamReader* impl = ReadableStreamReader::Create(script_state, stream, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ReadableStreamReader_Constructor");
  ...
  readable_stream_reader_v8_internal::Constructor(info);
}

}  // namespace readable_stream_reader_v8_internal

void V8ReadableStreamDefaultReader::ClosedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ReadableStreamReader_closed_Getter");

  readable_stream_reader_v8_internal::ClosedAttributeGetter(info);
}
...
void V8ReadableStreamDefaultReader::CancelMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ReadableStreamReader_cancel");

  readable_stream_reader_v8_internal::CancelMethod(info);
}
...
void V8ReadableStreamDefaultReader::ReadMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ReadableStreamReader_read");

  readable_stream_reader_v8_internal::ReadMethod(info);
}
...
void V8ReadableStreamDefaultReader::ReleaseLockMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ReadableStreamReader_releaseLock");

  readable_stream_reader_v8_internal::ReleaseLockMethod(info);
}
...
static void InstallV8ReadableStreamDefaultReaderTemplate(
  ...
  interface_template->SetCallHandler(readable_stream_reader_v8_internal::ConstructorCallback);
  ...
  kAccessorConfigurations[] = {
      { "closed", V8ReadableStreamDefaultReader::ClosedAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::DontEnum | v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
  };
...
ReadableStreamReader* V8ReadableStreamDefaultReader::ToImplWithTypeCheck(
