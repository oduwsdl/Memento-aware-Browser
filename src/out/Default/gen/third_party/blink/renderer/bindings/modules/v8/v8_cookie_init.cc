...
eternalV8CookieInitKeys(v8::Isolate* isolate) {
...
void V8CookieInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, CookieInit* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8CookieInitKeys(isolate).data();
  ...
  if (!v8Object->Get(context, keys[5].Get(isolate)).ToLocal(&value_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
...
v8::Local<v8::Value> CookieInit::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8CookieInit(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8CookieInit(const CookieInit* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const auto* keys = eternalV8CookieInitKeys(isolate).data();
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
...
CookieInit* NativeValueTraits<CookieInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  CookieInit* impl = MakeGarbageCollected<CookieInit>();
  V8CookieInit::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
