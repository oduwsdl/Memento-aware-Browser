...
const WrapperTypeInfo v8_subtle_crypto_wrapper_type_info = {
    ...
    V8SubtleCrypto::InstallConditionalFeatures,
    "SubtleCrypto",
    nullptr,
...
static void EncryptMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ObjectOrString algorithm;
  CryptoKey* key;
  ArrayBufferOrArrayBufferView data;
  V8ObjectOrString::ToImpl(info.GetIsolate(), info[0], algorithm, UnionTypeConversionMode::kNotNullable, exception_state);
  ...
  ScriptPromise result = impl->encrypt(script_state, algorithm, key, data, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
static void DecryptMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->decrypt(script_state, algorithm, key, data, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void SignMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->sign(script_state, algorithm, key, data, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void VerifyMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->verifySignature(script_state, algorithm, key, signature, data, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void DigestMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->digest(script_state, algorithm, data, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void GenerateKeyMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->generateKey(script_state, algorithm, extractable, key_usages, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void DeriveKeyMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ObjectOrString algorithm;
  CryptoKey* base_key;
  ObjectOrString derived_key_type;
  bool extractable;
  Vector<String> key_usages;
  V8ObjectOrString::ToImpl(info.GetIsolate(), info[0], algorithm, UnionTypeConversionMode::kNotNullable, exception_state);
  if (exception_state.HadException())
  ...
  V8ObjectOrString::ToImpl(info.GetIsolate(), info[2], derived_key_type, UnionTypeConversionMode::kNotNullable, exception_state);
  if (exception_state.HadException())
    return;
  ...
  ScriptPromise result = impl->deriveKey(script_state, algorithm, base_key, derived_key_type, extractable, key_usages, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void DeriveBitsMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->deriveBits(script_state, algorithm, base_key, length, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void ImportKeyMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ArrayBufferOrArrayBufferViewOrJsonWebKey key_data;
  ObjectOrString algorithm;
  bool extractable;
  Vector<String> key_usages;
  format = info[0];
  ...
  V8ArrayBufferOrArrayBufferViewOrJsonWebKey::ToImpl(info.GetIsolate(), info[1], key_data, UnionTypeConversionMode::kNotNullable, exception_state);
  if (exception_state.HadException())
    return;

  V8ObjectOrString::ToImpl(info.GetIsolate(), info[2], algorithm, UnionTypeConversionMode::kNotNullable, exception_state);
  if (exception_state.HadException())
    return;
  ...
  ScriptPromise result = impl->importKey(script_state, format, key_data, algorithm, extractable, key_usages, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void WrapKeyMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8ObjectOrString::ToImpl(info.GetIsolate(), info[3], wrap_algorithm, UnionTypeConversionMode::kNotNullable, exception_state);
  if (exception_state.HadException())
    return;

  ScriptPromise result = impl->wrapKey(script_state, format, key, wrapping_key, wrap_algorithm, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void UnwrapKeyMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ObjectOrString unwrap_algorithm;
  ObjectOrString unwrapped_key_algorithm;
  bool extractable;
  Vector<String> key_usages;
  format = info[0];
  if (!format.Prepare(exception_state))
  ...
  V8ObjectOrString::ToImpl(info.GetIsolate(), info[3], unwrap_algorithm, UnionTypeConversionMode::kNotNullable, exception_state);
  if (exception_state.HadException())
    return;

  V8ObjectOrString::ToImpl(info.GetIsolate(), info[4], unwrapped_key_algorithm, UnionTypeConversionMode::kNotNullable, exception_state);
  if (exception_state.HadException())
    return;
  ...
  ScriptPromise result = impl->unwrapKey(script_state, format, wrapped_key, unwrapping_key, unwrap_algorithm, unwrapped_key_algorithm, extractable, key_usages, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
void V8SubtleCrypto::InstallConditionalFeatures(
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    ...
    if (is_secure_context) {
      {
        // Install generateKey configuration
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
    ...
    if (is_secure_context) {
      {
        // Install deriveKey configuration
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
    ...
    if (is_secure_context) {
      {
        // Install deriveBits configuration
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
    ...
    if (is_secure_context) {
      {
        // Install importKey configuration
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
    ...
    if (is_secure_context) {
      {
        // Install exportKey configuration
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
    ...
    if (is_secure_context) {
      {
        // Install unwrapKey configuration
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
