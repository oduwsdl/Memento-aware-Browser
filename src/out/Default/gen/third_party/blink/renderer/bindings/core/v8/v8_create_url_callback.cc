...
v8::Maybe<String> V8CreateURLCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& input, const HeapVector<ScriptValue>& args) {
  ...
  //   an IDL value of the same type as the operation's return type.
  {
    ExceptionState exception_state(GetIsolate(),
                                   ...
                                   "invoke");
    auto native_result =
        NativeValueTraits<IDLUSVStringOrNull>::NativeValue(
