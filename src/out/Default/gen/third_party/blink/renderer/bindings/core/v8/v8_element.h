...
class V8Element {
 ...
 public:
  ...
  CORE_EXPORT static void OnbeforematchAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void OnbeforematchAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void GetInnerHTMLMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
