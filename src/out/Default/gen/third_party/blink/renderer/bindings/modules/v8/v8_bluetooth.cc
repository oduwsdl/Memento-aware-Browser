...
static void GetDevicesMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "Bluetooth", "getDevices");
  ExceptionToRejectPromiseScope reject_promise_scope(info, exception_state);
...
void V8Bluetooth::GetDevicesMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  bluetooth_v8_internal::GetDevicesMethod(info);
}
      ...
      if (RuntimeEnabledFeatures::WebBluetoothGetDevicesEnabled()) {
        {
          ...
          const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
              {"getDevices", V8Bluetooth::GetDevicesMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
          };
          for (const auto& config : kConfigurations) {
            V8DOMConfiguration::InstallMethod(
                isolate, world, instance_object, prototype_object,
