...
class V8Location {
 ...
 public:
  ...
  static void InstallTextFragmentIdentifiers(ScriptState*);
  ...
  CORE_EXPORT static void FragmentDirectiveAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
