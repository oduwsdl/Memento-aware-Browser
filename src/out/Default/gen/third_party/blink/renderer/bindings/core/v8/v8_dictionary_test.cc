...
static void GetMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  InternalDictionary* result = impl->get(info.GetIsolate());
...
static void GetDerivedMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  InternalDictionaryDerived* result = impl->getDerived(info.GetIsolate());
  V8SetReturnValue(info, result);
}
...
static void GetDerivedDerivedMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  InternalDictionaryDerivedDerived* result = impl->getDerivedDerived(info.GetIsolate());
  V8SetReturnValue(info, result);
}
