...
class V8NavigatorPartial {
 ...
 public:
  ...
  static void InstallSerial(ScriptState*);
  ...
  static void InkAttributeGetterCallback(    const v8::FunctionCallbackInfo<v8::Value>& info);
  ...
  static void VirtualKeyboardAttributeGetterCallback(    const v8::FunctionCallbackInfo<v8::Value>& info);
