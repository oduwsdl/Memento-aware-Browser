...
static void ApplicationServerKeyAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValueFast(info, WTF::GetPtr(impl->applicationServerKey()), impl);
}
...
static void InstallV8PushSubscriptionOptionsTemplate(
  ...
  kAccessorConfigurations[] = {
      { "userVisibleOnly", V8PushSubscriptionOptions::UserVisibleOnlyAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
