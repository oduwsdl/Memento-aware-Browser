...
class V8OriginTrialsTest {
 ...
 public:
  ...
  static void InstallOriginTrialsSampleAPINavigation(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::Object> instance, v8::Local<v8::Object> prototype, v8::Local<v8::Function> interface);
  static void InstallOriginTrialsSampleAPINavigation(ScriptState*, v8::Local<v8::Object> instance);
  static void InstallOriginTrialsSampleAPINavigation(ScriptState*);

  static void InstallOriginTrialsSampleAPIDeprecation(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::Object> instance, v8::Local<v8::Object> prototype, v8::Local<v8::Function> interface);
  static void InstallOriginTrialsSampleAPIDeprecation(ScriptState*, v8::Local<v8::Object> instance);
  static void InstallOriginTrialsSampleAPIDeprecation(ScriptState*);
  ...
  static void DeprecationAttributeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  static void NavigationMethodMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
