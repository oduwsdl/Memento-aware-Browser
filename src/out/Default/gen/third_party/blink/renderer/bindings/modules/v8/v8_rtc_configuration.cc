...
eternalV8RTCConfigurationKeys(v8::Isolate* isolate) {
...
void V8RTCConfiguration::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, RTCConfiguration* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8RTCConfigurationKeys(isolate).data();
  ...
  if (!v8Object->Get(context, keys[5].Get(isolate)).ToLocal(&ice_candidate_pool_size_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[6].Get(isolate)).ToLocal(&ice_servers_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[7].Get(isolate)).ToLocal(&ice_transport_policy_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[8].Get(isolate)).ToLocal(&ice_transports_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[9].Get(isolate)).ToLocal(&offer_extmap_allow_mixed_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[13].Get(isolate)).ToLocal(&rtcp_mux_policy_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (RuntimeEnabledFeatures::RTCUnifiedPlanEnabled()) {
    ...
    if (!v8Object->Get(context, keys[14].Get(isolate)).ToLocal(&sdp_semantics_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
  ...
  if (RuntimeEnabledFeatures::RTCInsertableStreamsEnabled(executionContext)) {
    v8::Local<v8::Value> encoded_insertable_streams_value;
    if (!v8Object->Get(context, keys[2].Get(isolate)).ToLocal(&encoded_insertable_streams_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
    if (encoded_insertable_streams_value.IsEmpty() || encoded_insertable_streams_value->IsUndefined()) {
      // Do nothing.
    } else {
      bool encoded_insertable_streams_cpp_value = NativeValueTraits<IDLBoolean>::NativeValue(isolate, encoded_insertable_streams_value, exception_state);
      if (exception_state.HadException())
        return;
      impl->setEncodedInsertableStreams(encoded_insertable_streams_cpp_value);
    }

    v8::Local<v8::Value> force_encoded_audio_insertable_streams_value;
    if (!v8Object->Get(context, keys[3].Get(isolate)).ToLocal(&force_encoded_audio_insertable_streams_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
    if (force_encoded_audio_insertable_streams_value.IsEmpty() || force_encoded_audio_insertable_streams_value->IsUndefined()) {
      // Do nothing.
    } else {
      Deprecation::CountDeprecation(CurrentExecutionContext(isolate), WebFeature::kForceEncodedAudioInsertableStreams);
      bool force_encoded_audio_insertable_streams_cpp_value = NativeValueTraits<IDLBoolean>::NativeValue(isolate, force_encoded_audio_insertable_streams_value, exception_state);
      if (exception_state.HadException())
        return;
      impl->setForceEncodedAudioInsertableStreams(force_encoded_audio_insertable_streams_cpp_value);
    }

    v8::Local<v8::Value> force_encoded_video_insertable_streams_value;
    if (!v8Object->Get(context, keys[4].Get(isolate)).ToLocal(&force_encoded_video_insertable_streams_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
    if (force_encoded_video_insertable_streams_value.IsEmpty() || force_encoded_video_insertable_streams_value->IsUndefined()) {
      // Do nothing.
    } else {
      Deprecation::CountDeprecation(CurrentExecutionContext(isolate), WebFeature::kForceEncodedVideoInsertableStreams);
      bool force_encoded_video_insertable_streams_cpp_value = NativeValueTraits<IDLBoolean>::NativeValue(isolate, force_encoded_video_insertable_streams_value, exception_state);
      if (exception_state.HadException())
        return;
      impl->setForceEncodedVideoInsertableStreams(force_encoded_video_insertable_streams_cpp_value);
    }
  }
  ...
  if (RuntimeEnabledFeatures::RtcAudioJitterBufferMaxPacketsEnabled(executionContext)) {
    ...
    if (!v8Object->Get(context, keys[10].Get(isolate)).ToLocal(&rtc_audio_jitter_buffer_fast_accelerate_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
    ...
    if (!v8Object->Get(context, keys[11].Get(isolate)).ToLocal(&rtc_audio_jitter_buffer_max_packets_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
    ...
    if (!v8Object->Get(context, keys[12].Get(isolate)).ToLocal(&rtc_audio_jitter_buffer_min_delay_ms_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
...
bool toV8RTCConfiguration(const RTCConfiguration* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (ice_candidate_pool_size_has_value_or_default &&
      !create_property(5, ice_candidate_pool_size_value)) {
    return false;
  }
  ...
  if (ice_servers_has_value_or_default &&
      !create_property(6, ice_servers_value)) {
    return false;
  }
  ...
  if (ice_transport_policy_has_value_or_default &&
      !create_property(7, ice_transport_policy_value)) {
    return false;
  }
  ...
  if (ice_transports_has_value_or_default &&
      !create_property(8, ice_transports_value)) {
    return false;
  }
  ...
  if (offer_extmap_allow_mixed_has_value_or_default &&
      !create_property(9, offer_extmap_allow_mixed_value)) {
    return false;
  }
  ...
  if (rtcp_mux_policy_has_value_or_default &&
      !create_property(13, rtcp_mux_policy_value)) {
    return false;
  }
  ...
  if (RuntimeEnabledFeatures::RTCUnifiedPlanEnabled()) {
    ...
    if (sdp_semantics_has_value_or_default &&
        !create_property(14, sdp_semantics_value)) {
      return false;
    }
  }
  ...
  if (RuntimeEnabledFeatures::RTCInsertableStreamsEnabled(executionContext)) {
    v8::Local<v8::Value> encoded_insertable_streams_value;
    bool encoded_insertable_streams_has_value_or_default = false;
    if (impl->hasEncodedInsertableStreams()) {
      encoded_insertable_streams_value = v8::Boolean::New(isolate, impl->encodedInsertableStreams());
      encoded_insertable_streams_has_value_or_default = true;
    } else {
      encoded_insertable_streams_value = v8::Boolean::New(isolate, false);
      encoded_insertable_streams_has_value_or_default = true;
    }
    if (encoded_insertable_streams_has_value_or_default &&
        !create_property(2, encoded_insertable_streams_value)) {
      return false;
    }

    v8::Local<v8::Value> force_encoded_audio_insertable_streams_value;
    bool force_encoded_audio_insertable_streams_has_value_or_default = false;
    if (impl->hasForceEncodedAudioInsertableStreams()) {
      force_encoded_audio_insertable_streams_value = v8::Boolean::New(isolate, impl->forceEncodedAudioInsertableStreams());
      force_encoded_audio_insertable_streams_has_value_or_default = true;
    } else {
      force_encoded_audio_insertable_streams_value = v8::Boolean::New(isolate, false);
      force_encoded_audio_insertable_streams_has_value_or_default = true;
    }
    if (force_encoded_audio_insertable_streams_has_value_or_default &&
        !create_property(3, force_encoded_audio_insertable_streams_value)) {
      return false;
    }

    v8::Local<v8::Value> force_encoded_video_insertable_streams_value;
    bool force_encoded_video_insertable_streams_has_value_or_default = false;
    if (impl->hasForceEncodedVideoInsertableStreams()) {
      force_encoded_video_insertable_streams_value = v8::Boolean::New(isolate, impl->forceEncodedVideoInsertableStreams());
      force_encoded_video_insertable_streams_has_value_or_default = true;
    } else {
      force_encoded_video_insertable_streams_value = v8::Boolean::New(isolate, false);
      force_encoded_video_insertable_streams_has_value_or_default = true;
    }
    if (force_encoded_video_insertable_streams_has_value_or_default &&
        !create_property(4, force_encoded_video_insertable_streams_value)) {
      return false;
    }
  }
  ...
  if (RuntimeEnabledFeatures::RtcAudioJitterBufferMaxPacketsEnabled(executionContext)) {
    ...
    if (rtc_audio_jitter_buffer_fast_accelerate_has_value_or_default &&
        !create_property(10, rtc_audio_jitter_buffer_fast_accelerate_value)) {
      return false;
    }
    ...
    if (rtc_audio_jitter_buffer_max_packets_has_value_or_default &&
        !create_property(11, rtc_audio_jitter_buffer_max_packets_value)) {
      return false;
    }
    ...
    if (rtc_audio_jitter_buffer_min_delay_ms_has_value_or_default &&
        !create_property(12, rtc_audio_jitter_buffer_min_delay_ms_value)) {
      return false;
    }
  }
