...
class V8HIDReportItem {
 ...
 public:
  ...
  MODULES_EXPORT static void UnitSystemAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void UnitFactorLengthExponentAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void UnitFactorMassExponentAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void UnitFactorTimeExponentAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void UnitFactorTemperatureExponentAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void UnitFactorCurrentExponentAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void UnitFactorLuminousIntensityExponentAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void StringsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
