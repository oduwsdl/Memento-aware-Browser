...
static void DeleteQueryEXTMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!query && !IsUndefinedOrNull(info[0])) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("deleteQueryEXT", "EXTDisjointTimerQuery", ExceptionMessages::ArgumentNotOfType(0, "WebGLTimerQueryEXT")));
    return;
  }
...
static void IsQueryEXTMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  query = V8WebGLTimerQueryEXT::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!query && !IsUndefinedOrNull(info[0])) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("isQueryEXT", "EXTDisjointTimerQuery", ExceptionMessages::ArgumentNotOfType(0, "WebGLTimerQueryEXT")));
    return;
  }
...
static void BeginQueryEXTMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!query) {
    exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(1, "WebGLTimerQueryEXT"));
    return;
  }
...
static void QueryCounterEXTMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  query = V8WebGLTimerQueryEXT::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!query) {
    exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(0, "WebGLTimerQueryEXT"));
    return;
  }
