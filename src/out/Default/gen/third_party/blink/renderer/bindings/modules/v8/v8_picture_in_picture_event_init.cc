...
eternalV8PictureInPictureEventInitKeys(v8::Isolate* isolate) {
...
void V8PictureInPictureEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, PictureInPictureEventInit* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8PictureInPictureEventInitKeys(isolate).data();
...
v8::Local<v8::Value> PictureInPictureEventInit::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8PictureInPictureEventInit(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8PictureInPictureEventInit(const PictureInPictureEventInit* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
...
PictureInPictureEventInit* NativeValueTraits<PictureInPictureEventInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  PictureInPictureEventInit* impl = MakeGarbageCollected<PictureInPictureEventInit>();
  V8PictureInPictureEventInit::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
