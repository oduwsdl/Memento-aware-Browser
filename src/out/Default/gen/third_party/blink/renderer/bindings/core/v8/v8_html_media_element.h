...
class V8HTMLMediaElement {
 ...
 public:
  ...
  CORE_EXPORT static void LatencyHintAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void LatencyHintAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
