...
class V8InternalSettingsGenerated {
 ...
 public:
  ...
  static void SetAccessibilityAlwaysShowFocusMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  static void SetAriaModalPrunesAXTreeMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  static void SetForceDarkModeBackgroundBrightnessThresholdMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetForceDarkModeContrastMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetForceDarkModeEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetForceDarkModeGrayscaleMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetForceDarkModeTextBrightnessThresholdMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
