...
static void InstallV8SVGPreserveAspectRatioTemplate(
  ...
  kAccessorConfigurations[] = {
      { "align", V8SVGPreserveAspectRatio::AlignAttributeGetterCallback, V8SVGPreserveAspectRatio::AlignAttributeSetterCallback, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
      { "meetOrSlice", V8SVGPreserveAspectRatio::MeetOrSliceAttributeGetterCallback, V8SVGPreserveAspectRatio::MeetOrSliceAttributeSetterCallback, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
  };
