...
static void ShareVideoImageWEBGLMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "WebGLVideoTexture", "shareVideoImageWEBGL");
  ...
  VideoFrameMetadata* result = impl->shareVideoImageWEBGL(execution_context, target, video, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
static void ReleaseVideoImageWEBGLMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "WebGLVideoTexture", "releaseVideoImageWEBGL");
  ...
  ExecutionContext* execution_context = ExecutionContext::ForRelevantRealm(info);
  bool result = impl->releaseVideoImageWEBGL(execution_context, target, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
void V8WebGLVideoTexture::ShareVideoImageWEBGLMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  webgl_video_texture_v8_internal::ShareVideoImageWEBGLMethod(info);
}

void V8WebGLVideoTexture::ReleaseVideoImageWEBGLMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  webgl_video_texture_v8_internal::ReleaseVideoImageWEBGLMethod(info);
}

static constexpr V8DOMConfiguration::MethodConfiguration kV8WebGLVideoTextureMethods[] = {
    {"shareVideoImageWEBGL", V8WebGLVideoTexture::ShareVideoImageWEBGLMethodCallback, 2, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
    {"releaseVideoImageWEBGL", V8WebGLVideoTexture::ReleaseVideoImageWEBGLMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
};
