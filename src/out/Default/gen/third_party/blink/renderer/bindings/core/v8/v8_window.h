...
class V8Window {
 ...
 public:
  ...
  static void InstallAppCache(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::Object> instance, v8::Local<v8::Object> prototype, v8::Local<v8::Function> interface);
  static void InstallAppCache(ScriptState*, v8::Local<v8::Object> instance);
  ...
  CORE_EXPORT static v8::Local<v8::Private> WindowCachedPropertyKey(v8::Isolate*);
  CORE_EXPORT static void WindowAttributeGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
  CORE_EXPORT static v8::Local<v8::Private> SelfCachedPropertyKey(v8::Isolate*);
  ...
  CORE_EXPORT static v8::Local<v8::Private> FramesCachedPropertyKey(v8::Isolate*);
  ...
  CORE_EXPORT static void OriginPolicyIdsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void CSSScrollTimelineRuleConstructorGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void EventCountsConstructorGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
  CORE_EXPORT static void IsInputPendingOptionsConstructorGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void LayoutShiftAttributionConstructorGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void GetWindowSegmentsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
