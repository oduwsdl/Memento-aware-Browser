...
v8::Maybe<void> V8NavigatorUserMediaErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const DOMExceptionOrOverconstrainedError& error) {
...
void V8NavigatorUserMediaErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const DOMExceptionOrOverconstrainedError& error) {
