...
// This static member must be declared by DEFINE_WRAPPERTYPEINFO in MediaSourceImpl.h.
// For details, see the comment of DEFINE_WRAPPERTYPEINFO in
// platform/bindings/ScriptWrappable.h.
const WrapperTypeInfo& MediaSourceImpl::wrapper_type_info_ = v8_media_source_wrapper_type_info;

// [ActiveScriptWrappable]
static_assert(
    std::is_base_of<ActiveScriptWrappableBase, MediaSourceImpl>::value,
    "MediaSourceImpl does not inherit from ActiveScriptWrappable<>, but specifying "
    "[ActiveScriptWrappable] extended attribute in the IDL file.  "
    "Be consistent.");
static_assert(
    !std::is_same<decltype(&MediaSourceImpl::HasPendingActivity),
                  decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "MediaSourceImpl is not overriding hasPendingActivity(), but is specifying "
    "[ActiveScriptWrappable] extended attribute in the IDL file.  "
    "Be consistent.");

namespace media_source_impl_v8_internal {

static void SourceBuffersAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();

  MediaSourceImpl* impl = V8MediaSource::ToImpl(holder);
...
static void AddSourceBufferMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  MediaSourceImpl* impl = V8MediaSource::ToImpl(info.Holder());
...
static void IsTypeSupportedMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValueBool(info, MediaSourceImpl::isTypeSupported(type));
}

static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_ConstructorCallback");

  ExecutionContext* execution_context = ToExecutionContext(
      info.NewTarget().As<v8::Object>()->CreationContext());
  MediaSourceImpl* impl = MediaSourceImpl::Create(execution_context);
...
MODULES_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_Constructor");
  ...
  media_source_impl_v8_internal::Constructor(info);
}

}  // namespace media_source_impl_v8_internal

void V8MediaSource::SourceBuffersAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_sourceBuffers_Getter");

  media_source_impl_v8_internal::SourceBuffersAttributeGetter(info);
}

void V8MediaSource::ActiveSourceBuffersAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_activeSourceBuffers_Getter");

  media_source_impl_v8_internal::ActiveSourceBuffersAttributeGetter(info);
}

void V8MediaSource::DurationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_duration_Getter");

  media_source_impl_v8_internal::DurationAttributeGetter(info);
}

void V8MediaSource::DurationAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_duration_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  media_source_impl_v8_internal::DurationAttributeSetter(v8_value, info);
}

void V8MediaSource::OnsourceopenAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_onsourceopen_Getter");

  media_source_impl_v8_internal::OnsourceopenAttributeGetter(info);
}

void V8MediaSource::OnsourceopenAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_onsourceopen_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  media_source_impl_v8_internal::OnsourceopenAttributeSetter(v8_value, info);
}

void V8MediaSource::OnsourceendedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_onsourceended_Getter");

  media_source_impl_v8_internal::OnsourceendedAttributeGetter(info);
}

void V8MediaSource::OnsourceendedAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_onsourceended_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  media_source_impl_v8_internal::OnsourceendedAttributeSetter(v8_value, info);
}

void V8MediaSource::OnsourcecloseAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_onsourceclose_Getter");

  media_source_impl_v8_internal::OnsourcecloseAttributeGetter(info);
}

void V8MediaSource::OnsourcecloseAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_onsourceclose_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  media_source_impl_v8_internal::OnsourcecloseAttributeSetter(v8_value, info);
}

void V8MediaSource::ReadyStateAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_readyState_Getter");

  media_source_impl_v8_internal::ReadyStateAttributeGetter(info);
}
...
void V8MediaSource::AddSourceBufferMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_addSourceBuffer");

  media_source_impl_v8_internal::AddSourceBufferMethod(info);
}
...
void V8MediaSource::RemoveSourceBufferMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_removeSourceBuffer");

  media_source_impl_v8_internal::RemoveSourceBufferMethod(info);
}
...
void V8MediaSource::EndOfStreamMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_endOfStream");

  media_source_impl_v8_internal::EndOfStreamMethod(info);
}
...
void V8MediaSource::SetLiveSeekableRangeMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_setLiveSeekableRange");

  media_source_impl_v8_internal::SetLiveSeekableRangeMethod(info);
}
...
void V8MediaSource::ClearLiveSeekableRangeMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_clearLiveSeekableRange");

  media_source_impl_v8_internal::ClearLiveSeekableRangeMethod(info);
}
...
void V8MediaSource::IsTypeSupportedMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaSourceImpl_isTypeSupported");

  media_source_impl_v8_internal::IsTypeSupportedMethod(info);
}
...
static void InstallV8MediaSourceTemplate(
  ...
  interface_template->SetCallHandler(media_source_impl_v8_internal::ConstructorCallback);
  ...
  kAccessorConfigurations[] = {
      { "sourceBuffers", V8MediaSource::SourceBuffersAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
      { "activeSourceBuffers", V8MediaSource::ActiveSourceBuffersAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
      ...
      { "onsourceended", V8MediaSource::OnsourceendedAttributeGetterCallback, V8MediaSource::OnsourceendedAttributeSetterCallback, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
...
MediaSourceImpl* V8MediaSource::ToImplWithTypeCheck(
