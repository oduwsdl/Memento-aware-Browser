...
static void FixedBlockSizeAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  base::Optional<double> cpp_value(impl->fixedBlockSize());
...
static void InstallV8LayoutConstraintsTemplate(
  ...
  kAccessorConfigurations[] = {
      ...
      { "fixedBlockSize", V8LayoutConstraints::FixedBlockSizeAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
