...
class V8RTCDataChannel {
 ...
 public:
  ...
  MODULES_EXPORT static void MaxPacketLifeTimeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void OnclosingAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void OnclosingAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
