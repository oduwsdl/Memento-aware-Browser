...
eternalV8GPUProgrammableStageDescriptorKeys(v8::Isolate* isolate) {
...
void V8GPUProgrammableStageDescriptor::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUProgrammableStageDescriptor* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8GPUProgrammableStageDescriptorKeys(isolate).data();
  ...
  if (entry_point_value.IsEmpty() || entry_point_value->IsUndefined()) {
    ...
    V8StringResource<> entry_point_cpp_value = NativeValueTraits<IDLUSVString>::NativeValue(isolate, entry_point_value, exception_state);
