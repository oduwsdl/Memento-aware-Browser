...
static void AllowPaymentRequestAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValueBool(info, HTMLIFrameElementPayments::FastHasAttribute(*impl, html_names::kAllowpaymentrequestAttr));
}
...
static void AllowPaymentRequestAttributeSetter(
  ...
  HTMLIFrameElementPayments::SetBooleanAttribute(*impl, html_names::kAllowpaymentrequestAttr, cpp_value);
}
...
void V8HTMLIFrameElementPartial::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::PaymentRequestEnabled()) {
    ...
    kAccessorConfigurations[] = {
        { "allowPaymentRequest", V8HTMLIFrameElementPartial::AllowPaymentRequestAttributeGetterCallback, V8HTMLIFrameElementPartial::AllowPaymentRequestAttributeSetterCallback, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    };
