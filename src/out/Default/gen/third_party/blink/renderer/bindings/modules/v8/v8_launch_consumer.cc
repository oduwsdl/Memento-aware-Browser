...
v8::Maybe<ScriptValue> V8LaunchConsumer::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, LaunchParams* params) {
  ...
  v8::Local<v8::Value> v8_params = ToV8(params, argument_creation_context, GetIsolate());
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_params };
...
v8::Maybe<ScriptValue> V8LaunchConsumer::Construct(LaunchParams* params) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "LaunchConsumer",
          "construct");
