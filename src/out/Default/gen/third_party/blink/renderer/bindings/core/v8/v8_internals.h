...
class V8Internals {
 ...
 public:
  ...
  static void SetSystemTimeZoneMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  static void TriggerTestInspectorIssueMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  static void PageZoomFactorMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetIsCursorVisibleMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetMaxNumberOfFramesToTenMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  static void GetAgentIdMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void UseMockOverlayScrollbarsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void GenerateTestReportMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
