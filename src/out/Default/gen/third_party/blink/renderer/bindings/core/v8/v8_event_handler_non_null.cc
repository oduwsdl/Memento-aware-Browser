...
v8::Maybe<ScriptValue> V8EventHandlerNonNull::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<ScriptValue>& args) {
...
v8::Maybe<ScriptValue> V8EventHandlerNonNull::Construct(const HeapVector<ScriptValue>& args) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "EventHandlerNonNull",
          "construct");
...
v8::Maybe<ScriptValue> V8EventHandlerNonNull::InvokeWithoutRunnabilityCheck(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<ScriptValue>& args) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "EventHandlerNonNull",
          "invoke");
