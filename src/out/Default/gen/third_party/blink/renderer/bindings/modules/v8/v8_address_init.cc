...
eternalV8AddressInitKeys(v8::Isolate* isolate) {
...
void V8AddressInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, AddressInit* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8AddressInitKeys(isolate).data();
...
v8::Local<v8::Value> AddressInit::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8AddressInit(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8AddressInit(const AddressInit* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const auto* keys = eternalV8AddressInitKeys(isolate).data();
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
...
AddressInit* NativeValueTraits<AddressInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  AddressInit* impl = MakeGarbageCollected<AddressInit>();
  V8AddressInit::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
