...
class V8BluetoothRemoteGATTCharacteristic {
 ...
 public:
  ...
  MODULES_EXPORT static void WriteValueWithResponseMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void WriteValueWithoutResponseMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
