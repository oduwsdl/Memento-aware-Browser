  ...
  if (RuntimeEnabledFeatures::MediaSessionPositionEnabled()) {
    {
      ...
      constexpr V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
          {"setPositionState", V8MediaSession::SetPositionStateMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
      };
