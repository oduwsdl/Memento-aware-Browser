...
v8::Maybe<String> V8CreateHTMLCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& input, const HeapVector<ScriptValue>& args) {
