...
eternalV8GPURenderPassDepthStencilAttachmentDescriptorKeys(v8::Isolate* isolate) {
...
void V8GPURenderPassDepthStencilAttachmentDescriptor::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPURenderPassDepthStencilAttachmentDescriptor* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8GPURenderPassDepthStencilAttachmentDescriptorKeys(isolate).data();
  ...
  if (stencil_load_value_value.IsEmpty() || stencil_load_value_value->IsUndefined()) {
    ...
    GPULoadOpOrUnsignedLongEnforceRange stencil_load_value_cpp_value;
    V8GPULoadOpOrUnsignedLongEnforceRange::ToImpl(isolate, stencil_load_value_value, stencil_load_value_cpp_value, UnionTypeConversionMode::kNotNullable, exception_state);
    if (exception_state.HadException())
      return;
