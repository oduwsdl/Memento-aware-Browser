...
v8::Maybe<ScriptValue> V8IntrinsicSizesCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<CustomLayoutChild>>& children, CustomLayoutEdges* edges, StylePropertyMapReadOnly* styleMap) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "IntrinsicSizesCallback",
          "invoke");
  ...
  v8::Local<v8::Value> v8_edges = ToV8(edges, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> v8_styleMap = ToV8(styleMap, argument_creation_context, GetIsolate());
  constexpr int argc = 3;
  v8::Local<v8::Value> argv[] = { v8_children, v8_edges, v8_styleMap };
...
v8::Maybe<ScriptValue> V8IntrinsicSizesCallback::Construct(const HeapVector<Member<CustomLayoutChild>>& children, CustomLayoutEdges* edges, StylePropertyMapReadOnly* styleMap) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "IntrinsicSizesCallback",
          "construct");
