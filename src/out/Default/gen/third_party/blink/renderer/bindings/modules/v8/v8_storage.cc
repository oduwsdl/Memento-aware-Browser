...
static void NamedPropertySetter(
  ...
  NamedPropertySetterResult result = impl->setItem(name, property_value, exception_state);
  if (exception_state.HadException())
    return;
...
static void NamedPropertyDeleter(
  ...
  NamedPropertyDeleterResult result = impl->removeItem(name, exception_state);
  if (exception_state.HadException())
    return;
