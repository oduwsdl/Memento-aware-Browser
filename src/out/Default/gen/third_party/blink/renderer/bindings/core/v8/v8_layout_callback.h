...
class CORE_EXPORT V8LayoutCallback final : public CallbackFunctionBase {
 public:
  ...
  v8::Maybe<ScriptValue> Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<CustomLayoutChild>>& children, CustomLayoutEdges* edges, CustomLayoutConstraints* constraints, StylePropertyMapReadOnly* styleMap) WARN_UNUSED_RESULT;

  // Performs "construct".
  // https://heycam.github.io/webidl/#construct-a-callback-function
  v8::Maybe<ScriptValue> Construct(const HeapVector<Member<CustomLayoutChild>>& children, CustomLayoutEdges* edges, CustomLayoutConstraints* constraints, StylePropertyMapReadOnly* styleMap) WARN_UNUSED_RESULT;
};
