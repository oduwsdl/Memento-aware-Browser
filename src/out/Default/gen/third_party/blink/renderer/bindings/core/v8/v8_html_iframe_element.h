...
class V8HTMLIFrameElement {
 ...
 public:
  ...
  static void InstallDocumentPolicy(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::Object> instance, v8::Local<v8::Object> prototype, v8::Local<v8::Function> interface);
  static void InstallDocumentPolicy(ScriptState*, v8::Local<v8::Object> instance);
  static void InstallDocumentPolicy(ScriptState*);

  static void InstallTrustTokens(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::Object> instance, v8::Local<v8::Object> prototype, v8::Local<v8::Function> interface);
  static void InstallTrustTokens(ScriptState*, v8::Local<v8::Object> instance);
  static void InstallTrustTokens(ScriptState*);
  ...
  CORE_EXPORT static void TrustTokenAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void TrustTokenAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
