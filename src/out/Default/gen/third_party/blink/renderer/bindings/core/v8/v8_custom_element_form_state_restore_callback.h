...
class CORE_EXPORT V8CustomElementFormStateRestoreCallback final : public CallbackFunctionBase {
 public:
  ...
  v8::Maybe<void> Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const FileOrUSVStringOrFormData& value, const String& mode) WARN_UNUSED_RESULT;

  // Performs "invoke", and then reports an exception, if any, to the global
  // error handler such as DevTools' console.
  void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const FileOrUSVStringOrFormData& value, const String& mode);
};
