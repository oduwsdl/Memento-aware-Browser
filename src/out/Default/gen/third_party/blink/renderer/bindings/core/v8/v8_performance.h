...
class V8Performance {
 ...
 public:
  ...
  static void InstallMeasureMemory(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::Object> instance, v8::Local<v8::Object> prototype, v8::Local<v8::Function> interface);
  static void InstallMeasureMemory(ScriptState*, v8::Local<v8::Object> instance);
  static void InstallMeasureMemory(ScriptState*);
  ...
  CORE_EXPORT static void EventCountsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
