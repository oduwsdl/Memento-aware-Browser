...
static void Constructor1(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  keyframes = NativeValueTraits<IDLNullable<IDLObject>>::NativeValue(info.GetIsolate(), info[1], exception_state);
  if (exception_state.HadException())
    return;
...
static void InstallV8KeyframeEffectTemplate(
  ...
  kAccessorConfigurations[] = {
      { "target", V8KeyframeEffect::TargetAttributeGetterCallback, V8KeyframeEffect::TargetAttributeSetterCallback, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
  };
...
void V8KeyframeEffect::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::WebAnimationsAPIEnabled()) {
    ...
    kAccessorConfigurations[] = {
        ...
        { "pseudoElement", V8KeyframeEffect::PseudoElementAttributeGetterCallback, V8KeyframeEffect::PseudoElementAttributeSetterCallback, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAccessors(
        isolate, world, instance_template, prototype_template, interface_template,
        signature, kAccessorConfigurations,
