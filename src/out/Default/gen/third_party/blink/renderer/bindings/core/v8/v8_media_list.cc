...
static void MediaTextAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValueString(info, impl->mediaText(execution_context), info.GetIsolate());
}
...
static void MediaTextAttributeSetter(
  ...
  impl->setMediaText(execution_context, cpp_value);
}
...
static void AppendMediumMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context = ExecutionContext::ForRelevantRealm(info);
  impl->appendMedium(execution_context, medium);
}
...
static void DeleteMediumMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context = ExecutionContext::ForRelevantRealm(info);
  impl->deleteMedium(execution_context, medium, exception_state);
  if (exception_state.HadException()) {
    return;
  }
}
...
static void InstallV8MediaListTemplate(
  ...
  kAccessorConfigurations[] = {
      { "mediaText", V8MediaList::MediaTextAttributeGetterCallback, V8MediaList::MediaTextAttributeSetterCallback, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
