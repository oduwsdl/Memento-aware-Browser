...
MODULES_EXPORT extern const WrapperTypeInfo v8_xr_plane_set_wrapper_type_info;

class V8XRPlaneSet {
  STATIC_ONLY(V8XRPlaneSet);
 public:
  MODULES_EXPORT static bool HasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> FindInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  MODULES_EXPORT static v8::Local<v8::FunctionTemplate> DomTemplate(v8::Isolate*, const DOMWrapperWorld&);
  static XRPlaneSet* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<XRPlaneSet>();
  }
  MODULES_EXPORT static XRPlaneSet* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);

  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_xr_plane_set_wrapper_type_info;
  }
...
template <>
struct V8TypeOf<XRPlaneSet> {
  typedef V8XRPlaneSet Type;
};
