...
eternalV8InternalDictionaryKeys(v8::Isolate* isolate) {
...
void V8InternalDictionary::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, InternalDictionary* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8InternalDictionaryKeys(isolate).data();
  ...
  if (!v8Object->Get(context, keys[4].Get(isolate)).ToLocal(&double_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[5].Get(isolate)).ToLocal(&double_or_string_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[6].Get(isolate)).ToLocal(&double_or_string_sequence_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[7].Get(isolate)).ToLocal(&element_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[8].Get(isolate)).ToLocal(&element_or_null_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[9].Get(isolate)).ToLocal(&enum_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[10].Get(isolate)).ToLocal(&enum_member_with_default_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[11].Get(isolate)).ToLocal(&enum_or_null_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[12].Get(isolate)).ToLocal(&event_target_or_null_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[13].Get(isolate)).ToLocal(&internal_enum_or_internal_enum_sequence_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[14].Get(isolate)).ToLocal(&long_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[15].Get(isolate)).ToLocal(&long_member_with_clamp_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[16].Get(isolate)).ToLocal(&long_member_with_default_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[17].Get(isolate)).ToLocal(&long_member_with_enforce_range_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[18].Get(isolate)).ToLocal(&long_or_null_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[19].Get(isolate)).ToLocal(&long_or_null_member_with_default_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[20].Get(isolate)).ToLocal(&object_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[21].Get(isolate)).ToLocal(&object_or_null_member_with_default_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  if (object_or_null_member_with_default_value.IsEmpty() || object_or_null_member_with_default_value->IsUndefined()) {
    ...
    ScriptValue object_or_null_member_with_default_cpp_value = NativeValueTraits<IDLNullable<IDLObject>>::NativeValue(isolate, object_or_null_member_with_default_value, exception_state);
    if (exception_state.HadException())
      return;
  ...
  if (!v8Object->Get(context, keys[22].Get(isolate)).ToLocal(&string_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[23].Get(isolate)).ToLocal(&string_member_with_default_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[24].Get(isolate)).ToLocal(&string_sequence_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[25].Get(isolate)).ToLocal(&string_sequence_member_with_default_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[26].Get(isolate)).ToLocal(&string_sequence_or_null_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[27].Get(isolate)).ToLocal(&unrestricted_double_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[28].Get(isolate)).ToLocal(&usv_string_member_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
...
bool toV8InternalDictionary(const InternalDictionary* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (double_member_has_value_or_default &&
      !create_property(4, double_member_value)) {
    return false;
  }
  ...
  if (double_or_string_member_has_value_or_default &&
      !create_property(5, double_or_string_member_value)) {
    return false;
  }
  ...
  if (double_or_string_sequence_member_has_value_or_default &&
      !create_property(6, double_or_string_sequence_member_value)) {
    return false;
  }
  ...
  if (element_member_has_value_or_default &&
      !create_property(7, element_member_value)) {
    return false;
  }
  ...
  if (element_or_null_member_has_value_or_default &&
      !create_property(8, element_or_null_member_value)) {
    return false;
  }
  ...
  if (enum_member_has_value_or_default &&
      !create_property(9, enum_member_value)) {
    return false;
  }
  ...
  if (enum_member_with_default_has_value_or_default &&
      !create_property(10, enum_member_with_default_value)) {
    return false;
  }
  ...
  if (enum_or_null_member_has_value_or_default &&
      !create_property(11, enum_or_null_member_value)) {
    return false;
  }
  ...
  if (event_target_or_null_member_has_value_or_default &&
      !create_property(12, event_target_or_null_member_value)) {
    return false;
  }
  ...
  if (internal_enum_or_internal_enum_sequence_member_has_value_or_default &&
      !create_property(13, internal_enum_or_internal_enum_sequence_member_value)) {
    return false;
  }
  ...
  if (long_member_has_value_or_default &&
      !create_property(14, long_member_value)) {
    return false;
  }
  ...
  if (long_member_with_clamp_has_value_or_default &&
      !create_property(15, long_member_with_clamp_value)) {
    return false;
  }
  ...
  if (long_member_with_default_has_value_or_default &&
      !create_property(16, long_member_with_default_value)) {
    return false;
  }
  ...
  if (long_member_with_enforce_range_has_value_or_default &&
      !create_property(17, long_member_with_enforce_range_value)) {
    return false;
  }
  ...
  if (long_or_null_member_has_value_or_default &&
      !create_property(18, long_or_null_member_value)) {
    return false;
  }
  ...
  if (long_or_null_member_with_default_has_value_or_default &&
      !create_property(19, long_or_null_member_with_default_value)) {
    return false;
  }
  ...
  if (object_member_has_value_or_default &&
      !create_property(20, object_member_value)) {
    return false;
  }
  ...
  if (object_or_null_member_with_default_has_value_or_default &&
      !create_property(21, object_or_null_member_with_default_value)) {
    return false;
  }
  ...
  if (string_member_has_value_or_default &&
      !create_property(22, string_member_value)) {
    return false;
  }
  ...
  if (string_member_with_default_has_value_or_default &&
      !create_property(23, string_member_with_default_value)) {
    return false;
  }
  ...
  if (string_sequence_member_has_value_or_default &&
      !create_property(24, string_sequence_member_value)) {
    return false;
  }
  ...
  if (string_sequence_member_with_default_has_value_or_default &&
      !create_property(25, string_sequence_member_with_default_value)) {
    return false;
  }
  ...
  if (string_sequence_or_null_member_has_value_or_default &&
      !create_property(26, string_sequence_or_null_member_value)) {
    return false;
  }
  ...
  if (unrestricted_double_member_has_value_or_default &&
      !create_property(27, unrestricted_double_member_value)) {
    return false;
  }
  ...
  if (usv_string_member_has_value_or_default &&
      !create_property(28, usv_string_member_value)) {
    return false;
  }
