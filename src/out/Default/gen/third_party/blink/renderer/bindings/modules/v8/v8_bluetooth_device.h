...
class V8BluetoothDevice {
 ...
 public:
  ...
  MODULES_EXPORT static void WatchingAdvertisementsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void WatchAdvertisementsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
