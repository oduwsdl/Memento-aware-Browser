...
class V8HTMLLinkElement {
 ...
 public:
  ...
  CORE_EXPORT static void ResourcesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void ResourcesAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
