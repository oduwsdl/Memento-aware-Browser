...
class V8RTCRtpSender {
 ...
 public:
  ...
  static void InstallRTCInsertableStreams(ScriptState*);
  ...
  MODULES_EXPORT static void CreateEncodedStreamsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void CreateEncodedAudioStreamsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void CreateEncodedVideoStreamsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
