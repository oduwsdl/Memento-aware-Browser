...
static void Observe1Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "ResizeObserver", "observe");
  ...
  options = NativeValueTraits<ResizeObserverOptions>::NativeValue(info.GetIsolate(), info[1], exception_state);
...
static void Observe2Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ResizeObserver* impl = V8ResizeObserver::ToImpl(info.Holder());
...
static int ObserveMethodMaxArg() {
...
static void ObserveMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  switch (std::min(resize_observer_v8_internal::ObserveMethodMaxArg(), info.Length())) {
    case 1:
      if (true) {
        Observe2Method(info);
        return;
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ResizeObserver* impl = ResizeObserver::Create(script_state, callback);
