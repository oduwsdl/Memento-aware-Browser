...
eternalV8ScrollTimelineOptionsKeys(v8::Isolate* isolate) {
...
void V8ScrollTimelineOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ScrollTimelineOptions* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8ScrollTimelineOptionsKeys(isolate).data();
  ...
  if (end_scroll_offset_value.IsEmpty() || end_scroll_offset_value->IsUndefined()) {
    ...
    StringOrScrollTimelineElementBasedOffset end_scroll_offset_cpp_value;
    V8StringOrScrollTimelineElementBasedOffset::ToImpl(isolate, end_scroll_offset_value, end_scroll_offset_cpp_value, UnionTypeConversionMode::kNotNullable, exception_state);
  ...
  if (!v8Object->Get(context, keys[1].Get(isolate)).ToLocal(&orientation_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[2].Get(isolate)).ToLocal(&scroll_source_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[3].Get(isolate)).ToLocal(&start_scroll_offset_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  if (start_scroll_offset_value.IsEmpty() || start_scroll_offset_value->IsUndefined()) {
    ...
    StringOrScrollTimelineElementBasedOffset start_scroll_offset_cpp_value;
    V8StringOrScrollTimelineElementBasedOffset::ToImpl(isolate, start_scroll_offset_value, start_scroll_offset_cpp_value, UnionTypeConversionMode::kNotNullable, exception_state);
    if (exception_state.HadException())
      return;
  ...
  if (!v8Object->Get(context, keys[4].Get(isolate)).ToLocal(&time_range_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
...
bool toV8ScrollTimelineOptions(const ScrollTimelineOptions* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (impl->hasEndScrollOffset()) {
    end_scroll_offset_value = ToV8(impl->endScrollOffset(), creationContext, isolate);
    end_scroll_offset_has_value_or_default = true;
  } else {
    end_scroll_offset_value = ToV8(StringOrScrollTimelineElementBasedOffset::FromString("auto"), creationContext, isolate);
    end_scroll_offset_has_value_or_default = true;
  }
  ...
  if (orientation_has_value_or_default &&
      !create_property(1, orientation_value)) {
    return false;
  }
  ...
  if (scroll_source_has_value_or_default &&
      !create_property(2, scroll_source_value)) {
    return false;
  }
  ...
  if (impl->hasStartScrollOffset()) {
    start_scroll_offset_value = ToV8(impl->startScrollOffset(), creationContext, isolate);
    start_scroll_offset_has_value_or_default = true;
  } else {
    start_scroll_offset_value = ToV8(StringOrScrollTimelineElementBasedOffset::FromString("auto"), creationContext, isolate);
    start_scroll_offset_has_value_or_default = true;
  }
  if (start_scroll_offset_has_value_or_default &&
      !create_property(3, start_scroll_offset_value)) {
    return false;
  }
  ...
  if (time_range_has_value_or_default &&
      !create_property(4, time_range_value)) {
    return false;
  }
