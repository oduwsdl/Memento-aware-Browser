...
class V8HTMLElement {
 ...
 public:
  ...
  CORE_EXPORT static void VirtualKeyboardPolicyAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void VirtualKeyboardPolicyAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
