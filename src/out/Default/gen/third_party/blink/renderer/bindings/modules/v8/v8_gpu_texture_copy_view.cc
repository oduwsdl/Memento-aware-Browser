...
eternalV8GPUTextureCopyViewKeys(v8::Isolate* isolate) {
...
void V8GPUTextureCopyView::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUTextureCopyView* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8GPUTextureCopyViewKeys(isolate).data();
  ...
  if (array_layer_value.IsEmpty() || array_layer_value->IsUndefined()) {
    ...
    uint32_t array_layer_cpp_value = NativeValueTraits<IDLUnsignedLongEnforceRange>::NativeValue(isolate, array_layer_value, exception_state);
  ...
  if (mip_level_value.IsEmpty() || mip_level_value->IsUndefined()) {
    ...
    uint32_t mip_level_cpp_value = NativeValueTraits<IDLUnsignedLongEnforceRange>::NativeValue(isolate, mip_level_value, exception_state);
    if (exception_state.HadException())
      return;
  ...
  if (origin_value.IsEmpty() || origin_value->IsUndefined()) {
    ...
    UnsignedLongEnforceRangeSequenceOrGPUOrigin3DDict origin_cpp_value;
    V8UnsignedLongEnforceRangeSequenceOrGPUOrigin3DDict::ToImpl(isolate, origin_value, origin_cpp_value, UnionTypeConversionMode::kNotNullable, exception_state);
    if (exception_state.HadException())
      return;
...
bool toV8GPUTextureCopyView(const GPUTextureCopyView* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (impl->hasOrigin()) {
    ...
    origin_value = ToV8(UnsignedLongEnforceRangeSequenceOrGPUOrigin3DDict::FromGPUOrigin3DDict(MakeGarbageCollected<GPUOrigin3DDict>()), creationContext, isolate);
    origin_has_value_or_default = true;
  }
