...
static void AssignMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  impl->assign(nodes, exception_state);
  if (exception_state.HadException()) {
    return;
  }
}
