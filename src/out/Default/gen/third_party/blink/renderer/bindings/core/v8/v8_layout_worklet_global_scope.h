...
class V8LayoutWorkletGlobalScope {
 ...
 public:
  ...
  CORE_EXPORT static void IntrinsicSizesConstructorGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void LayoutEdgesConstructorGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
