...
class V8WebGL2ComputeRenderingContext {
 ...
 public:
  ...
  MODULES_EXPORT static void DispatchComputeIndirectMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void DrawArraysIndirectMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void DrawElementsIndirectMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
