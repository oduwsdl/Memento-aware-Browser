...
eternalV8GPUExtent3DDictKeys(v8::Isolate* isolate) {
...
void V8GPUExtent3DDict::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUExtent3DDict* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8GPUExtent3DDictKeys(isolate).data();
  ...
  if (depth_value.IsEmpty() || depth_value->IsUndefined()) {
    ...
    uint32_t depth_cpp_value = NativeValueTraits<IDLUnsignedLongEnforceRange>::NativeValue(isolate, depth_value, exception_state);
  ...
  if (height_value.IsEmpty() || height_value->IsUndefined()) {
    ...
    uint32_t height_cpp_value = NativeValueTraits<IDLUnsignedLongEnforceRange>::NativeValue(isolate, height_value, exception_state);
    if (exception_state.HadException())
      return;
  ...
  if (width_value.IsEmpty() || width_value->IsUndefined()) {
    ...
    uint32_t width_cpp_value = NativeValueTraits<IDLUnsignedLongEnforceRange>::NativeValue(isolate, width_value, exception_state);
    if (exception_state.HadException())
      return;
