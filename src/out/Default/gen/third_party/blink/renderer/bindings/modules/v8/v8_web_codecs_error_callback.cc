...
v8::Maybe<void> V8WebCodecsErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
...
void V8WebCodecsErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
