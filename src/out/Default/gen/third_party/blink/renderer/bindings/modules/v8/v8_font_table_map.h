...
MODULES_EXPORT extern const WrapperTypeInfo v8_font_table_map_wrapper_type_info;

class V8FontTableMap {
  STATIC_ONLY(V8FontTableMap);
 public:
  MODULES_EXPORT static bool HasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> FindInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  MODULES_EXPORT static v8::Local<v8::FunctionTemplate> DomTemplate(v8::Isolate*, const DOMWrapperWorld&);
  static FontTableMap* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<FontTableMap>();
  }
  MODULES_EXPORT static FontTableMap* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);

  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_font_table_map_wrapper_type_info;
  }
...
template <>
struct V8TypeOf<FontTableMap> {
  typedef V8FontTableMap Type;
};
