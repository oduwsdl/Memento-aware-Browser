...
static void DataAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!static_cast<const ExtendableMessageEvent*>(impl)->isDataDirty()) {
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ExtendableMessageEvent_ConstructorCallback");

  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kConstructionContext, "ExtendableMessageEvent");
  ...
  event_init_dict = NativeValueTraits<ExtendableMessageEventInit>::NativeValue(info.GetIsolate(), info[1], exception_state);
  if (exception_state.HadException())
    return;

  ExtendableMessageEvent* impl = ExtendableMessageEvent::Create(type, event_init_dict);
  v8::Local<v8::Object> wrapper = info.Holder();
  wrapper = impl->AssociateWithWrapper(info.GetIsolate(), V8ExtendableMessageEvent::GetWrapperTypeInfo(), wrapper);
...
MODULES_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  extendable_message_event_v8_internal::Constructor(info);
}
...
void V8ExtendableMessageEvent::DataAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  extendable_message_event_v8_internal::DataAttributeGetter(info);
}
...
static void InstallV8ExtendableMessageEventTemplate(
  ...
  kAccessorConfigurations[] = {
      ...
      { "lastEventId", V8ExtendableMessageEvent::LastEventIdAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
      { "source", V8ExtendableMessageEvent::SourceAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
