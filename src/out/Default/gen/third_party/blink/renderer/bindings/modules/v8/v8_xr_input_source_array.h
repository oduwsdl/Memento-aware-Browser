...
MODULES_EXPORT extern const WrapperTypeInfo v8_xr_input_source_array_wrapper_type_info;

class V8XRInputSourceArray {
  STATIC_ONLY(V8XRInputSourceArray);
 public:
  MODULES_EXPORT static bool HasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> FindInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  MODULES_EXPORT static v8::Local<v8::FunctionTemplate> DomTemplate(v8::Isolate*, const DOMWrapperWorld&);
  static XRInputSourceArray* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<XRInputSourceArray>();
  }
  MODULES_EXPORT static XRInputSourceArray* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);

  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_xr_input_source_array_wrapper_type_info;
  }
...
template <>
struct V8TypeOf<XRInputSourceArray> {
  typedef V8XRInputSourceArray Type;
};
