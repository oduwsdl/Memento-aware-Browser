...
static void GetContextMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  CanvasRenderingContext2DOrWebGLRenderingContextOrWebGL2RenderingContextOrWebGL2ComputeRenderingContextOrImageBitmapRenderingContextOrGPUCanvasContext result;
  HTMLCanvasElementModule::getContext(*impl, context_id, attributes, result, exception_state);
  if (exception_state.HadException()) {
    return;
  }
