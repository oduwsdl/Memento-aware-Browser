...
_tabversion   = '3.10'
_lextokens    = set(('ANY', 'ASYNC', 'ATTRIBUTE', 'BOOLEAN', 'BYTE', 'BYTESTRING', 'CALLBACK', 'CONST', 'CONSTRUCTOR', 'DELETER', 'DICTIONARY', 'DOMSTRING', 'DOUBLE', 'ELLIPSIS', 'ENUM', 'FALSE', 'FLOAT', 'FROZENARRAY', 'GETTER', 'INCLUDES', 'INFINITY', 'INHERIT', 'INTERFACE', 'ITERABLE', 'LONG', 'MAPLIKE', 'MIXIN', 'NAMESPACE', 'NAN', 'NULL', 'OBJECT', 'OCTET', 'OPTIONAL', 'OR', 'PARTIAL', 'PROMISE', 'READONLY', 'RECORD', 'REQUIRED', 'SEQUENCE', 'SETLIKE', 'SETTER', 'SHORT', 'SPECIAL_COMMENT', 'STATIC', 'STRINGIFIER', 'TRUE', 'TYPEDEF', 'UNRESTRICTED', 'UNSIGNED', 'USVSTRING', 'VOID', 'float', 'identifier', 'integer', 'string'))
_lexreflags   = 64
_lexliterals  = '"*.(){}[],;:=+-/~|&^?<>'
