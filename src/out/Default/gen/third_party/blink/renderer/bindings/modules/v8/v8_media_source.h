...
class V8MediaSource {
 ...
 public:
  ...
  static MediaSourceImpl* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<MediaSourceImpl>();
  }
  MODULES_EXPORT static MediaSourceImpl* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);
...
template <>
struct V8TypeOf<MediaSourceImpl> {
