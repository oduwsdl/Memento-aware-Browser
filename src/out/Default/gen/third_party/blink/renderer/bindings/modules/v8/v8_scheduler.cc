...
static void CurrentTaskSignalAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();

  DOMScheduler* impl = V8Scheduler::ToImpl(holder);

  ScriptState* script_state = ScriptState::ForRelevantRealm(info);

  DOMTaskSignal* cpp_value(impl->currentTaskSignal(script_state));
...
void V8Scheduler::CurrentTaskSignalAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMScheduler_currentTaskSignal_Getter");

  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kSchedulerCurrentTaskSignal);

  dom_scheduler_v8_internal::CurrentTaskSignalAttributeGetter(info);
}
...
static void InstallV8SchedulerTemplate(
  ...
  kAccessorConfigurations[] = {
      { "currentTaskSignal", V8Scheduler::CurrentTaskSignalAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
  };
