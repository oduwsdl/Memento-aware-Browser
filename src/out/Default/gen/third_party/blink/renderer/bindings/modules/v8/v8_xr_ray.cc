...
static void Constructor1(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  direction = NativeValueTraits<XRRayDirectionInit>::NativeValue(info.GetIsolate(), info[1], exception_state);
  if (exception_state.HadException())
    return;
