...
v8::Maybe<ScriptValue> V8LayoutCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<CustomLayoutChild>>& children, CustomLayoutEdges* edges, CustomLayoutConstraints* constraints, StylePropertyMapReadOnly* styleMap) {
...
v8::Maybe<ScriptValue> V8LayoutCallback::Construct(const HeapVector<Member<CustomLayoutChild>>& children, CustomLayoutEdges* edges, CustomLayoutConstraints* constraints, StylePropertyMapReadOnly* styleMap) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "LayoutCallback",
          "construct");
