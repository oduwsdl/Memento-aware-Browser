...
static void StateAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptValue cpp_value(impl->state(script_state, exception_state));
...
static void PushStateMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  data = ScriptValue(info.GetIsolate(), info[0]);
  ...
  impl->pushState(info.GetIsolate(), data, title, url, exception_state);
  if (exception_state.HadException()) {
    return;
  }
}
...
static void ReplaceStateMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  impl->replaceState(info.GetIsolate(), data, title, url, exception_state);
  if (exception_state.HadException()) {
    return;
  }
}
...
static void InstallV8HistoryTemplate(
  ...
  kAccessorConfigurations[] = {
      { "length", V8History::LengthAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
      { "scrollRestoration", V8History::ScrollRestorationAttributeGetterCallback, V8History::ScrollRestorationAttributeSetterCallback, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
      { "state", V8History::StateAttributeGetterCallback, nullptr, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
  };
