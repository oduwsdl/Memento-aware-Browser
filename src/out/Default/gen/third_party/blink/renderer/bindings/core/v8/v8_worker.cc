...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  script_url = NativeValueTraits<IDLUSVStringStringContextTrustedScriptURL>::NativeValue(info.GetIsolate(), info[0], exception_state, CurrentExecutionContext(info.GetIsolate()));
  if (exception_state.HadException())
    return;
...
static void InstallV8WorkerTemplate(
  ...
  kAccessorConfigurations[] = {
      { "onmessage", V8Worker::OnmessageAttributeGetterCallback, V8Worker::OnmessageAttributeSetterCallback, static_cast<unsigned>(V8PrivateProperty::CachedAccessor::kNone), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
