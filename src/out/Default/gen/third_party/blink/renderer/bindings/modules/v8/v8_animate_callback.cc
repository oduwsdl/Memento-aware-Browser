...
v8::Maybe<void> V8AnimateCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, double currentTime, const WorkletAnimationEffectOrWorkletGroupEffect& effect) {
...
void V8AnimateCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, double currentTime, const WorkletAnimationEffectOrWorkletGroupEffect& effect) {
