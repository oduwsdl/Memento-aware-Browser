...
eternalV8SerialPortRequestOptionsKeys(v8::Isolate* isolate) {
...
void V8SerialPortRequestOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, SerialPortRequestOptions* impl, ExceptionState& exception_state) {
  ...
  const auto* keys = eternalV8SerialPortRequestOptionsKeys(isolate).data();
  ...
  if (filters_value.IsEmpty() || filters_value->IsUndefined()) {
    ...
    HeapVector<Member<SerialPortFilter>> filters_cpp_value = NativeValueTraits<IDLSequence<SerialPortFilter>>::NativeValue(isolate, filters_value, exception_state);
...
SerialPortRequestOptions* NativeValueTraits<SerialPortRequestOptions>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  SerialPortRequestOptions* impl = MakeGarbageCollected<SerialPortRequestOptions>();
