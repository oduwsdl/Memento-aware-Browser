...
static_assert(
    ...
    "WakeLock inherits from ActiveScriptWrappable<>, but is not specifying "
    "[ActiveScriptWrappable] extended attribute in the IDL file.  "
    "Be consistent.");
static_assert(
    std::is_same<decltype(&WakeLock::HasPendingActivity),
                 decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "WakeLock is overriding hasPendingActivity(), but is not specifying "
    "[ActiveScriptWrappable] extended attribute in the IDL file.  "
    "Be consistent.");
...
static void RequestMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "WakeLock", "request");
  ExceptionToRejectPromiseScope reject_promise_scope(info, exception_state);

  // V8DOMConfiguration::kDoNotCheckHolder
  // Make sure that info.Holder() really points to an instance of the type.
  if (!V8WakeLock::HasInstance(info.Holder(), info.GetIsolate())) {
  ...
  ScriptPromise result = impl->request(script_state, type, exception_state);
...
void V8WakeLock::RequestMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  wake_lock_v8_internal::RequestMethod(info);
}
...
static void InstallV8WakeLockTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8WakeLock::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8WakeLock::kInternalFieldCount);
    ...
    if (is_secure_context) {
      {
        ...
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
            {"request", V8WakeLock::RequestMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
        };
