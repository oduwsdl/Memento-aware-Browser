...
void Frontend::dataReceived(const String& requestId, double timestamp, int dataLength, int encodedDataLength)
{
    ...
    std::unique_ptr<DataReceivedNotification> messageData = DataReceivedNotification::create()
        ...
        .build();
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.dataReceived", std::move(messageData)));
}
...
void Frontend::eventSourceMessageReceived(const String& requestId, double timestamp, const String& eventName, const String& eventId, const String& data)
{
    ...
    std::unique_ptr<EventSourceMessageReceivedNotification> messageData = EventSourceMessageReceivedNotification::create()
        ...
        .setData(data)
        .build();
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.eventSourceMessageReceived", std::move(messageData)));
}
...
void Frontend::requestServedFromCache(const String& requestId)
{
    ...
    std::unique_ptr<RequestServedFromCacheNotification> messageData = RequestServedFromCacheNotification::create()
        .setRequestId(requestId)
        .build();
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.requestServedFromCache", std::move(messageData)));
}
...
void Frontend::resourceChangedPriority(const String& requestId, const String& newPriority, double timestamp)
{
    ...
    std::unique_ptr<ResourceChangedPriorityNotification> messageData = ResourceChangedPriorityNotification::create()
        ...
        .setTimestamp(timestamp)
        .build();
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.resourceChangedPriority", std::move(messageData)));
}
...
void Frontend::webSocketClosed(const String& requestId, double timestamp)
{
    ...
    std::unique_ptr<WebSocketClosedNotification> messageData = WebSocketClosedNotification::create()
        ...
        .setTimestamp(timestamp)
        .build();
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.webSocketClosed", std::move(messageData)));
}
...
void Frontend::webSocketCreated(const String& requestId, const String& url, Maybe<protocol::Network::Initiator> initiator)
{
    ...
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.webSocketCreated", std::move(messageData)));
}
...
void Frontend::webSocketFrameError(const String& requestId, double timestamp, const String& errorMessage)
{
    ...
    std::unique_ptr<WebSocketFrameErrorNotification> messageData = WebSocketFrameErrorNotification::create()
        ...
        .build();
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.webSocketFrameError", std::move(messageData)));
}
...
void Frontend::webSocketFrameReceived(const String& requestId, double timestamp, std::unique_ptr<protocol::Network::WebSocketFrame> response)
{
    ...
    std::unique_ptr<WebSocketFrameReceivedNotification> messageData = WebSocketFrameReceivedNotification::create()
        ...
        .setResponse(std::move(response))
        .build();
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.webSocketFrameReceived", std::move(messageData)));
}
...
void Frontend::webSocketFrameSent(const String& requestId, double timestamp, std::unique_ptr<protocol::Network::WebSocketFrame> response)
{
    ...
    std::unique_ptr<WebSocketFrameSentNotification> messageData = WebSocketFrameSentNotification::create()
        ...
        .setResponse(std::move(response))
        .build();
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.webSocketFrameSent", std::move(messageData)));
}
...
void Frontend::webSocketHandshakeResponseReceived(const String& requestId, double timestamp, std::unique_ptr<protocol::Network::WebSocketResponse> response)
{
    ...
    std::unique_ptr<WebSocketHandshakeResponseReceivedNotification> messageData = WebSocketHandshakeResponseReceivedNotification::create()
        ...
        .setResponse(std::move(response))
        .build();
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.webSocketHandshakeResponseReceived", std::move(messageData)));
}
...
void Frontend::webSocketWillSendHandshakeRequest(const String& requestId, double timestamp, double wallTime, std::unique_ptr<protocol::Network::WebSocketRequest> request)
{
    ...
    std::unique_ptr<WebSocketWillSendHandshakeRequestNotification> messageData = WebSocketWillSendHandshakeRequestNotification::create()
        ...
        .setRequest(std::move(request))
        .build();
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.webSocketWillSendHandshakeRequest", std::move(messageData)));
}
...
public:
    ...
    void canClearBrowserCache(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors);
    void canClearBrowserCookies(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors);
    ...
    void getCertificate(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors);
    void getResponseBody(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors);
    void getRequestPostData(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors);
    void replayXHR(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors);
    void searchInResponseBody(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors);
    void setBlockedURLs(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors);
    ...
    void setDataSizeLimitsForTest(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors);
...
DomainDispatcherImpl::CallHandler CommandByName(crdtp::span<uint8_t> command_name) {
  static auto* commands = [](){
    ...
    {
          crdtp::SpanFrom("setDataSizeLimitsForTest"),
...
void DomainDispatcherImpl::canClearBrowserCache(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors)
{
...
void DomainDispatcherImpl::canClearBrowserCookies(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors)
{
    // Declare output parameters.
    bool out_result;
...
void DomainDispatcherImpl::getCertificate(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors)
{
    // Prepare input parameters.
...
crdtp::SpanFrom("Network.getRequestPostData"), message) { }
    ...
    void sendSuccess(const String& postData) override
    {
        ...
        envelope_encoder.EncodeStart(&result_buffer);
        result_buffer.push_back(crdtp::cbor::EncodeIndefiniteLengthMapStart());
          crdtp::SerializeField(crdtp::SpanFrom("postData"), postData, &result_buffer);
        result_buffer.push_back(crdtp::cbor::EncodeStop());
        envelope_encoder.EncodeStop(&result_buffer);
        sendIfActive(crdtp::Serializable::From(std::move(result_buffer)), DispatchResponse::Success());
    }
...
void DomainDispatcherImpl::getRequestPostData(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors)
{
    // Prepare input parameters.
    protocol::Value* requestIdValue = params ? params->get("requestId") : nullptr;
    errors->SetName("requestId");
...
void DomainDispatcherImpl::replayXHR(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors)
{
    // Prepare input parameters.
    protocol::Value* requestIdValue = params ? params->get("requestId") : nullptr;
    errors->SetName("requestId");
...
void DomainDispatcherImpl::searchInResponseBody(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors)
{
    // Prepare input parameters.
    protocol::Value* requestIdValue = params ? params->get("requestId") : nullptr;
    errors->SetName("requestId");
...
void DomainDispatcherImpl::setBlockedURLs(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors)
{
    // Prepare input parameters.
...
void DomainDispatcherImpl::setDataSizeLimitsForTest(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors)
{
    // Prepare input parameters.
    ...
    if (response.IsFallThrough()) {
        channel()->FallThrough(dispatchable.CallId(), crdtp::SpanFrom("Network.setDataSizeLimitsForTest"), dispatchable.Serialized());
        return;
    }
    if (weak->get())
        weak->get()->sendResponse(dispatchable.CallId(), response);
