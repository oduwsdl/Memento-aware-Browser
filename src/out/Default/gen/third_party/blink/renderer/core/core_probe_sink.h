...
class CORE_EXPORT CoreProbeSink final : public GarbageCollected<CoreProbeSink> {
 ...
 public:
  enum AgentType : unsigned {
    ...
    kInspectorIssueReporter = 1u << 2,
    kInspectorCSSAgent = 1u << 3,
    kInspectorEmulationAgent = 1u << 4,
    kInspectorDOMDebuggerAgent = 1u << 5,
    kInspectorMediaAgent = 1u << 6,
    kInspectorAuditsAgent = 1u << 7,
    kInspectorDOMAgent = 1u << 8,
    kInspectorApplicationCacheAgent = 1u << 9,
    kDevToolsSession = 1u << 10,
    kInspectorNetworkAgent = 1u << 11,
    kPerformanceMonitor = 1u << 12,
    kInspectorTraceEvents = 1u << 13,
    kInspectorPerformanceAgent = 1u << 14,
    kInspectorAnimationAgent = 1u << 15,
    kInspectorPageAgent = 1u << 16,
    kInspectorDOMSnapshotAgent = 1u << 17,
    kInspectorLayerTreeAgent = 1u << 18,
  };
  ...
  const HeapListHashSet<Member<InspectorIssueReporter>>& InspectorIssueReporters() const { return inspector_issue_reporters_; }
  ...
  const HeapListHashSet<Member<InspectorAuditsAgent>>& InspectorAuditsAgents() const { return inspector_audits_agents_; }
 ...
 private:
  ...
  HeapListHashSet<Member<InspectorIssueReporter>> inspector_issue_reporters_;
  ...
  HeapListHashSet<Member<InspectorAuditsAgent>> inspector_audits_agents_;
