...
class InternalDictionary : public IDLDictionaryBase {
 public:
  ...
  static InternalDictionary* Create(v8::Isolate* isolate) {
    return MakeGarbageCollected<InternalDictionary>();
  }
  ...
  // Returns true iff this member has a non-null value.  Returns false if the
  // value is missing or a null value.
  bool hasEventTargetOrNullMemberNonNull() const { return has_event_target_or_null_member_; }
  // Returns the value if this member has a non-null value.  Call
  // |hasEventTargetOrNullMemberNonNull| in advance to check the condition.
  EventTarget* eventTargetOrNullMemberNonNull() const {
    DCHECK(hasEventTargetOrNullMemberNonNull());
    return event_target_or_null_member_;
  }
  ...
  // Returns true iff this member has a non-null value.  Returns false if the
  // value is missing or a null value.
  bool hasLongOrNullMemberNonNull() const { return has_long_or_null_member_; }
  // Returns the value if this member has a non-null value.  Call
  // |hasLongOrNullMemberNonNull| in advance to check the condition.
  ...
  // Returns true iff this member has a non-null value.  Returns false if the
  // value is missing or a null value.
  bool hasLongOrNullMemberWithDefaultNonNull() const { return has_long_or_null_member_with_default_; }
  // Returns the value if this member has a non-null value.  Call
  // |hasLongOrNullMemberWithDefaultNonNull| in advance to check the condition.
  ...
  // Returns true iff this member has a non-null value.  Returns false if the
  // value is missing or a null value.
  bool hasObjectOrNullMemberWithDefaultNonNull() const { return !(object_or_null_member_with_default_.IsEmpty() || object_or_null_member_with_default_.IsNull() || object_or_null_member_with_default_.IsUndefined()); }
  // Returns the value if this member has a non-null value.  Call
  // |hasObjectOrNullMemberWithDefaultNonNull| in advance to check the condition.
  ScriptValue objectOrNullMemberWithDefaultNonNull() const {
    DCHECK(hasObjectOrNullMemberWithDefaultNonNull());
    return object_or_null_member_with_default_;
  }
  ...
  // Returns true iff this member has a non-null value.  Returns false if the
  // value is missing or a null value.
  bool hasStringSequenceOrNullMemberNonNull() const { return has_string_sequence_or_null_member_; }
  // Returns the value if this member has a non-null value.  Call
  // |hasStringSequenceOrNullMemberNonNull| in advance to check the condition.
