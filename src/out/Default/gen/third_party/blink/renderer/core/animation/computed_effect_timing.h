...
class CORE_EXPORT ComputedEffectTiming : public EffectTiming {
 public:
  ...
  bool hasCurrentIterationNonNull() const { return has_current_iteration_; }
  // Returns the value if this member has a non-null value.  Call
  // |hasCurrentIterationNonNull| in advance to check the condition.
  ...
  // Returns true iff this member has a non-null value.  Returns false if the
  // value is missing or a null value.
  bool hasLocalTimeNonNull() const { return has_local_time_; }
  // Returns the value if this member has a non-null value.  Call
  // |hasLocalTimeNonNull| in advance to check the condition.
  double localTimeNonNull() const {
    DCHECK(hasLocalTimeNonNull());
    return local_time_;
  }
  ...
  // Returns true iff this member has a non-null value.  Returns false if the
  // value is missing or a null value.
  bool hasProgressNonNull() const { return has_progress_; }
  // Returns the value if this member has a non-null value.  Call
  // |hasProgressNonNull| in advance to check the condition.
