...
InternalSettingsGenerated::InternalSettingsGenerated(Page* page)
    ...
    , forceDarkModeBackgroundBrightnessThreshold_(page->GetSettings().GetForceDarkModeBackgroundBrightnessThreshold())
    , forceDarkModeContrast_(page->GetSettings().GetForceDarkModeContrast())
    , forceDarkModeEnabled_(page->GetSettings().GetForceDarkModeEnabled())
    , forceDarkModeGrayscale_(page->GetSettings().GetForceDarkModeGrayscale())
    , forceDarkModeTextBrightnessThreshold_(page->GetSettings().GetForceDarkModeTextBrightnessThreshold())
...
void InternalSettingsGenerated::resetToConsistentState() {
  ...
  page_->GetSettings().SetForceDarkModeBackgroundBrightnessThreshold(forceDarkModeBackgroundBrightnessThreshold_);
  page_->GetSettings().SetForceDarkModeContrast(forceDarkModeContrast_);
  page_->GetSettings().SetForceDarkModeEnabled(forceDarkModeEnabled_);
  page_->GetSettings().SetForceDarkModeGrayscale(forceDarkModeGrayscale_);
  page_->GetSettings().SetForceDarkModeTextBrightnessThreshold(forceDarkModeTextBrightnessThreshold_);
...
void InternalSettingsGenerated::setForceDarkModeBackgroundBrightnessThreshold(int forceDarkModeBackgroundBrightnessThreshold) {
  page_->GetSettings().SetForceDarkModeBackgroundBrightnessThreshold(forceDarkModeBackgroundBrightnessThreshold);
}

void InternalSettingsGenerated::setForceDarkModeContrast(double forceDarkModeContrast) {
  page_->GetSettings().SetForceDarkModeContrast(forceDarkModeContrast);
}
...
void InternalSettingsGenerated::setForceDarkModeGrayscale(bool forceDarkModeGrayscale) {
  page_->GetSettings().SetForceDarkModeGrayscale(forceDarkModeGrayscale);
}

void InternalSettingsGenerated::setForceDarkModeTextBrightnessThreshold(int forceDarkModeTextBrightnessThreshold) {
  page_->GetSettings().SetForceDarkModeTextBrightnessThreshold(forceDarkModeTextBrightnessThreshold);
}
