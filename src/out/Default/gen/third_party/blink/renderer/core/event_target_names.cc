...
const AtomicString& kNode = reinterpret_cast<AtomicString*>(&names_storage)[17];
const AtomicString& kOffscreenCanvas = reinterpret_cast<AtomicString*>(&names_storage)[18];
const AtomicString& kPerformance = reinterpret_cast<AtomicString*>(&names_storage)[19];
const AtomicString& kPortalHost = reinterpret_cast<AtomicString*>(&names_storage)[20];
const AtomicString& kSharedWorker = reinterpret_cast<AtomicString*>(&names_storage)[21];
const AtomicString& kSharedWorkerGlobalScope = reinterpret_cast<AtomicString*>(&names_storage)[22];
const AtomicString& kTextTrack = reinterpret_cast<AtomicString*>(&names_storage)[23];
const AtomicString& kTextTrackCue = reinterpret_cast<AtomicString*>(&names_storage)[24];
const AtomicString& kTextTrackList = reinterpret_cast<AtomicString*>(&names_storage)[25];
const AtomicString& kVideoTrackList = reinterpret_cast<AtomicString*>(&names_storage)[26];
const AtomicString& kVisualViewport = reinterpret_cast<AtomicString*>(&names_storage)[27];
const AtomicString& kWindow = reinterpret_cast<AtomicString*>(&names_storage)[28];
const AtomicString& kWorker = reinterpret_cast<AtomicString*>(&names_storage)[29];
const AtomicString& kXMLHttpRequest = reinterpret_cast<AtomicString*>(&names_storage)[30];
const AtomicString& kXMLHttpRequestUpload = reinterpret_cast<AtomicString*>(&names_storage)[31];
