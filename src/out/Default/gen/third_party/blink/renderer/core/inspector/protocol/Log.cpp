...
public:
    ...
    void startViolationsReport(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors);
    void stopViolationsReport(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors);
 protected:
    Backend* m_backend;
};
...
void DomainDispatcherImpl::startViolationsReport(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors)
{
...
void DomainDispatcherImpl::stopViolationsReport(const crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors)
{
