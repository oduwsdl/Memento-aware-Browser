...
inline ETextAlignLast cssValueIDToPlatformEnumGenerated(CSSValueID v) {
  switch (v) {
    ...
    case CSSValueID::kInternalSpaceAround:
      return ETextAlignLast::kInternalSpaceAround;
    case CSSValueID::kAuto:
...
inline EContentVisibility cssValueIDToPlatformEnumGenerated(CSSValueID v) {
  switch (v) {
    ...
    case CSSValueID::kHiddenMatchable:
      return EContentVisibility::kHiddenMatchable;
    default:
      DCHECK_GE(v, CSSValueID::kHidden);
      DCHECK_LE(v, CSSValueID::kHidden);
...
inline CSSValueID platformEnumToCSSValueIDGenerated(EContentVisibility v) {
  switch (v) {
    ...
    case EContentVisibility::kHiddenMatchable:
      return CSSValueID::kHiddenMatchable;
    default:
...
template <>
inline EMathSuperscriptShiftStyle cssValueIDToPlatformEnumGenerated(CSSValueID v) {
  switch (v) {
    case CSSValueID::kDisplay:
      return EMathSuperscriptShiftStyle::kDisplay;
    default:
      DCHECK_GE(v, CSSValueID::kInline);
      DCHECK_LE(v, CSSValueID::kInline);
      return static_cast<EMathSuperscriptShiftStyle>(static_cast<int>(v) - static_cast<int>(CSSValueID::kInline) + static_cast<int>(EMathSuperscriptShiftStyle::kInline));
  }
}

inline CSSValueID platformEnumToCSSValueIDGenerated(EMathSuperscriptShiftStyle v) {
  switch (v) {
    case EMathSuperscriptShiftStyle::kDisplay:
      return CSSValueID::kDisplay;
    default:
      DCHECK_GE(v, EMathSuperscriptShiftStyle::kInline);
      DCHECK_LE(v, EMathSuperscriptShiftStyle::kInline);
      return static_cast<CSSValueID>(static_cast<int>(v) - static_cast<int>(EMathSuperscriptShiftStyle::kInline) + static_cast<int>(CSSValueID::kInline));
  }
}
...
inline EMathStyle cssValueIDToPlatformEnumGenerated(CSSValueID v) {
  switch (v) {
    case CSSValueID::kDisplay:
      return EMathStyle::kDisplay;
    default:
      DCHECK_GE(v, CSSValueID::kInline);
      DCHECK_LE(v, CSSValueID::kInline);
      return static_cast<EMathStyle>(static_cast<int>(v) - static_cast<int>(CSSValueID::kInline) + static_cast<int>(EMathStyle::kInline));
  }
}

inline CSSValueID platformEnumToCSSValueIDGenerated(EMathStyle v) {
  switch (v) {
    case EMathStyle::kDisplay:
      return CSSValueID::kDisplay;
    default:
      DCHECK_GE(v, EMathStyle::kInline);
      DCHECK_LE(v, EMathStyle::kInline);
      return static_cast<CSSValueID>(static_cast<int>(v) - static_cast<int>(EMathStyle::kInline) + static_cast<int>(CSSValueID::kInline));
  }
}
