...
const QualifiedName& kFontFamilyAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[49];
const QualifiedName& kFontSizeAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[50];
const QualifiedName& kFontSizeAdjustAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[51];
const QualifiedName& kFontStretchAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[52];
const QualifiedName& kFontStyleAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[53];
const QualifiedName& kFontVariantAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[54];
const QualifiedName& kFontWeightAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[55];
const QualifiedName& kFormatAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[56];
const QualifiedName& kFrAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[57];
const QualifiedName& kFromAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[58];
const QualifiedName& kFxAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[59];
const QualifiedName& kFyAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[60];
const QualifiedName& kG1Attr = reinterpret_cast<QualifiedName*>(&attr_storage)[61];
const QualifiedName& kG2Attr = reinterpret_cast<QualifiedName*>(&attr_storage)[62];
const QualifiedName& kGlyphRefAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[63];
const QualifiedName& kGradientTransformAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[64];
const QualifiedName& kGradientUnitsAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[65];
const QualifiedName& kHeightAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[66];
const QualifiedName& kHrefAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[67];
const QualifiedName& kImageRenderingAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[68];
const QualifiedName& kInAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[69];
const QualifiedName& kIn2Attr = reinterpret_cast<QualifiedName*>(&attr_storage)[70];
const QualifiedName& kInterceptAttr = reinterpret_cast<QualifiedName*>(&attr_storage)[71];
