...
class InternalSettingsGenerated : public ScriptWrappable {
 ...
 public:
  ...
  void setForceDarkModeBackgroundBrightnessThreshold(int forceDarkModeBackgroundBrightnessThreshold);
  void setForceDarkModeContrast(double forceDarkModeContrast);
  void setForceDarkModeEnabled(bool forceDarkModeEnabled);
  void setForceDarkModeGrayscale(bool forceDarkModeGrayscale);
  void setForceDarkModeTextBrightnessThreshold(int forceDarkModeTextBrightnessThreshold);
 ...
 private:
  ...
  int forceDarkModeBackgroundBrightnessThreshold_;
  double forceDarkModeContrast_;
  bool forceDarkModeEnabled_;
  bool forceDarkModeGrayscale_;
  int forceDarkModeTextBrightnessThreshold_;
