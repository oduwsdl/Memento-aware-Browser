...
public:
    ...
    protocol::Array<protocol::Network::BlockedCookieWithReason>* getAssociatedCookies() { return m_associatedCookies.get(); }
    void setAssociatedCookies(std::unique_ptr<protocol::Array<protocol::Network::BlockedCookieWithReason>> value) { m_associatedCookies = std::move(value); }
    ...
    public:
        enum {
            NoFieldsSet = 0,
            RequestIdSet = 1 << 1,
            AssociatedCookiesSet = 1 << 2,
            HeadersSet = 1 << 3,
            AllFieldsSet = (RequestIdSet | AssociatedCookiesSet | HeadersSet | 0)};
        ...
        RequestWillBeSentExtraInfoNotificationBuilder<STATE | AssociatedCookiesSet>& setAssociatedCookies(std::unique_ptr<protocol::Array<protocol::Network::BlockedCookieWithReason>> value)
        {
            static_assert(!(STATE & AssociatedCookiesSet), "property associatedCookies should not be set yet");
            m_result->setAssociatedCookies(std::move(value));
            return castState<AssociatedCookiesSet>();
        }
...
private:
    ...
    String m_requestId;
    std::unique_ptr<protocol::Array<protocol::Network::BlockedCookieWithReason>> m_associatedCookies;
    std::unique_ptr<protocol::Network::Headers> m_headers;
};
...
public:
  explicit Frontend(FrontendChannel* frontend_channel) : frontend_channel_(frontend_channel) {}
    ...
    void requestWillBeSentExtraInfo(const String& requestId, std::unique_ptr<protocol::Array<protocol::Network::BlockedCookieWithReason>> associatedCookies, std::unique_ptr<protocol::Network::Headers> headers);
