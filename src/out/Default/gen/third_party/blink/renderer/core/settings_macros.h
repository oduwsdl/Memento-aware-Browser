...
#define SETTINGS_GETTERS_AND_SETTERS \
    ...
    int GetForceDarkModeBackgroundBrightnessThreshold() const { return force_dark_mode_background_brightness_threshold_; } \
    void SetForceDarkModeBackgroundBrightnessThreshold(int force_dark_mode_background_brightness_threshold); \
    double GetForceDarkModeContrast() const { return force_dark_mode_contrast_; } \
    void SetForceDarkModeContrast(double force_dark_mode_contrast); \
    ...
    bool GetForceDarkModeGrayscale() const { return force_dark_mode_grayscale_; } \
    void SetForceDarkModeGrayscale(bool force_dark_mode_grayscale); \
    float GetForceDarkModeImageGrayscale() const { return force_dark_mode_image_grayscale_; } \
    void SetForceDarkModeImageGrayscale(float force_dark_mode_image_grayscale); \
    DarkModeImagePolicy GetForceDarkModeImagePolicy() const { return force_dark_mode_image_policy_; } \
    void SetForceDarkModeImagePolicy(DarkModeImagePolicy force_dark_mode_image_policy); \
    DarkModeInversionAlgorithm GetForceDarkModeInversionAlgorithm() const { return force_dark_mode_inversion_algorithm_; } \
    void SetForceDarkModeInversionAlgorithm(DarkModeInversionAlgorithm force_dark_mode_inversion_algorithm); \
    DarkModePagePolicy GetForceDarkModePagePolicy() const { return force_dark_mode_page_policy_; } \
    void SetForceDarkModePagePolicy(DarkModePagePolicy force_dark_mode_page_policy); \
    int GetForceDarkModeTextBrightnessThreshold() const { return force_dark_mode_text_brightness_threshold_; } \
    void SetForceDarkModeTextBrightnessThreshold(int force_dark_mode_text_brightness_threshold); \
...
#define SETTINGS_MEMBER_VARIABLES \
    ...
    int force_dark_mode_background_brightness_threshold_; \
    double force_dark_mode_contrast_; \
    float force_dark_mode_image_grayscale_; \
    DarkModeImagePolicy force_dark_mode_image_policy_; \
    DarkModeInversionAlgorithm force_dark_mode_inversion_algorithm_; \
    DarkModePagePolicy force_dark_mode_page_policy_; \
    int force_dark_mode_text_brightness_threshold_; \
    ...
    bool force_dark_mode_grayscale_ : 1; \
...
#define SETTINGS_INITIALIZER_LIST \
    ...
    , force_dark_mode_background_brightness_threshold_(205) \
    , force_dark_mode_contrast_(0) \
    , force_dark_mode_image_grayscale_(0.0) \
    , force_dark_mode_image_policy_(DarkModeImagePolicy::kFilterNone) \
    , force_dark_mode_inversion_algorithm_(DarkModeInversionAlgorithm::kInvertLightnessLAB) \
    , force_dark_mode_page_policy_(DarkModePagePolicy::kFilterByBackground) \
    , force_dark_mode_text_brightness_threshold_(150) \
    ...
    , lazy_image_first_k_fully_load_2_g_(0) \
    , lazy_image_first_k_fully_load_3_g_(0) \
    , lazy_image_first_k_fully_load_4_g_(0) \
    , lazy_image_first_k_fully_load_slow_2_g_(0) \
    ...
    , force_dark_mode_grayscale_(false) \
...
void Settings::SetForceDarkModeBackgroundBrightnessThreshold(int force_dark_mode_background_brightness_threshold) { \
  if (force_dark_mode_background_brightness_threshold_ == force_dark_mode_background_brightness_threshold) \
    return; \
  force_dark_mode_background_brightness_threshold_ = force_dark_mode_background_brightness_threshold; \
  Invalidate(SettingsDelegate::kForceDarkChange); \
} \
void Settings::SetForceDarkModeContrast(double force_dark_mode_contrast) { \
  if (force_dark_mode_contrast_ == force_dark_mode_contrast) \
    return; \
  force_dark_mode_contrast_ = force_dark_mode_contrast; \
  Invalidate(SettingsDelegate::kForceDarkChange); \
} \
...
void Settings::SetForceDarkModeGrayscale(bool force_dark_mode_grayscale) { \
  if (force_dark_mode_grayscale_ == force_dark_mode_grayscale) \
    return; \
  force_dark_mode_grayscale_ = force_dark_mode_grayscale; \
  Invalidate(SettingsDelegate::kForceDarkChange); \
} \
void Settings::SetForceDarkModeImageGrayscale(float force_dark_mode_image_grayscale) { \
  if (force_dark_mode_image_grayscale_ == force_dark_mode_image_grayscale) \
    return; \
  force_dark_mode_image_grayscale_ = force_dark_mode_image_grayscale; \
  Invalidate(SettingsDelegate::kForceDarkChange); \
} \
void Settings::SetForceDarkModeImagePolicy(DarkModeImagePolicy force_dark_mode_image_policy) { \
  if (force_dark_mode_image_policy_ == force_dark_mode_image_policy) \
    return; \
  force_dark_mode_image_policy_ = force_dark_mode_image_policy; \
  Invalidate(SettingsDelegate::kForceDarkChange); \
} \
void Settings::SetForceDarkModeInversionAlgorithm(DarkModeInversionAlgorithm force_dark_mode_inversion_algorithm) { \
  if (force_dark_mode_inversion_algorithm_ == force_dark_mode_inversion_algorithm) \
    return; \
  force_dark_mode_inversion_algorithm_ = force_dark_mode_inversion_algorithm; \
  Invalidate(SettingsDelegate::kForceDarkChange); \
} \
void Settings::SetForceDarkModePagePolicy(DarkModePagePolicy force_dark_mode_page_policy) { \
  if (force_dark_mode_page_policy_ == force_dark_mode_page_policy) \
    return; \
  force_dark_mode_page_policy_ = force_dark_mode_page_policy; \
  Invalidate(SettingsDelegate::kForceDarkChange); \
} \
void Settings::SetForceDarkModeTextBrightnessThreshold(int force_dark_mode_text_brightness_threshold) { \
  if (force_dark_mode_text_brightness_threshold_ == force_dark_mode_text_brightness_threshold) \
    return; \
  force_dark_mode_text_brightness_threshold_ = force_dark_mode_text_brightness_threshold; \
  Invalidate(SettingsDelegate::kForceDarkChange); \
} \
...
void Settings::SetFromStrings(const String& name, const String& value) { \
  ...
  if (name == "accessibilityAlwaysShowFocus") { \
    SetAccessibilityAlwaysShowFocus( \
      value.IsEmpty() || value == "true" \
    ); \
    return; \
  } \
  ...
  if (name == "forceDarkModeBackgroundBrightnessThreshold") { \
    SetForceDarkModeBackgroundBrightnessThreshold( \
      value.ToInt() \
    ); \
    return; \
  } \
  if (name == "forceDarkModeContrast") { \
    SetForceDarkModeContrast( \
      value.ToDouble() \
    ); \
    return; \
  } \
  if (name == "forceDarkModeEnabled") { \
    SetForceDarkModeEnabled( \
      value.IsEmpty() || value == "true" \
    ); \
    return; \
  } \
  if (name == "forceDarkModeGrayscale") { \
    SetForceDarkModeGrayscale( \
      value.IsEmpty() || value == "true" \
    ); \
    return; \
  } \
  if (name == "forceDarkModeImageGrayscale") { \
    SetForceDarkModeImageGrayscale( \
      value.ToFloat() \
    ); \
    return; \
  } \
  if (name == "forceDarkModeImagePolicy") { \
    SetForceDarkModeImagePolicy( \
      static_cast<DarkModeImagePolicy>(value.ToInt()) \
    ); \
    return; \
  } \
  if (name == "forceDarkModeInversionAlgorithm") { \
    SetForceDarkModeInversionAlgorithm( \
      static_cast<DarkModeInversionAlgorithm>(value.ToInt()) \
    ); \
    return; \
  } \
  if (name == "forceDarkModePagePolicy") { \
    SetForceDarkModePagePolicy( \
      static_cast<DarkModePagePolicy>(value.ToInt()) \
    ); \
    return; \
  } \
  if (name == "forceDarkModeTextBrightnessThreshold") { \
    SetForceDarkModeTextBrightnessThreshold( \
      value.ToInt() \
    ); \
    return; \
  } \
  ...
  if (name == "parserScriptingFlagPolicy") { \
    SetParserScriptingFlagPolicy( \
      static_cast<ParserScriptingFlagPolicy>(value.ToInt()) \
    ); \
    return; \
  } \
