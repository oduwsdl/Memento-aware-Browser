...
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalForcedBackgroundColorRgb();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyMathSuperscriptShiftStyle();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyTimeRange();
