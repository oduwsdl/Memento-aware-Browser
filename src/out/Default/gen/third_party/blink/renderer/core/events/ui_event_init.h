...
class CORE_EXPORT UIEventInit : public EventInit {
 public:
  ...
  bool hasSourceCapabilitiesNonNull() const { return has_source_capabilities_; }
  // Returns the value if this member has a non-null value.  Call
  // |hasSourceCapabilitiesNonNull| in advance to check the condition.
  InputDeviceCapabilities* sourceCapabilitiesNonNull() const {
    DCHECK(hasSourceCapabilitiesNonNull());
    return source_capabilities_;
  }
  ...
  // Returns true iff this member has a non-null value.  Returns false if the
  // value is missing or a null value.
  bool hasViewNonNull() const { return has_view_; }
  // Returns the value if this member has a non-null value.  Call
  // |hasViewNonNull| in advance to check the condition.
  DOMWindow* viewNonNull() const {
    DCHECK(hasViewNonNull());
    return view_;
  }
