...
public:
    ...
    public:
        enum {
            ...
            EndLineSet = 1 << 12,
            EndColumnSet = 1 << 13,
            AllFieldsSet = (StyleSheetIdSet | FrameIdSet | SourceURLSet | OriginSet | TitleSet | DisabledSet | IsInlineSet | IsMutableSet | StartLineSet | StartColumnSet | LengthSet | EndLineSet | EndColumnSet | 0)};
