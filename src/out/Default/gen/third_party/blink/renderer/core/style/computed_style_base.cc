...
ComputedStyleBase::ComputedStyleBase() :
    ...
    , has_non_inherited_light_dark_value_(static_cast<unsigned>(false))
    ...
    , white_space_is_inherited_(static_cast<unsigned>(true))
{
  box_data_.Init();
  surround_data_.Init();
  inherited_variables_data_.Init();
  visual_data_.Init();
...
void ComputedStyleBase::InheritFrom(const ComputedStyleBase& other,
  ...
  math_superscript_shift_style_ = other.math_superscript_shift_style_;
...
bool ComputedStyleBase::DiffNeedsFullLayout(const ComputedStyle& a, const ComputedStyle& b) {
  if (a.box_data_.Get() != b.box_data_.Get()) {
      ...
      if (a.box_data_->box_sizing_ != b.box_data_->box_sizing_)
        return true;
      if (a.box_data_->contain_intrinsic_size_ != b.box_data_->contain_intrinsic_size_)
        return true;
    ...
    if (a.rare_inherited_usage_less_than_57_percent_data_.Get() != b.rare_inherited_usage_less_than_57_percent_data_.Get()) {
      ...
      if (a.rare_inherited_usage_less_than_57_percent_data_->rare_inherited_usage_less_than_57_percent_sub_data_.Get() != b.rare_inherited_usage_less_than_57_percent_data_->rare_inherited_usage_less_than_57_percent_sub_data_.Get()) {
        if (a.rare_inherited_usage_less_than_57_percent_data_->rare_inherited_usage_less_than_57_percent_sub_data_->text_indent_line_ != b.rare_inherited_usage_less_than_57_percent_data_->rare_inherited_usage_less_than_57_percent_sub_data_->text_indent_line_)
          return true;
        if (a.rare_inherited_usage_less_than_57_percent_data_->rare_inherited_usage_less_than_57_percent_sub_data_->effective_zoom_ != b.rare_inherited_usage_less_than_57_percent_data_->rare_inherited_usage_less_than_57_percent_sub_data_->effective_zoom_)
          return true;
      ...
      if (a.rare_non_inherited_usage_less_than_12_percent_data_->rare_non_inherited_usage_less_than_12_percent_sub_data_.Get() != b.rare_non_inherited_usage_less_than_12_percent_data_->rare_non_inherited_usage_less_than_12_percent_sub_data_.Get()) {
        ...
        if (a.rare_non_inherited_usage_less_than_12_percent_data_->rare_non_inherited_usage_less_than_12_percent_sub_data_->grid_data_.Get() != b.rare_non_inherited_usage_less_than_12_percent_data_->rare_non_inherited_usage_less_than_12_percent_sub_data_->grid_data_.Get()) {
          ...
          if (a.rare_non_inherited_usage_less_than_12_percent_data_->rare_non_inherited_usage_less_than_12_percent_sub_data_->grid_data_->auto_repeat_ordered_named_grid_row_lines_ != b.rare_non_inherited_usage_less_than_12_percent_data_->rare_non_inherited_usage_less_than_12_percent_sub_data_->grid_data_->auto_repeat_ordered_named_grid_row_lines_)
            return true;
          if (a.rare_non_inherited_usage_less_than_12_percent_data_->rare_non_inherited_usage_less_than_12_percent_sub_data_->grid_data_->implicit_named_grid_column_lines_ != b.rare_non_inherited_usage_less_than_12_percent_data_->rare_non_inherited_usage_less_than_12_percent_sub_data_->grid_data_->implicit_named_grid_column_lines_)
            return true;
          if (a.rare_non_inherited_usage_less_than_12_percent_data_->rare_non_inherited_usage_less_than_12_percent_sub_data_->grid_data_->implicit_named_grid_row_lines_ != b.rare_non_inherited_usage_less_than_12_percent_data_->rare_non_inherited_usage_less_than_12_percent_sub_data_->grid_data_->implicit_named_grid_row_lines_)
            return true;
...
ComputedStyleBase::StyleBoxData::StyleBoxData() :
      aspect_ratio_(base::nullopt)
      , contain_intrinsic_size_(LengthSize(Length::Auto(), Length::Auto()))
      , height_(Length())
...
ComputedStyleBase::StyleInheritedVariablesData::StyleInheritedVariablesData() :
      inherited_variables_(nullptr)
  {
  }

ComputedStyleBase::StyleInheritedVariablesData::StyleInheritedVariablesData(const StyleInheritedVariablesData& other) :
...
ComputedStyleBase::StyleRareNonInheritedUsageLessThan100PercentData::StyleRareNonInheritedUsageLessThan100PercentData() :
      ...
      , column_gap_(base::nullopt)
      , row_gap_(base::nullopt)
...
ComputedStyleBase::StyleRareNonInheritedUsageLessThan12PercentSubData::StyleRareNonInheritedUsageLessThan12PercentSubData() :
      ...
      , internal_forced_background_color_rgb_(CSSValueID::kCanvas)
