...
class ComputedStyleInitialValues{
 ...
 public:
  ...
  static base::Optional<IntSize> InitialAspectRatio() {
    return base::nullopt;
  }
  ...
  static base::Optional<Length> InitialColumnGap() {
    return base::nullopt;
  }
  ...
  static LengthSize InitialContainIntrinsicSize() {
  ...
  static CSSValueID InitialInternalForcedBackgroundColorRgb() {
    return CSSValueID::kCanvas;
  }
  ...
  static EMathStyle InitialMathStyle() {
    return EMathStyle::kInline;
  }

  static EMathSuperscriptShiftStyle InitialMathSuperscriptShiftStyle() {
  ...
  static base::Optional<Length> InitialRowGap() {
    return base::nullopt;
  }
  ...
  static short InitialMathScriptLevel() {
    return 0;
  }
