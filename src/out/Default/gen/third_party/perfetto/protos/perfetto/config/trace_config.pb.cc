...
extern PROTOBUF_INTERNAL_EXPORT_protos_2fperfetto_2fconfig_2fdata_5fsource_5fconfig_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<16> scc_info_DataSourceConfig_protos_2fperfetto_2fconfig_2fdata_5fsource_5fconfig_2eproto;
...
TraceConfig::TraceConfig(const TraceConfig& from)
  ...
  ::memcpy(&duration_ms_, &from.duration_ms_,
    ...
    reinterpret_cast<char*>(&duration_ms_)) + sizeof(compression_type_));
...
void TraceConfig::SharedCtor() {
  ...
  ::memset(&statsd_metadata_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&statsd_metadata_)) + sizeof(compression_type_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.TraceConfig)
  ...
  if (cached_has_bits & 0x007f0000u) {
    ::memset(&flush_period_ms_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&compression_type_) -
        reinterpret_cast<char*>(&flush_period_ms_)) + sizeof(compression_type_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
