...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PerfSample_protos_2fperfetto_2ftrace_2fprofiling_2fprofile_5fpacket_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_PerfSample_protos_2fperfetto_2ftrace_2fprofiling_2fprofile_5fpacket_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> Profiling_StackUnwindError_strings[9] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry Profiling_StackUnwindError_entries[] = {
  ...
  { {Profiling_StackUnwindError_names + 151, 20}, 0 },
  { {Profiling_StackUnwindError_names + 171, 24}, 4 },
  { {Profiling_StackUnwindError_names + 195, 24}, 3 },
};

static const int Profiling_StackUnwindError_entries_by_number[] = {
  6, // 0 -> UNWIND_ERROR_UNKNOWN
  4, // 1 -> UNWIND_ERROR_NONE
  3, // 2 -> UNWIND_ERROR_MEMORY_INVALID
  8, // 3 -> UNWIND_ERROR_UNWIND_INFO
  7, // 4 -> UNWIND_ERROR_UNSUPPORTED
...
const std::string& Profiling_StackUnwindError_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ...
          9, Profiling_StackUnwindError_strings);
  (void) dummy;
  int idx = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumName(
      Profiling_StackUnwindError_entries,
      Profiling_StackUnwindError_entries_by_number,
...
bool Profiling_StackUnwindError_Parse(
  ...
  int int_value;
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      Profiling_StackUnwindError_entries, 9, name, &int_value);
  if (success) {
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.ProfilePacket.ProcessHeapSamples)
  ...
  if (cached_has_bits & 0x000000feu) {
    ::memset(&pid_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&hit_guardrail_) -
        reinterpret_cast<char*>(&pid_)) + sizeof(hit_guardrail_));
  }
