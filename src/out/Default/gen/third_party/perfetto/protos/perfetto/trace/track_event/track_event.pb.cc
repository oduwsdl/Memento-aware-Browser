...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<11> scc_info_TrackEvent_protos_2fperfetto_2ftrace_2ftrack_5fevent_2ftrack_5fevent_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 11, InitDefaultsscc_info_TrackEvent_protos_2fperfetto_2ftrace_2ftrack_5fevent_2ftrack_5fevent_2eproto}, {
...
TrackEvent::TrackEvent(const TrackEvent& from)
  ...
  ::memcpy(&track_uuid_, &from.track_uuid_,
    static_cast<size_t>(reinterpret_cast<char*>(&counter_value_) -
    reinterpret_cast<char*>(&track_uuid_)) + sizeof(counter_value_));
...
void TrackEvent::SharedCtor() {
  ...
  ::memset(&task_execution_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&counter_value_) -
      reinterpret_cast<char*>(&task_execution_)) + sizeof(counter_value_));
  clear_has_name_field();
  clear_has_timestamp();
  clear_has_thread_time();
  clear_has_thread_instruction_count();
...
// @@protoc_insertion_point(one_of_clear_start:perfetto.protos.TrackEvent)
  ...
  _oneof_case_[1] = TIMESTAMP_NOT_SET;
}
...
// @@protoc_insertion_point(one_of_clear_start:perfetto.protos.TrackEvent)
  ...
  _oneof_case_[2] = THREAD_TIME_NOT_SET;
}
...
// @@protoc_insertion_point(one_of_clear_start:perfetto.protos.TrackEvent)
  ...
  _oneof_case_[3] = THREAD_INSTRUCTION_COUNT_NOT_SET;
}
