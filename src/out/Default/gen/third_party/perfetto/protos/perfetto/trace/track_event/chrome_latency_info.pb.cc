...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> ChromeLatencyInfo_Step_strings[11] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry ChromeLatencyInfo_Step_entries[] = {
  ...
  { {ChromeLatencyInfo_Step_names + 54, 29}, 10 },
  { {ChromeLatencyInfo_Step_names + 83, 37}, 9 },
  { {ChromeLatencyInfo_Step_names + 120, 28}, 5 },
  { {ChromeLatencyInfo_Step_names + 148, 28}, 4 },
  { {ChromeLatencyInfo_Step_names + 176, 35}, 1 },
  { {ChromeLatencyInfo_Step_names + 211, 30}, 2 },
  { {ChromeLatencyInfo_Step_names + 241, 24}, 3 },
  { {ChromeLatencyInfo_Step_names + 265, 17}, 6 },
  { {ChromeLatencyInfo_Step_names + 282, 16}, 0 },
};

static const int ChromeLatencyInfo_Step_entries_by_number[] = {
  10, // 0 -> STEP_UNSPECIFIED
  6, // 1 -> STEP_HANDLE_INPUT_EVENT_MAIN_COMMIT
  7, // 2 -> STEP_MAIN_THREAD_SCROLL_UPDATE
  8, // 3 -> STEP_SEND_INPUT_EVENT_UI
  5, // 4 -> STEP_HANDLE_INPUT_EVENT_MAIN
  4, // 5 -> STEP_HANDLE_INPUT_EVENT_IMPL
  9, // 6 -> STEP_SWAP_BUFFERS
  1, // 7 -> STEP_DRAW_AND_SWAP
  0, // 8 -> STEP_DID_HANDLE_INPUT_AND_OVERSCROLL
  3, // 9 -> STEP_HANDLED_INPUT_EVENT_MAIN_OR_IMPL
  2, // 10 -> STEP_HANDLED_INPUT_EVENT_IMPL
};
...
const std::string& ChromeLatencyInfo_Step_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ...
          11, ChromeLatencyInfo_Step_strings);
  (void) dummy;
...
bool ChromeLatencyInfo_Step_Parse(
  ...
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      ChromeLatencyInfo_Step_entries, 11, name, &int_value);
  if (success) {
