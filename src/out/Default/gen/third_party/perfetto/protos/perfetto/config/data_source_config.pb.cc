...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<16> scc_info_DataSourceConfig_protos_2fperfetto_2fconfig_2fdata_5fsource_5fconfig_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 16, InitDefaultsscc_info_DataSourceConfig_protos_2fperfetto_2fconfig_2fdata_5fsource_5fconfig_2eproto}, {
