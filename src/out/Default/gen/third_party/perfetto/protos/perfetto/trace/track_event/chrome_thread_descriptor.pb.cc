...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> ChromeThreadDescriptor_ThreadType_strings[14] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry ChromeThreadDescriptor_ThreadType_entries[] = {
  ...
  { {ChromeThreadDescriptor_ThreadType_names + 80, 23}, 6 },
  { {ChromeThreadDescriptor_ThreadType_names + 103, 21}, 3 },
  { {ChromeThreadDescriptor_ThreadType_names + 124, 23}, 5 },
  { {ChromeThreadDescriptor_ThreadType_names + 147, 21}, 4 },
  { {ChromeThreadDescriptor_ThreadType_names + 168, 19}, 7 },
  { {ChromeThreadDescriptor_ThreadType_names + 187, 24}, 51 },
  { {ChromeThreadDescriptor_ThreadType_names + 211, 21}, 11 },
  { {ChromeThreadDescriptor_ThreadType_names + 232, 18}, 0 },
  { {ChromeThreadDescriptor_ThreadType_names + 250, 21}, 9 },
};

static const int ChromeThreadDescriptor_ThreadType_entries_by_number[] = {
  12, // 0 -> THREAD_UNSPECIFIED
  3, // 1 -> THREAD_MAIN
  2, // 2 -> THREAD_IO
  6, // 3 -> THREAD_POOL_BG_WORKER
  8, // 4 -> THREAD_POOL_FG_WORKER
  7, // 5 -> THREAD_POOL_FG_BLOCKING
  5, // 6 -> THREAD_POOL_BG_BLOCKING
  9, // 7 -> THREAD_POOL_SERVICE
  0, // 8 -> THREAD_COMPOSITOR
  13, // 9 -> THREAD_VIZ_COMPOSITOR
  1, // 10 -> THREAD_COMPOSITOR_WORKER
  11, // 11 -> THREAD_SERVICE_WORKER
  4, // 50 -> THREAD_MEMORY_INFRA
  10, // 51 -> THREAD_SAMPLING_PROFILER
};
...
const std::string& ChromeThreadDescriptor_ThreadType_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ...
          14, ChromeThreadDescriptor_ThreadType_strings);
  (void) dummy;
...
bool ChromeThreadDescriptor_ThreadType_Parse(
  ...
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      ChromeThreadDescriptor_ThreadType_entries, 14, name, &int_value);
  if (success) {
