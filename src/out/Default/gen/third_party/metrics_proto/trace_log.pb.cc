...
class TraceLogDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<TraceLog> _instance;
} _TraceLog_default_instance_;
}  // namespace metrics
static void InitDefaultsscc_info_TraceLog_trace_5flog_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TraceLog_trace_5flog_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_TraceLog_trace_5flog_2eproto}, {}};
...
void TraceLog::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_TraceLog_trace_5flog_2eproto.base);
  raw_data_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
const char* TraceLog::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
...
void TraceLog::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const TraceLog*>(
      &from));
}
...
template<> PROTOBUF_NOINLINE ::metrics::TraceLog* Arena::CreateMaybeMessage< ::metrics::TraceLog >(Arena* arena) {
