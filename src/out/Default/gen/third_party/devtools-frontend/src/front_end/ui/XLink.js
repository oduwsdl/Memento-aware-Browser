...
export class ContextMenuProvider {
    ...
    appendApplicableItems(event, contextMenu, target) {
        ...
        contextMenu.revealSection().appendItem(openLinkExternallyLabel(), () => Host.InspectorFrontendHost.InspectorFrontendHostInstance.openInNewTab(targetNode._href));
        contextMenu.revealSection().appendItem(copyLinkAddressLabel(), () => Host.InspectorFrontendHost.InspectorFrontendHostInstance.copyText(targetNode._href));
    }
}
