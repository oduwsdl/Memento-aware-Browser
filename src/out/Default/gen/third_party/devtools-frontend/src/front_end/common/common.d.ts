...
export const ls: typeof Platform.UIString.ls;
/**
 * @type {!Settings.Settings}
 */
export let settings: Settings.Settings;
...
export { App, AppProvider, CharacterIdMap, Color, ColorUtils, Console, EventTarget, JavaScriptMetaData, Lazy, Linkifier, ObjectWrapper, ParsedURL, Progress, QueryParamHandler, ResourceType, Revealer, Runnable, SegmentedRange, Settings, StringOutputStream, TextDictionary, Throttler, Trie, Worker, WasmDisassembly };
