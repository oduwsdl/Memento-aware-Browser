...
export class FrameManager extends Common.ObjectWrapper.ObjectWrapper {
    ...
    modelAdded(resourceTreeModel) {
        const addListener = resourceTreeModel.addEventListener(SDK.ResourceTreeModel.Events.FrameAdded, this._frameAdded, this);
        const detachListener = resourceTreeModel.addEventListener(SDK.ResourceTreeModel.Events.FrameDetached, this._frameDetached, this);
