...
bool DebugLogsChangeHandler_ChangeDebugLogsState_Params_Data::Validate(
  ...
  const DebugLogsChangeHandler_ChangeDebugLogsState_Params_Data* object = static_cast<const DebugLogsChangeHandler_ChangeDebugLogsState_Params_Data*>(data);
...
bool BluetoothInternalsHandler_GetDebugLogsChangeHandler_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const BluetoothInternalsHandler_GetDebugLogsChangeHandler_Params_Data* object = static_cast<const BluetoothInternalsHandler_GetDebugLogsChangeHandler_Params_Data*>(data);
...
bool BluetoothInternalsHandler_GetDebugLogsChangeHandler_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const BluetoothInternalsHandler_GetDebugLogsChangeHandler_ResponseParams_Data* object = static_cast<const BluetoothInternalsHandler_GetDebugLogsChangeHandler_ResponseParams_Data*>(data);
