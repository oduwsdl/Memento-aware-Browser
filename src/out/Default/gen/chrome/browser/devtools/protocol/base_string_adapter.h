...
#ifndef protocol_BASE_STRING_ADAPTER_H
#define protocol_BASE_STRING_ADAPTER_H
...
class  Binary : public crdtp::Serializable {
 public:
  Binary(const Binary&);
  Binary();
  ~Binary();
...
#endif // !defined(protocol_BASE_STRING_ADAPTER_H)
