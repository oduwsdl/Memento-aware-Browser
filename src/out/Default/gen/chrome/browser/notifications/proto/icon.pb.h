...
inline void Icon::set_icon(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
...
inline void Icon::set_icon(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  icon_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:notifications.proto.Icon.icon)
}
inline void Icon::set_icon(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  icon_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:notifications.proto.Icon.icon)
}
inline void Icon::set_icon(const void* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  icon_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:notifications.proto.Icon.icon)
}
