...
class PreloadedDataDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<PreloadedData> _instance;
} _PreloadedData_default_instance_;
}  // namespace chrome_browser_media
static void InitDefaultsscc_info_PreloadedData_media_5fengagement_5fpreload_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::chrome_browser_media::_PreloadedData_default_instance_;
    new (ptr) ::chrome_browser_media::PreloadedData();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::chrome_browser_media::PreloadedData::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PreloadedData_media_5fengagement_5fpreload_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_PreloadedData_media_5fengagement_5fpreload_2eproto}, {}};

namespace chrome_browser_media {

// ===================================================================

void PreloadedData::InitAsDefaultInstance() {
}
...
PreloadedData::PreloadedData(const PreloadedData& from)
  ...
  dafsa_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from.has_dafsa()) {
    dafsa_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.dafsa_);
  }
  // @@protoc_insertion_point(copy_constructor:chrome_browser_media.PreloadedData)
}

void PreloadedData::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_PreloadedData_media_5fengagement_5fpreload_2eproto.base);
  dafsa_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void PreloadedData::SharedDtor() {
  dafsa_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
// @@protoc_insertion_point(message_clear_start:chrome_browser_media.PreloadedData)
  ...
  if (cached_has_bits & 0x00000001u) {
    dafsa_.ClearNonDefaultToEmptyNoArena();
  }
  _has_bits_.Clear();
...
const char* PreloadedData::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(mutable_dafsa(), ptr, ctx);
          CHK_(ptr);
...
void PreloadedData::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const PreloadedData*>(
      &from));
}
...
void PreloadedData::InternalSwap(PreloadedData* other) {
  ...
  dafsa_.Swap(&other->dafsa_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
}
...
template<> PROTOBUF_NOINLINE ::chrome_browser_media::PreloadedData* Arena::CreateMaybeMessage< ::chrome_browser_media::PreloadedData >(Arena* arena) {
  return Arena::CreateInternal< ::chrome_browser_media::PreloadedData >(arena);
}
