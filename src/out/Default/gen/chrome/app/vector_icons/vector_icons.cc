...
VECTOR_ICON_REP_TEMPLATE(kScrollingTabstripLeadingPath, CANVAS_DIMENSIONS, 16,
MOVE_TO, 7.03f, 8,
LINE_TO, 12, 3.4f,
LINE_TO, 10.49f, 2,
LINE_TO, 4, 8,
...
LINE_TO, 7.03f, 8,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kScrollingTabstripLeadingRepList, kScrollingTabstripLeadingIcon, {kScrollingTabstripLeadingPath, base::size(kScrollingTabstripLeadingPath)})
...
LINE_TO, 4.85f, 6,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kTabSearchRepList, kTabSearchIcon, {kTabSearchPath, base::size(kTabSearchPath)})
...
VECTOR_ICON_REP_TEMPLATE(kScrollingTabstripTrailingPath, CANVAS_DIMENSIONS, 16,
MOVE_TO, 8.97f, 8,
LINE_TO, 4, 3.4f,
LINE_TO, 5.51f, 2,
LINE_TO, 12, 8,
...
LINE_TO, 8.97f, 8,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kScrollingTabstripTrailingRepList, kScrollingTabstripTrailingIcon, {kScrollingTabstripTrailingPath, base::size(kScrollingTabstripTrailingPath)})
...
R_V_LINE_TO, -1.23f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kReadLaterAddRepList, kReadLaterAddIcon, {kReadLaterAddPath, base::size(kReadLaterAddPath)})
...
VECTOR_ICON_REP_TEMPLATE(kLiveCaptionPath, CANVAS_DIMENSIONS, 20,
MOVE_TO, 2, 5,
...
V_LINE_TO, 11,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kLiveCaptionRepList, kLiveCaptionIcon, {kLiveCaptionPath, base::size(kLiveCaptionPath)})
...
R_LINE_TO, 1.88f, 1.88f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kTabBluetoothScanActiveRepList, kTabBluetoothScanActiveIcon, {kTabBluetoothScanActivePath, base::size(kTabBluetoothScanActivePath)})
...
LINE_TO, 14.17f, 12,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kChevronRightRepList, kChevronRightIcon, {kChevronRightPath, base::size(kChevronRightPath)})
...
VECTOR_ICON_REP_TEMPLATE(kGuestMenuArtPath, CANVAS_DIMENSIONS, 272,
...
V_LINE_TO, 4,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kGuestMenuArtRepList, kGuestMenuArtIcon, {kGuestMenuArtPath, base::size(kGuestMenuArtPath)})
VECTOR_ICON_REP_TEMPLATE(kIncognitoMenuArtPath, CANVAS_DIMENSIONS, 272,
MOVE_TO, 203.7f, 0,
H_LINE_TO, 268,
...
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kIncognitoMenuArtRepList, kIncognitoMenuArtIcon, {kIncognitoMenuArtPath, base::size(kIncognitoMenuArtPath)})
...
R_CUBIC_TO, 0, -1.99f, -4, -3, -6, -3,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kPersonFilledPaddedSmallRepList, kPersonFilledPaddedSmallIcon, {kPersonFilledPaddedSmallPath, base::size(kPersonFilledPaddedSmallPath)}, {kPersonFilledPaddedSmall22Path, base::size(kPersonFilledPaddedSmall22Path)}, {kPersonFilledPaddedSmall20Path, base::size(kPersonFilledPaddedSmall20Path)})
...
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kPersonFilledPaddedLargeRepList, kPersonFilledPaddedLargeIcon, {kPersonFilledPaddedLargePath, base::size(kPersonFilledPaddedLargePath)})
...
R_V_LINE_TO, 10.89f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kReadLaterRepList, kReadLaterIcon, {kReadLaterPath, base::size(kReadLaterPath)})
...
R_V_LINE_TO, 6,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kNewTabMacTouchbarRepList, kNewTabMacTouchbarIcon, {kNewTabMacTouchbarPath, base::size(kNewTabMacTouchbarPath)})
...
R_LINE_TO, -6, 6,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kKeyboardArrowUpRepList, kKeyboardArrowUpIcon, {kKeyboardArrowUpPath, base::size(kKeyboardArrowUpPath)})
...
R_LINE_TO, 1.41f, -1.41f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kKeyboardArrowDownRepList, kKeyboardArrowDownIcon, {kKeyboardArrowDownPath, base::size(kKeyboardArrowDownPath)})
...
VECTOR_ICON_REP_TEMPLATE(kDefaultFaviconPath, CANVAS_DIMENSIONS, 32,
MOVE_TO, 18, 2,
H_LINE_TO, 6,
R_V_LINE_TO, 28,
R_H_LINE_TO, 20,
...
R_V_LINE_TO, 16,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kDefaultFaviconRepList, kDefaultFaviconIcon, {kDefaultFaviconPath, base::size(kDefaultFaviconPath)})
...
LINE_TO, 5.54f, 10.08f,
LINE_TO, 4.39f, 8.89f,
CUBIC_TO, 3.94f, 8.42f, 3.19f, 8.41f, 2.72f, 8.87f,
CLOSE,
MOVE_TO, 16.26f, 15.75f,
LINE_TO, 17.26f, 14.73f,
LINE_TO, 18.92f, 13.04f,
LINE_TO, 21.35f, 10.55f,
CUBIC_TO, 21.57f, 10.31f, 21.68f, 10.02f, 21.68f, 9.72f,
CUBIC_TO, 21.68f, 9.41f, 21.56f, 9.11f, 21.32f, 8.87f,
CUBIC_TO, 20.86f, 8.42f, 20.1f, 8.42f, 19.65f, 8.89f,
LINE_TO, 17.26f, 11.35f,
LINE_TO, 15.6f, 13.04f,
LINE_TO, 14.57f, 14.09f,
CUBIC_TO, 13.89f, 14.79f, 12.99f, 15.17f, 12.02f, 15.17f,
CUBIC_TO, 11.15f, 15.17f, 10.35f, 14.86f, 9.71f, 14.3f,
LINE_TO, 8.06f, 15.99f,
CUBIC_TO, 9.15f, 16.99f, 10.54f, 17.54f, 12.02f, 17.54f,
CUBIC_TO, 13.63f, 17.54f, 15.14f, 16.91f, 16.26f, 15.75f,
CLOSE,
MOVE_TO, 12.02f, 8.54f,
CUBIC_TO, 10.41f, 8.54f, 8.9f, 9.17f, 7.78f, 10.33f,
LINE_TO, 4.07f, 14.13f,
LINE_TO, 2.69f, 15.54f,
CUBIC_TO, 2.24f, 16, 2.24f, 16.76f, 2.72f, 17.21f,
CUBIC_TO, 3.18f, 17.66f, 3.94f, 17.66f, 4.39f, 17.19f,
LINE_TO, 6.78f, 14.73f,
LINE_TO, 8.44f, 13.04f,
LINE_TO, 9.47f, 11.99f,
CUBIC_TO, 10.15f, 11.29f, 11.05f, 10.91f, 12.02f, 10.91f,
CUBIC_TO, 12.88f, 10.91f, 13.68f, 11.22f, 14.33f, 11.78f,
LINE_TO, 15.98f, 10.09f,
CUBIC_TO, 14.89f, 9.09f, 13.5f, 8.54f, 12.02f, 8.54f,
CLOSE,
MOVE_TO, 21.68f, 16.37f,
CUBIC_TO, 21.68f, 16.07f, 21.57f, 15.77f, 21.35f, 15.54f,
LINE_TO, 20.16f, 14.32f,
LINE_TO, 18.51f, 16.03f,
LINE_TO, 19.65f, 17.2f,
CUBIC_TO, 20.1f, 17.67f, 20.85f, 17.69f, 21.32f, 17.22f,
CUBIC_TO, 21.56f, 16.99f, 21.68f, 16.68f, 21.68f, 16.37f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kNearbyShareRepList, kNearbyShareIcon, {kNearbySharePath, base::size(kNearbySharePath)})
...
R_V_LINE_TO, -1.4f,
CLOSE,)
VECTOR_ICON_TEMPLATE_CC(kHardwareComputerSmallRepList, kHardwareComputerSmallIcon, {kHardwareComputerSmallPath, base::size(kHardwareComputerSmallPath)})
...
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kKeyboardArrowRightRepList, kKeyboardArrowRightIcon, {kKeyboardArrowRightPath, base::size(kKeyboardArrowRightPath)})
