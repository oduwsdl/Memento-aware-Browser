...
bool DistillerJavaScriptService_HandleStoreThemePref_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const DistillerJavaScriptService_HandleStoreThemePref_Params_Data* object = static_cast<const DistillerJavaScriptService_HandleStoreThemePref_Params_Data*>(data);
...
bool DistillerJavaScriptService_HandleStoreFontFamilyPref_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const DistillerJavaScriptService_HandleStoreFontFamilyPref_Params_Data* object = static_cast<const DistillerJavaScriptService_HandleStoreFontFamilyPref_Params_Data*>(data);
