...
class  Bitmap {
 public:
  template <typename T>
  using EnableIfSame = std::enable_if_t<std::is_same<Bitmap, T>::value>;
  ...
  template <typename T, Bitmap::EnableIfSame<T>* = nullptr>
...
template <typename T, Bitmap::EnableIfSame<T>*>
