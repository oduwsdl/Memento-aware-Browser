...
bool WebUIConversionReport_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->impression_data, 1, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams impression_data_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->impression_data, validation_context,
                                         &impression_data_validate_params)) {
    return false;
  }

  if (!mojo::internal::ValidatePointerNonNullable(
          object->conversion_data, 2, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams conversion_data_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->conversion_data, validation_context,
                                         &conversion_data_validate_params)) {
    return false;
  }
