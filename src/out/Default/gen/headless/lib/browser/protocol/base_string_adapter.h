...
#ifndef headless_protocol_BASE_STRING_ADAPTER_H
#define headless_protocol_BASE_STRING_ADAPTER_H
...
class HEADLESS_EXPORT Binary : public crdtp::Serializable {
 public:
  Binary(const Binary&);
  Binary();
  ~Binary();
...
#endif // !defined(headless_protocol_BASE_STRING_ADAPTER_H)
