...
#define MASK_SFI_NACL1 (1 << 14)
#define MASK_SINGLE_PIC_BASE (1 << 15)
...
#define TARGET_SFI_NACL1_P(target_flags) ((target_flags & MASK_SFI_NACL1) != 0)
...
enum opt_code
{
  ...
  OPT_msfi_nacl1 = 1095,                     /* -msfi-nacl1 */
