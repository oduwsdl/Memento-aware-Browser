...
extern __IMPORT long timezone __asm__("_timezone");
extern __IMPORT int daylight __asm__("_daylight");
extern __IMPORT char *tzname[2] __asm__("_tzname");

/* These variants, starting with "_", are a non-standard newlibism.
 * They are provided for compatibility with programs that have been
 * adapted to build with newlib. */
