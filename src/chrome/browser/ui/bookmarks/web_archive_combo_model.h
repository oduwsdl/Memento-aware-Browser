...
#ifndef CHROME_BROWSER_UI_BOOKMARKS_WEB_ARCHIVED_COMBO_MODEL_H_
#define CHROME_BROWSER_UI_BOOKMARKS_WEB_ARCHIVED_COMBO_MODEL_H_
...
class WebArchiveComboModel : public ui::ComboboxModel,
                                      public bookmarks::BookmarkModelObserver {
 public:
  WebArchiveComboModel(bookmarks::BookmarkModel* model,
                                const bookmarks::BookmarkNode* node);
  ~WebArchiveComboModel() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(WebArchiveComboModel);
};
