...
#ifndef CHROME_BROWSER_UI_VIEWS_MEMENTO_VIEWS_H_
#define CHROME_BROWSER_UI_VIEWS_MEMENTO_VIEWS_H_
...
//
// MementoViews is a dialog that displays the allowed and blocked
...
class MementoViews
    : public views::DialogDelegateView,
      ...
      public content::WebContentsUserData<MementoViews> {
 public:
  ~MementoViews() override;
 ...
 private:
  ...
  friend class content::WebContentsUserData<MementoViews>;

  explicit MementoViews(content::WebContents* web_contents);
  ...
  DISALLOW_COPY_AND_ASSIGN(MementoViews);
};

#endif  // CHROME_BROWSER_UI_VIEWS_MEMENTO_VIEWS_H_
