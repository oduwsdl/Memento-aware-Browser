...
///////////////////////////////////////////////////////////////////////////////
// MementoInfoView, public:

MementoInfoView::MementoInfoView() {
...
MementoInfoView::~MementoInfoView() = default;

void MementoInfoView::SetCookie(const std::string& domain,
...
void MementoInfoView::ClearCookieDisplay() {
...
void MementoInfoView::EnableCookieDisplay(bool enabled) {
  for (const auto textfield_pair : property_textfields_)
    textfield_pair.second->SetEnabled(enabled);
}

void MementoInfoView::OnThemeChanged() {
  SetTextfieldColors();
  views::ScrollView::OnThemeChanged();
}

void MementoInfoView::SetTextfieldColors() {
...
views::Textfield* MementoInfoView::AddTextfieldRow(int layout_id,
                                                  views::GridLayout* layout,
