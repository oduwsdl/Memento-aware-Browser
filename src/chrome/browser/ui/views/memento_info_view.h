...
#ifndef CHROME_BROWSER_UI_VIEWS_MEMENTO_INFO_VIEW_H_
#define CHROME_BROWSER_UI_VIEWS_MEMENTO_INFO_VIEW_H_
...
class MementoInfoView : public views::ScrollView {
 public:
  MementoInfoView();
  ~MementoInfoView() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(MementoInfoView);
};
